#  2-1 and 2-2 skills implementation overall plan and prompts

 2-1 and 2-2 skills implementation overall plan and prompts

All 13/13 Research Agents Complete


  ┌────────────┬──────────────────────────────┬───────┬────────┬────────────────────┬──────────┬────────────────────┐
  │   Class    │             File             │ Lines │ Skills │     Data Bugs      │ Handlers │    New Systems     │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │ Formula bugs       │          │ 8 (mount, stance,  │
  │ Knight     │ Knight_Class_Research.md     │ 1,488 │ 12     │ (Charge Attack,    │ 0        │ line/directional   │
  │            │                              │       │        │ Pierce)            │          │ AoE)               │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │                    │          │ 10 (Devotion,      │
  │ Crusader   │ Crusader_Class_Research.md   │ 1,372 │ ~15    │ 6 data + 4 prereq  │ 0        │ Grand Cross        │
  │            │                              │       │        │ bugs               │          │ hybrid, shield     │
  │            │                              │       │        │                    │          │ skills)            │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │                    │          │ 8 (ground AoE, Ice │
  │ Wizard     │ Wizard_Class_Research.md     │ 1,447 │ 14     │ 15 data errors     │ 0        │  Wall, Quagmire,   │
  │            │                              │       │        │                    │          │ freeze counter)    │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │                    │          │ 8 (endow, Dispel,  │
  │ Sage       │ Sage_Class_Research.md       │ 1,626 │ 24     │ SP/range/cast bugs │ 0        │ autocast, ground   │
  │            │                              │       │        │                    │          │ effects)           │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │ 41 field-level     │          │ 6 (trap system,    │
  │ Hunter     │ Hunter_Class_Research.md     │ 1,657 │ 18     │ issues             │ 0        │ MISC damage,       │
  │            │                              │       │        │                    │          │ falcon)            │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │ 5 prereqs + 4      │          │ 5 (performance     │
  │ Bard       │ Bard_Class_Research.md       │ 1,254 │ 20     │ values + missing   │ 0        │ state, ensemble,   │
  │            │                              │       │        │ skill              │          │ song AoE)          │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │                    │          │ 5 (dance system,   │
  │ Dancer     │ Dancer_Class_Research.md     │ 1,621 │ 20     │ 12 bugs            │ 0        │ ensemble           │
  │            │                              │       │        │                    │          │ counterpart)       │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │ Major formula      │          │ 8 (Kyrie barrier,  │
  │ Priest     │ Priest_Class_Research.md     │ 1,694 │ 19     │ corrections        │ 0        │ Sanctuary, Magnus, │
  │            │                              │       │        │                    │          │  resurrect)        │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │                    │          │ 8 (spirit spheres, │
  │ Monk       │ Monk_Class_Research.md       │ 1,523 │ 16     │ Wrong              │ 0        │  combo chain,      │
  │            │                              │       │        │ prereqs/SP/values  │          │ Asura,             │
  │            │                              │       │        │                    │          │ Investigate)       │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │ 14 definition      │ 0 (3     │ 10 (Sonic Blow,    │
  │ Assassin   │ Assassin_Class_Research.md   │ 1,673 │ 17     │ issues             │ passives │ Cloaking, poison   │
  │            │                              │       │        │                    │  exist)  │ skills, EDP)       │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │                    │          │ 8 (Plagiarism,     │
  │ Rogue      │ Rogue_Class_Research.md      │ 1,468 │ 29     │ 15+ issues         │ 0        │ Strip, backstab    │
  │            │                              │       │        │                    │          │ positioning)       │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │ 9 prereq + formula │          │ 7 (forging,        │
  │ Blacksmith │ Blacksmith_Class_Research.md │ 1,564 │ 26     │  bugs              │ 0        │ refining, cart,    │
  │            │                              │       │        │                    │          │ weapon break)      │
  ├────────────┼──────────────────────────────┼───────┼────────┼────────────────────┼──────────┼────────────────────┤
  │            │                              │       │        │                    │          │ 9 (Homunculus AI,  │
  │ Alchemist  │ Alchemist_Class_Research.md  │ 1,622 │ 17     │ 8 definition bugs  │ 0        │ potion crafting,   │
  │            │                              │       │        │                    │          │ summons)           │
  └────────────┴──────────────────────────────┴───────┴────────┴────────────────────┴──────────┴────────────────────┘

  Totals: ~20,000 lines of research documentation, ~227 skills fully specified, 100+ data bugs identified, 0 active
  second-class handlers exist, ~100 new systems needed across all classes.

  Cross-class new systems that appear repeatedly (build once, reuse everywhere):
  1. Ground Effect / Zone system — Wizard, Sage, Priest, Hunter, Bard/Dancer, Assassin, Alchemist
  2. Mount system — Knight, Crusader (Peco Peco)
  3. Performance/Song system — Bard, Dancer (shared)
  4. Ensemble system — Bard + Dancer (requires party system)
  5. Spirit Sphere system — Monk
  6. Combo chain system — Monk
  7. Trap entity system — Hunter
  8. Plagiarism / Skill Copy — Rogue
  9. Strip Equipment — Rogue (reusable by Stalker later)
  10. Forging / Refining / Crafting — Blacksmith, Alchemist
  11. Homunculus AI companion — Alchemist
  12. MISC damage type — Hunter (traps), Monk (some skills)
  13. Damage absorb barrier — Priest (Kyrie Eleison)
  14. Weapon element endow — Sage, Priest (Aspersio)

  All documents are in docsNew/05_Development/ ready for implementation planning.
 ...
 Second Class Implementation — Master Prompt Sequence
     ...
     This document contains **20 implementation prompts** to be run **in order**. Each prompt is self-contained and
     references the research documents created during the deep research phase.
     ...
     **Run order:** 0A → 0B → 0C → (1A, 1B, 1C in any order) → (2A, 2B, 2C) → (3A → 3B, 3C) → (4A → 4B) → (5A, 5B) →
      5C → 6A → 6B
...
● The master prompt sequence is complete at docsNew/05_Development/Second_Class_Implementation_Prompts.md.

  Here's the summary:

  20 Prompts in 7 Phases
  ...
  Each prompt is fully self-contained with the exact skills to load, files to read, formulas to implement, and systems
  to integrate with. Just copy-paste them one at a time in order.
