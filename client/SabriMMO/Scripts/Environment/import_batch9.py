# import_batch9.py
# Bulk import batch-9 enemy sprite atlases:
# noxious, marc, mole, myst, mystcase, wild_rose, leaf_cat, iceicle,
# stem_worm, neraid, pest, greatest_general, quve.
#
# Settings:
#   Filter:          Nearest
#   Compression:     BC7
...
#   py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/import_batch9.py"
...
total_imported = 0
total_configured = 0
unreal.log(f"Importing {len(FOLDERS)} batch-9 enemy sprite folders...")
