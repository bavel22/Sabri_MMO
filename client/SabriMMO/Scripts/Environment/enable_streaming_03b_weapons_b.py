"""Enable streaming: weapons L-Z (~140 atlases). Idempotent.
Covers: mace, rod, spear_1h, spear_2h, staff, sword_1h, sword_2h, whip."""
import unreal
import os
import time
...
def main():
    ...
    unreal.log(f"=== Weapons L-Z done in {time.time()-start:.1f}s. {counts} ===")
