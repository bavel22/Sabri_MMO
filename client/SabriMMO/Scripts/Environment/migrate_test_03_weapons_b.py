"""Sprite quality migration — TEST PART 3 of 7: weapons batch B (female).

Covers: dagger, instrument, katar, knuckle.

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/migrate_test_03_weapons_b.py"

After this finishes, wait for "Compiling Textures: 0" before running part 4.
"""
import unreal
import os
import glob
...
WEAPON_TYPES = ["dagger", "instrument", "katar", "knuckle"]
...
def main():
    ...
    unreal.log(f"=== Part 3 done in {elapsed:.1f}s. {counts} ===")
    unreal.log(f"Wait for 'Compiling Textures: 0' before running part 4.")
