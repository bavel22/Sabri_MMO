"""Clear MaxTextureSize: enemies batch 6b (red_mushroom → sasquatch, 13 enemies).

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/clear_maxsize_10b_enemies_06.py"
"""
import unreal
import os
import glob
...
ENEMIES = [
    "red_mushroom", "red_plant", "requiem", "rice_cake_boy", "rocker",
    "rocker_old", "roda_frog", "rotar_zairo", "roween", "sageworm",
    "sand_man", "santa_poring", "sasquatch",
]
...
def main():
    ...
    unreal.log(f"=== Enemies 06b done in {time.time()-start:.1f}s. {counts} ===")
    unreal.log("Wait for 'Compiling Textures: 0' before running script 11a.")
