"""Sprite quality migration — TEST PART 1 of 7: priest_f body atlases.

Run from UE5 Python console:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/migrate_test_01_priest.py"

After this finishes, wait for "Compiling Textures: 0" before running part 2.
"""
import unreal
import os
import glob
...
def main():
    ...
    unreal.log(f"=== TEST 1/7: priest_f body ({len(pngs)} atlases) ===")
    if not pngs:
