# import_batch8.py
# Bulk import batch-8 enemy sprite atlases:
# karakasa, obeaune, marse, matyr, deviling, roween, tri_joint,
# baby_leopard, horong, whisper.
#
# Settings:
#   Filter:          Nearest
#   Compression:     BC7
...
#   py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/import_batch8.py"
...
total_imported = 0
total_configured = 0
unreal.log(f"Importing {len(FOLDERS)} batch-8 enemy sprite folders...")
