"""Clear MaxTextureSize: enemies batch 6a (pitman → raggler, 13 enemies).

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/clear_maxsize_10a_enemies_06.py"
"""
import unreal
import os
import glob
...
ENEMIES = [
    "pitman", "plankton", "plasma", "poison_spore", "poison_toad",
    "poporing", "porcellio", "poring", "punk", "pupa", "quve", "rafflesia",
    "raggler",
]
...
def main():
    ...
    unreal.log(f"=== Enemies 06a done in {time.time()-start:.1f}s. {counts} ===")
    unreal.log("Wait for 'Compiling Textures: 0' before running script 10b.")
