"""RECOVERY part 4 of 7: re-import weapons batch C (female): mace, rod, spear_1h, spear_2h.

Run from UE5 Python console:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/migrate_recover_04_weapons_c.py"

After it finishes, wait for "Compiling Textures: 0" before running part 5.
"""
import unreal
import os
import glob
