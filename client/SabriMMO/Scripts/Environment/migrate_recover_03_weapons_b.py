"""RECOVERY part 3 of 7: re-import weapons batch B (female): dagger, instrument, katar, knuckle.

Run from UE5 Python console:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/migrate_recover_03_weapons_b.py"

After it finishes, wait for "Compiling Textures: 0" before running part 4.
"""
import unreal
import os
import glob
