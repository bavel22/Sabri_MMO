# import_batch6.py
# Bulk import batch-6 enemy sprite atlases:
# dustiness, marina, raggler, thara_frog, anacondaq, cornutus, caramel,
# zerom, anopheles, stapo, scorpion, megalodon, vagabond_wolf, drainliar, eggyra.
#
# Settings:
#   Filter:          Nearest
#   Compression:     BC7
...
#   py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/import_batch6.py"
...
total_imported = 0
total_configured = 0
unreal.log(f"Importing {len(FOLDERS)} batch-6 enemy sprite folders...")
