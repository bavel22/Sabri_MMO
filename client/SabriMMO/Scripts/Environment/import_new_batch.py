# import_new_batch.py
# Bulk import the 7 newest enemy sprite atlases (crystals, mastering, picky, santa_poring).
# Applies sprite texture settings in one shot.
#
# Settings:
#   Filter:          Nearest
#   Compression:     BC7
...
#   py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/import_new_batch.py"
...
total_imported = 0
total_configured = 0
unreal.log(f"Importing {len(FOLDERS)} new enemy sprite folders...")
