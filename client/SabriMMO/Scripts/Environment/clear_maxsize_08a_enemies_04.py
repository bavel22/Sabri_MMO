"""Clear MaxTextureSize: enemies batch 4a (kobold → marc, 13 enemies).

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/clear_maxsize_08a_enemies_04.py"
"""
import unreal
import os
import glob
...
ENEMIES = [
    "kobold", "kobold_archer", "kraben", "kukre", "leaf_cat", "lude",
    "lunatic", "magmaring", "magnolia", "mandragora", "mantis", "marc",
    "marduk",
]
...
def main():
    ...
    unreal.log(f"=== Enemies 04a done in {time.time()-start:.1f}s. {counts} ===")
    unreal.log("Wait for 'Compiling Textures: 0' before running script 08b.")
