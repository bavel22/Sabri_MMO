# import_batch7.py
# Bulk import batch-7 enemy sprite atlases:
# wolf, argos, cookie, flora, hode, mantis, phen, savage, metaling,
# desert_wolf, marine_sphere, cookie_xmas, porcellio, giearth, sword_fish, frilldora.
#
# Settings:
#   Filter:          Nearest
#   Compression:     BC7
...
#   py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/import_batch7.py"
...
total_imported = 0
total_configured = 0
unreal.log(f"Importing {len(FOLDERS)} batch-7 enemy sprite folders...")
