"""Clear MaxTextureSize: enemies batch 5b (orc_warrior → pirate_skel, 13 enemies).

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/clear_maxsize_09b_enemies_05.py"
"""
import unreal
import os
import glob
...
ENEMIES = [
    "orc_warrior", "orc_xmas", "orc_zombie", "parasite", "pecopeco",
    "pecopeco_egg", "pest", "petit", "petit_", "phen", "picky", "piere",
    "pirate_skel",
]
...
def main():
    ...
    unreal.log(f"=== Enemies 05b done in {time.time()-start:.1f}s. {counts} ===")
    unreal.log("Wait for 'Compiling Textures: 0' before running script 10a.")
