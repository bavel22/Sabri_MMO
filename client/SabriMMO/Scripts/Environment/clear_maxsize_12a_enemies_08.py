"""Clear MaxTextureSize: enemies batch 8a (toad → wind_crystal, 12 enemies).

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/clear_maxsize_12a_enemies_08.py"
"""
import unreal
import os
import glob
...
ENEMIES = [
    "toad", "tri_joint", "vadon", "vagabond_wolf", "verit", "vitata",
    "vocal", "whisper", "white_plant", "wild_rose", "willow", "wind_crystal",
]
...
def main():
    ...
    unreal.log(f"=== Enemies 08a done in {time.time()-start:.1f}s. {counts} ===")
    unreal.log("Wait for 'Compiling Textures: 0' before running script 12b.")
