"""Clear MaxTextureSize: enemies batch 5a (mole → orc_skeleton, 13 enemies).

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/clear_maxsize_09a_enemies_05.py"
"""
import unreal
import os
import glob
...
ENEMIES = [
    "mole", "muka", "mummy", "myst", "mystcase", "neraid", "nightmare",
    "novus", "noxious", "obeaune", "orc_baby", "orc_lady", "orc_skeleton",
]
...
def main():
    ...
    unreal.log(f"=== Enemies 05a done in {time.time()-start:.1f}s. {counts} ===")
    unreal.log("Wait for 'Compiling Textures: 0' before running script 09b.")
