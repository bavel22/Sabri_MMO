"""RECOVERY part 6 of 7: re-import hair style_01 female from PNG.

Run from UE5 Python console:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/migrate_recover_06_hair.py"

After it finishes, wait for "Compiling Textures: 0" before running part 7.
"""
import unreal
import os
import glob
...
def main():
    ...
    unreal.log(f"=== RECOVERY 6/7: hair style_01 female ({len(pngs)} atlases) ===")
