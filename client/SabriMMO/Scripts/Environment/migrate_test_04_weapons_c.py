"""Sprite quality migration — TEST PART 4 of 7: weapons batch C (female).

Covers: mace, rod, spear_1h, spear_2h.

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/migrate_test_04_weapons_c.py"

After this finishes, wait for "Compiling Textures: 0" before running part 5.
"""
import unreal
import os
import glob
...
WEAPON_TYPES = ["mace", "rod", "spear_1h", "spear_2h"]
...
def main():
    ...
    unreal.log(f"=== Part 4 done in {elapsed:.1f}s. {counts} ===")
    unreal.log(f"Wait for 'Compiling Textures: 0' before running part 5.")
