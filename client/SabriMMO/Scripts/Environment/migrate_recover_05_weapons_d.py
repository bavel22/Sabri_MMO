"""RECOVERY part 5 of 7: re-import weapons batch D (female): staff, sword_1h, sword_2h, whip.

Run from UE5 Python console:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/migrate_recover_05_weapons_d.py"

After it finishes, wait for "Compiling Textures: 0" before running part 6.
"""
import unreal
import os
import glob
