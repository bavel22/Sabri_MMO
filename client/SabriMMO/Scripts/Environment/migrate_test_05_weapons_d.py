"""Sprite quality migration — TEST PART 5 of 7: weapons batch D (female).

Covers: staff, sword_1h, sword_2h, whip.

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/migrate_test_05_weapons_d.py"

After this finishes, wait for "Compiling Textures: 0" before running part 6.
"""
import unreal
import os
import glob
...
WEAPON_TYPES = ["staff", "sword_1h", "sword_2h", "whip"]
...
def main():
    ...
    unreal.log(f"=== Part 5 done in {elapsed:.1f}s. {counts} ===")
    unreal.log(f"Wait for 'Compiling Textures: 0' before running part 6.")
