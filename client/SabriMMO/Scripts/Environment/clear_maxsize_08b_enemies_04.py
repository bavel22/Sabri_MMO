"""Clear MaxTextureSize: enemies batch 4b (marina → miyabi_doll, 13 enemies).

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/clear_maxsize_08b_enemies_04.py"
"""
import unreal
import os
import glob
...
ENEMIES = [
    "marina", "marine_sphere", "marionette", "marse", "martin", "mastering",
    "matyr", "megalith", "megalodon", "metaling", "metaller", "mime_monkey",
    "miyabi_doll",
]
...
def main():
    ...
    unreal.log(f"=== Enemies 04b done in {time.time()-start:.1f}s. {counts} ===")
    unreal.log("Wait for 'Compiling Textures: 0' before running script 09a.")
