# import_batch3.py
# Bulk import batch-3 enemy sprite atlases:
# kukre, tarou, ambernite, worm_tail, hydra, snake, shellfish, antonio.
#
# Settings:
#   Filter:          Nearest
#   Compression:     BC7
...
#   py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/import_batch3.py"
...
total_imported = 0
total_configured = 0
unreal.log(f"Importing {len(FOLDERS)} batch-3 enemy sprite folders...")
