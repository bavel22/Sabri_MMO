# import_batch5.py
# Bulk import batch-5 enemy sprite atlases:
# ghostring, horn, martin, piere, aster, thief_bug_male, deniro,
# elder_wilow, crab, angeling, vitata, vadon.
#
# Settings:
#   Filter:          Nearest
#   Compression:     BC7
...
#   py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/import_batch5.py"
...
total_imported = 0
total_configured = 0
unreal.log(f"Importing {len(FOLDERS)} batch-5 enemy sprite folders...")
