"""Clear MaxTextureSize: enemies batch 7a (savage → spore, 13 enemies).

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/clear_maxsize_11a_enemies_07.py"
"""
import unreal
import os
import glob
...
ENEMIES = [
    "savage", "savage_babe", "scorpion", "shellfish", "shining_plant",
    "side_winder", "skeleton", "smokie", "smoking_orc", "snake",
    "soldier_skeleton", "spore",
]
...
def main():
    ...
    unreal.log(f"=== Enemies 07a done in {time.time()-start:.1f}s. {counts} ===")
    unreal.log("Wait for 'Compiling Textures: 0' before running script 11b.")
