"""Clear MaxTextureSize: enemies batch 1/8 (alligator → cookie).

Run:
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/clear_maxsize_05_enemies_01.py"
"""
import unreal
import os
import glob
...
def main():
    ...
    unreal.log("Wait for 'Compiling Textures: 0' before running script 06.")
