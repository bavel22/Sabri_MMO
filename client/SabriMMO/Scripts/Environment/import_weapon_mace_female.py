"""Imports the female mace weapon overlay atlases into UE5.

Usage (in UE5 editor Python console):
    py "C:/Sabri_MMO/client/SabriMMO/Scripts/Environment/import_weapon_mace_female.py"
...
SRC_DIR = "C:/Sabri_MMO/client/SabriMMO/Content/SabriMMO/Sprites/Atlases/Weapon/mace/female"
GAME_DEST = "/Game/SabriMMO/Sprites/Atlases/Weapon/mace/female"
DELETE_FIRST = False
...
pngs = sorted(glob.glob(os.path.join(SRC_DIR, "weapon_8_*.png")))
unreal.log(f"[mace/female] Found {len(pngs)} PNG atlases to import")
...
unreal.log(f"[mace/female] Imported {len(tasks)}, configured {configured}")
