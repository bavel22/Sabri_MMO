...
const SKILL_DEFINITIONS = [
    // === NOVICE (IDs 1-10) ===
    { id: 1, name: 'basic_skill', displayName: 'Basic Skill', classId: 'novice', maxLevel: 9, type: 'passive', targetType: 'none', element: 'neutral', range: 0, description: 'Enables basic interface commands at each level. Trading (Lv1), Emotes (Lv2), Sitting (Lv3), Chat Rooms (Lv4), Party Join (Lv5), Kafra Storage (Lv6), Party Create (Lv7), Job Change (Lv9).', icon: 'basic_skill', treeRow: 0, treeCol: 0, prerequisites: [], levels: genLevels(9, i => ({ level: i+1, spCost: 0, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 0, duration: 0 })) },
    { id: 2, name: 'first_aid', displayName: 'First Aid', classId: 'novice', maxLevel: 1, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Restore 5 HP.', icon: 'first_aid', treeRow: 0, treeCol: 1, prerequisites: [], isQuestSkill: true, levels: [{ level: 1, spCost: 3, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 5, duration: 0 }] },
    { id: 3, name: 'play_dead', displayName: 'Play Dead', classId: 'novice', maxLevel: 1, type: 'toggle', targetType: 'self', element: 'neutral', range: 0, description: 'Feign death. All monsters (including MVPs) ignore you. Cannot move, attack, use skills, or use items. HP/SP regen blocked. Toggle on/off.', icon: 'play_dead', treeRow: 1, treeCol: 0, prerequisites: [], isQuestSkill: true, levels: [{ level: 1, spCost: 5, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 0, duration: 0 }] },
    ...
    { id: 103, name: 'bash', displayName: 'Bash', classId: 'swordsman', maxLevel: 10, type: 'active', targetType: 'single', element: 'neutral', range: 150, description: 'Smash a target for increased damage.', icon: 'bash', treeRow: 0, treeCol: 1, prerequisites: [], levels: genLevels(10, i => ({ level: i+1, spCost: i < 5 ? 8 : 15, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 130 + i*30, duration: 0 })) },
    { id: 104, name: 'provoke', displayName: 'Provoke', classId: 'swordsman', maxLevel: 10, type: 'active', targetType: 'single', element: 'neutral', range: 450, description: 'Enrage target: -DEF, +ATK.', icon: 'provoke', treeRow: 1, treeCol: 1, prerequisites: [], levels: genLevels(10, i => ({ level: i+1, spCost: 4+i, castTime: 0, afterCastDelay: 0, cooldown: 1000, effectValue: 5+i*3, duration: 30000 })) },
    { id: 105, name: 'magnum_break', displayName: 'Magnum Break', classId: 'swordsman', maxLevel: 10, type: 'active', targetType: 'aoe', element: 'fire', range: 0, description: 'AoE fire attack centered on self. Knockback, +20% Fire ATK bonus for 10s.', icon: 'magnum_break', treeRow: 1, treeCol: 2, prerequisites: [{ skillId: 103, level: 5 }], levels: genLevels(10, i => ({ level: i+1, spCost: 30, castTime: 0, afterCastDelay: 2000, cooldown: 0, effectValue: 120+i*20, duration: 0 })) },
    ...
    { id: 107, name: 'moving_hp_recovery', displayName: 'Moving HP Recovery', classId: 'swordsman', maxLevel: 1, type: 'passive', targetType: 'none', element: 'neutral', range: 0, description: 'Recover HP while moving. Quest skill.', icon: 'moving_hp_recovery', treeRow: 1, treeCol: 3, prerequisites: [], levels: [{ level: 1, spCost: 0, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 25, duration: 0 }] },
    { id: 108, name: 'auto_berserk', displayName: 'Auto Berserk', classId: 'swordsman', maxLevel: 1, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Increase ATK when HP is below 25%. Quest skill.', icon: 'auto_berserk', treeRow: 2, treeCol: 2, prerequisites: [], levels: [{ level: 1, spCost: 1, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 32, duration: 300000 }] },
    { id: 109, name: 'fatal_blow', displayName: 'Fatal Blow', classId: 'swordsman', maxLevel: 1, type: 'passive', targetType: 'none', element: 'neutral', range: 0, description: 'Add stun chance to Bash Lv6+. Quest skill.', icon: 'fatal_blow', treeRow: 0, treeCol: 3, prerequisites: [], levels: [{ level: 1, spCost: 0, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 0, duration: 0 }] },
    ...
    { id: 206, name: 'stone_curse', displayName: 'Stone Curse', classId: 'mage', maxLevel: 10, type: 'active', targetType: 'single', element: 'earth', range: 100, description: 'Petrify a target. Requires Red Gemstone.', icon: 'stone_curse', treeRow: 2, treeCol: 0, prerequisites: [], levels: genLevels(10, i => ({ level: i+1, spCost: 25-i, castTime: 1000, afterCastDelay: 0, cooldown: 0, effectValue: 24+i*4, duration: 20000 })) },
    ...
    { id: 210, name: 'soul_strike', displayName: 'Soul Strike', classId: 'mage', maxLevel: 10, type: 'active', targetType: 'single', element: 'ghost', range: 900, description: 'Ghost bolts. Extra damage vs Undead.', icon: 'soul_strike', treeRow: 1, treeCol: 3, prerequisites: [{ skillId: 203, level: 4 }], levels: [{ level: 1, spCost: 18, castTime: 500, afterCastDelay: 1200, cooldown: 0, effectValue: 100, duration: 0 },{ level: 2, spCost: 14, castTime: 500, afterCastDelay: 1000, cooldown: 0, effectValue: 100, duration: 0 },{ level: 3, spCost: 24, castTime: 500, afterCastDelay: 1400, cooldown: 0, effectValue: 100, duration: 0 },{ level: 4, spCost: 20, castTime: 500, afterCastDelay: 1200, cooldown: 0, effectValue: 100, duration: 0 },{ level: 5, spCost: 30, castTime: 500, afterCastDelay: 1600, cooldown: 0, effectValue: 100, duration: 0 },{ level: 6, spCost: 26, castTime: 500, afterCastDelay: 1400, cooldown: 0, effectValue: 100, duration: 0 },{ level: 7, spCost: 36, castTime: 500, afterCastDelay: 1800, cooldown: 0, effectValue: 100, duration: 0 },{ level: 8, spCost: 32, castTime: 500, afterCastDelay: 1600, cooldown: 0, effectValue: 100, duration: 0 },{ level: 9, spCost: 42, castTime: 500, afterCastDelay: 2000, cooldown: 0, effectValue: 100, duration: 0 },{ level: 10, spCost: 38, castTime: 500, afterCastDelay: 1800, cooldown: 0, effectValue: 100, duration: 0 }] },
    { id: 211, name: 'safety_wall', displayName: 'Safety Wall', classId: 'mage', maxLevel: 10, type: 'active', targetType: 'ground', element: 'neutral', range: 900, description: 'Blocks melee physical attacks. Needs Blue Gem.', icon: 'safety_wall', treeRow: 2, treeCol: 3, prerequisites: [{ skillId: 203, level: 7 }, { skillId: 210, level: 5 }], levels: genLevels(10, i => ({ level: i+1, spCost: [30,30,30,35,35,35,40,40,40,40][i], castTime: [4000,3500,3000,2500,2000,1500,1000,1000,1000,1000][i], afterCastDelay: 0, cooldown: 0, effectValue: i+2, duration: (i+1)*5000 })) },
    ...
    { id: 213, name: 'energy_coat', displayName: 'Energy Coat', classId: 'mage', maxLevel: 1, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Reduce physical damage based on SP%. Drains SP on hit. Quest skill.', icon: 'energy_coat', treeRow: 2, treeCol: 1, prerequisites: [], levels: [{ level: 1, spCost: 30, castTime: 5000, afterCastDelay: 0, cooldown: 0, effectValue: 30, duration: 300000 }] },
    ...
    { id: 302, name: 'improve_concentration', displayName: 'Improve Concentration', classId: 'archer', maxLevel: 10, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Increase AGI/DEX %, reveal hidden on cast.', icon: 'improve_concentration', treeRow: 2, treeCol: 0, prerequisites: [{ skillId: 301, level: 1 }], levels: genLevels(10, i => ({ level: i+1, spCost: 25+i*5, castTime: 0, cooldown: 0, effectValue: 3+i, duration: 60000+i*20000 })) },
    { id: 303, name: 'double_strafe', displayName: 'Double Strafe', classId: 'archer', maxLevel: 10, type: 'active', targetType: 'single', element: 'neutral', range: 800, description: 'Fire two arrows at once.', icon: 'double_strafe', treeRow: 0, treeCol: 1, prerequisites: [], levels: genLevels(10, i => ({ level: i+1, spCost: 12, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 100+i*10, duration: 0 })) },
    { id: 304, name: 'arrow_shower', displayName: 'Arrow Shower', classId: 'archer', maxLevel: 10, type: 'active', targetType: 'ground', element: 'neutral', range: 800, description: 'AoE arrow volley. 5x5 area, knockback 2 cells.', icon: 'arrow_shower', treeRow: 1, treeCol: 1, prerequisites: [{ skillId: 303, level: 5 }], levels: genLevels(10, i => ({ level: i+1, spCost: 15, castTime: 0, afterCastDelay: 1000, cooldown: 0, effectValue: 80+i*5, duration: 0 })) },
    ...
    { id: 306, name: 'arrow_repel', displayName: 'Arrow Repel', classId: 'archer', maxLevel: 1, type: 'active', targetType: 'single', element: 'neutral', range: 800, description: 'Knockback target 6 cells with arrow. Quest skill.', icon: 'arrow_repel', treeRow: 2, treeCol: 1, prerequisites: [], levels: [{ level: 1, spCost: 15, castTime: 1500, afterCastDelay: 0, cooldown: 0, effectValue: 150, duration: 0 }] },

    // === ACOLYTE (IDs 400-429) ===
    { id: 400, name: 'heal', displayName: 'Heal', classId: 'acolyte', maxLevel: 10, type: 'active', targetType: 'single', element: 'holy', range: 450, description: 'Restore HP. Damages Undead.', icon: 'heal', treeRow: 0, treeCol: 0, prerequisites: [], levels: genLevels(10, i => ({ level: i+1, spCost: 13+i*3, castTime: 0, afterCastDelay: 1000, cooldown: 0, effectValue: 18*(i+1), duration: 0 })) },
    ...
    { id: 402, name: 'blessing', displayName: 'Blessing', classId: 'acolyte', maxLevel: 10, type: 'active', targetType: 'single', element: 'holy', range: 450, description: 'Increase STR/DEX/INT. Cures Curse. Debuffs Undead/Demon.', icon: 'blessing', treeRow: 1, treeCol: 2, prerequisites: [{ skillId: 401, level: 5 }], levels: genLevels(10, i => ({ level: i+1, spCost: 28+i*4, castTime: 0, cooldown: 0, effectValue: i+1, duration: 60000+i*20000 })) },
    { id: 403, name: 'increase_agi', displayName: 'Increase AGI', classId: 'acolyte', maxLevel: 10, type: 'active', targetType: 'single', element: 'holy', range: 450, description: 'Increase AGI and move speed. Costs 15 HP.', icon: 'increase_agi', treeRow: 0, treeCol: 1, prerequisites: [{ skillId: 400, level: 3 }], levels: genLevels(10, i => ({ level: i+1, spCost: 18+i*3, castTime: 1000, afterCastDelay: 1000, cooldown: 0, effectValue: 3+i, duration: 60000+i*20000 })) },
    { id: 404, name: 'decrease_agi', displayName: 'Decrease AGI', classId: 'acolyte', maxLevel: 10, type: 'active', targetType: 'single', element: 'holy', range: 450, description: 'Decrease target AGI and move speed.', icon: 'decrease_agi', treeRow: 1, treeCol: 1, prerequisites: [{ skillId: 403, level: 1 }], levels: genLevels(10, i => ({ level: i+1, spCost: 15+i*2, castTime: 1000, afterCastDelay: 1000, cooldown: 0, effectValue: 3+i, duration: (4+i)*10000 })) },
    { id: 405, name: 'cure', displayName: 'Cure', classId: 'acolyte', maxLevel: 1, type: 'active', targetType: 'single', element: 'holy', range: 450, description: 'Remove status effects.', icon: 'cure', treeRow: 1, treeCol: 0, prerequisites: [{ skillId: 400, level: 2 }], levels: [{ level: 1, spCost: 15, castTime: 0, afterCastDelay: 1000, cooldown: 0, effectValue: 0, duration: 0 }] },
    { id: 406, name: 'angelus', displayName: 'Angelus', classId: 'acolyte', maxLevel: 10, type: 'active', targetType: 'self', element: 'holy', range: 0, description: 'Increase party VIT DEF %.', icon: 'angelus', treeRow: 2, treeCol: 2, prerequisites: [{ skillId: 401, level: 3 }], levels: genLevels(10, i => ({ level: i+1, spCost: 23+i*3, castTime: 500, afterCastDelay: 3500, cooldown: 0, effectValue: 5+i*5, duration: (i+1)*30000 })) },
    { id: 407, name: 'signum_crucis', displayName: 'Signum Crucis', classId: 'acolyte', maxLevel: 10, type: 'active', targetType: 'aoe', element: 'holy', range: 0, description: 'Decrease hard DEF of Undead/Demon on screen.', icon: 'signum_crucis', treeRow: 0, treeCol: 3, prerequisites: [{ skillId: 413, level: 3 }], levels: genLevels(10, i => ({ level: i+1, spCost: 35, castTime: 500, afterCastDelay: 2000, cooldown: 0, effectValue: 14+i*4, duration: 86400000 })) },
    ...
    { id: 409, name: 'teleport', displayName: 'Teleport', classId: 'acolyte', maxLevel: 2, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Teleport randomly or to save point.', icon: 'teleport', treeRow: 3, treeCol: 0, prerequisites: [{ skillId: 408, level: 1 }], levels: [{ level: 1, spCost: 10, castTime: 0, cooldown: 0, effectValue: 0, duration: 0 }, { level: 2, spCost: 9, castTime: 0, cooldown: 0, effectValue: 0, duration: 0 }] },
    { id: 410, name: 'warp_portal', displayName: 'Warp Portal', classId: 'acolyte', maxLevel: 4, type: 'active', targetType: 'ground', element: 'neutral', range: 450, description: 'Create portal. Needs Blue Gem.', icon: 'warp_portal', treeRow: 4, treeCol: 0, prerequisites: [{ skillId: 409, level: 2 }], levels: [{ level: 1, spCost: 35, castTime: 1000, cooldown: 0, effectValue: 1, duration: 10000 },{ level: 2, spCost: 32, castTime: 1000, cooldown: 0, effectValue: 2, duration: 15000 },{ level: 3, spCost: 29, castTime: 1000, cooldown: 0, effectValue: 3, duration: 20000 },{ level: 4, spCost: 26, castTime: 1000, cooldown: 0, effectValue: 4, duration: 25000 }] },
    ...
    { id: 412, name: 'aqua_benedicta', displayName: 'Aqua Benedicta', classId: 'acolyte', maxLevel: 1, type: 'active', targetType: 'self', element: 'holy', range: 0, description: 'Create Holy Water. Must stand in water. Needs Empty Bottle.', icon: 'aqua_benedicta', treeRow: 0, treeCol: 4, prerequisites: [], levels: [{ level: 1, spCost: 10, castTime: 1000, afterCastDelay: 500, cooldown: 0, effectValue: 0, duration: 0 }] },
    { id: 413, name: 'demon_bane', displayName: 'Demon Bane', classId: 'acolyte', maxLevel: 10, type: 'passive', targetType: 'none', element: 'neutral', range: 0, description: 'Increase ATK vs Undead/Demon race.', icon: 'demon_bane', treeRow: 0, treeCol: 3, prerequisites: [{ skillId: 401, level: 3 }], levels: genLevels(10, i => ({ level: i+1, spCost: 0, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: (i+1)*3, duration: 0 })) },
    { id: 414, name: 'holy_light', displayName: 'Holy Light', classId: 'acolyte', maxLevel: 1, type: 'active', targetType: 'single', element: 'holy', range: 450, description: 'Holy magic attack. Cancels Kyrie Eleison on target. Quest skill.', icon: 'holy_light', treeRow: 5, treeCol: 2, prerequisites: [], levels: [{ level: 1, spCost: 15, castTime: 2000, afterCastDelay: 0, cooldown: 0, effectValue: 125, duration: 0 }] },
    ...
    { id: 502, name: 'steal', displayName: 'Steal', classId: 'thief', maxLevel: 10, type: 'active', targetType: 'single', element: 'neutral', range: 150, description: 'Steal items from monsters.', icon: 'steal', treeRow: 0, treeCol: 2, prerequisites: [], levels: genLevels(10, i => ({ level: i+1, spCost: 10, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 10+i*6, duration: 0 })) },
    { id: 503, name: 'hiding', displayName: 'Hiding', classId: 'thief', maxLevel: 10, type: 'toggle', targetType: 'self', element: 'neutral', range: 0, description: 'Hide from enemies. Drains SP over time.', icon: 'hiding', treeRow: 1, treeCol: 2, prerequisites: [{ skillId: 502, level: 5 }], levels: genLevels(10, i => ({ level: i+1, spCost: 10, castTime: 0, cooldown: 0, effectValue: 0, duration: (i+1)*30000 })) },
    { id: 504, name: 'envenom', displayName: 'Envenom', classId: 'thief', maxLevel: 10, type: 'active', targetType: 'single', element: 'poison', range: 100, description: 'Poison attack.', icon: 'envenom', treeRow: 1, treeCol: 0, prerequisites: [], levels: genLevels(10, i => ({ level: i+1, spCost: 12, castTime: 0, cooldown: 0, effectValue: 15*(i+1), duration: 0 })) },
    { id: 505, name: 'detoxify', displayName: 'Detoxify', classId: 'thief', maxLevel: 1, type: 'active', targetType: 'single', element: 'neutral', range: 450, description: 'Cure poison.', icon: 'detoxify', treeRow: 2, treeCol: 0, prerequisites: [{ skillId: 504, level: 3 }], levels: [{ level: 1, spCost: 10, castTime: 0, cooldown: 0, effectValue: 0, duration: 0 }] },
    { id: 506, name: 'sand_attack', displayName: 'Sand Attack', classId: 'thief', maxLevel: 1, type: 'active', targetType: 'single', element: 'earth', range: 150, description: 'Throw sand to blind target. Earth element. Quest skill.', icon: 'sand_attack', treeRow: 2, treeCol: 1, prerequisites: [], levels: [{ level: 1, spCost: 9, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 130, duration: 0 }] },
    { id: 507, name: 'backslide', displayName: 'Back Slide', classId: 'thief', maxLevel: 1, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Instantly slide backward.', icon: 'backslide', treeRow: 1, treeCol: 3, prerequisites: [], levels: [{ level: 1, spCost: 7, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 0, duration: 0 }] },
    { id: 508, name: 'throw_stone', displayName: 'Throw Stone', classId: 'thief', maxLevel: 1, type: 'active', targetType: 'single', element: 'neutral', range: 350, description: 'Throw stone for fixed 50 damage. Chance to stun/blind. Needs Stone item. Quest skill.', icon: 'throw_stone', treeRow: 0, treeCol: 3, prerequisites: [], levels: [{ level: 1, spCost: 2, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 50, duration: 0 }] },
    { id: 509, name: 'pick_stone', displayName: 'Pick Stone', classId: 'thief', maxLevel: 1, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Pick up a stone. Must be under 50% weight. Quest skill.', icon: 'pick_stone', treeRow: 0, treeCol: 4, prerequisites: [], levels: [{ level: 1, spCost: 3, castTime: 500, afterCastDelay: 0, cooldown: 0, effectValue: 0, duration: 0 }] },
    ...
    { id: 601, name: 'discount', displayName: 'Discount', classId: 'merchant', maxLevel: 10, type: 'passive', targetType: 'none', element: 'neutral', range: 0, description: 'Reduce NPC buy prices.', icon: 'discount', treeRow: 1, treeCol: 0, prerequisites: [{ skillId: 600, level: 3 }], levels: genLevels(10, i => ({ level: i+1, spCost: 0, castTime: 0, cooldown: 0, effectValue: [7,9,11,13,15,17,19,21,23,24][i], duration: 0 })) },
    { id: 602, name: 'overcharge', displayName: 'Overcharge', classId: 'merchant', maxLevel: 10, type: 'passive', targetType: 'none', element: 'neutral', range: 0, description: 'Increase NPC sell prices.', icon: 'overcharge', treeRow: 2, treeCol: 0, prerequisites: [{ skillId: 601, level: 3 }], levels: genLevels(10, i => ({ level: i+1, spCost: 0, castTime: 0, cooldown: 0, effectValue: [7,9,11,13,15,17,19,21,23,24][i], duration: 0 })) },
    { id: 603, name: 'mammonite', displayName: 'Mammonite', classId: 'merchant', maxLevel: 10, type: 'active', targetType: 'single', element: 'neutral', range: 150, description: 'Powerful attack costing Zeny.', icon: 'mammonite', treeRow: 0, treeCol: 1, prerequisites: [], levels: genLevels(10, i => ({ level: i+1, spCost: 5, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 150+i*50, duration: 0 })) },
    { id: 604, name: 'pushcart', displayName: 'Pushcart', classId: 'merchant', maxLevel: 10, type: 'passive', targetType: 'none', element: 'neutral', range: 0, description: 'Use a cart for storage. Higher levels reduce speed penalty.', icon: 'pushcart', treeRow: 0, treeCol: 2, prerequisites: [{ skillId: 600, level: 5 }], levels: genLevels(10, i => ({ level: i+1, spCost: 0, castTime: 0, cooldown: 0, effectValue: (i+1)*5, duration: 0 })) },
    ...
    { id: 607, name: 'change_cart', displayName: 'Change Cart', classId: 'merchant', maxLevel: 1, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Change cart appearance based on base level. Quest skill.', icon: 'change_cart', treeRow: 2, treeCol: 2, prerequisites: [], levels: [{ level: 1, spCost: 40, castTime: 0, cooldown: 0, effectValue: 0, duration: 0 }] },
    ...
    { id: 609, name: 'loud_exclamation', displayName: 'Loud Exclamation', classId: 'merchant', maxLevel: 1, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Shout to increase STR by 4 for 5 min. Quest skill.', icon: 'loud_exclamation', treeRow: 2, treeCol: 1, prerequisites: [], levels: [{ level: 1, spCost: 8, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 4, duration: 300000 }] },
];
...
function getAvailableSkills(jobClass) {
    ...
    // Add skills shared with this class (e.g., Knight skills shared with Crusader)
    for (const skill of ALL_SKILLS) {
        if (skill.sharedClasses && skill.sharedClasses.includes(jobClass)) {
...
function canLearnSkill(skillId, playerSkills, jobClass, skillPoints) {
    ...
    // Check class access (including sharedClasses)
    const chain = CLASS_PROGRESSION[jobClass] || ['novice'];
    const hasAccess = chain.includes(skill.classId) ||
        (skill.sharedClasses && skill.sharedClasses.includes(jobClass));
    if (!hasAccess) return { ok: false, reason: `${skill.displayName} is not available for your class` };
