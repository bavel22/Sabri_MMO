...
const SKILL_DEFINITIONS = [
    ...
    { id: 105, name: 'magnum_break', displayName: 'Magnum Break', classId: 'swordsman', maxLevel: 10, type: 'active', targetType: 'aoe', element: 'fire', range: 0, description: 'AoE fire attack that pushes enemies back.', icon: 'magnum_break', treeRow: 1, treeCol: 2, prerequisites: [{ skillId: 103, level: 5 }], levels: genLevels(10, i => ({ level: i+1, spCost: 30, castTime: 0, afterCastDelay: 0, cooldown: 2000, effectValue: 120+i*20, duration: 0 })) },
