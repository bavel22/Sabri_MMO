...
const SKILL_DEFINITIONS = [
    ...
    { id: 3, name: 'play_dead', displayName: 'Play Dead', classId: 'novice', maxLevel: 1, type: 'toggle', targetType: 'self', element: 'neutral', range: 0, description: 'Pretend to be dead. Monsters ignore you.', icon: 'play_dead', treeRow: 1, treeCol: 0, prerequisites: [{ skillId: 1, level: 1 }], levels: [{ level: 1, spCost: 5, castTime: 0, cooldown: 0, effectValue: 0, duration: 0 }] },
    ...
    { id: 304, name: 'arrow_shower', displayName: 'Arrow Shower', classId: 'archer', maxLevel: 10, type: 'active', targetType: 'ground', element: 'neutral', range: 800, description: 'AoE arrow volley. 5x5 area, knockback 2 cells.', icon: 'arrow_shower', treeRow: 1, treeCol: 1, prerequisites: [{ skillId: 303, level: 5 }], levels: genLevels(10, i => ({ level: i+1, spCost: 15, castTime: 0, cooldown: 1000, effectValue: 80+i*5, duration: 0 })) },
    ...
    { id: 407, name: 'signum_crucis', displayName: 'Signum Crucis', classId: 'acolyte', maxLevel: 10, type: 'active', targetType: 'aoe', element: 'holy', range: 0, description: 'Decrease hard DEF of Undead/Demon on screen.', icon: 'signum_crucis', treeRow: 0, treeCol: 3, prerequisites: [{ skillId: 413, level: 3 }], levels: genLevels(10, i => ({ level: i+1, spCost: 35, castTime: 500, afterCastDelay: 2000, cooldown: 0, effectValue: 14+i*4, duration: 0 })) },
    ...
    { id: 503, name: 'hiding', displayName: 'Hiding', classId: 'thief', maxLevel: 10, type: 'toggle', targetType: 'self', element: 'neutral', range: 0, description: 'Hide from enemies. Drains SP over time.', icon: 'hiding', treeRow: 1, treeCol: 2, prerequisites: [{ skillId: 502, level: 5 }], levels: genLevels(10, i => ({ level: i+1, spCost: 10, castTime: 0, cooldown: 500, effectValue: 0, duration: (i+1)*30000 })) },
    ...
    { id: 506, name: 'sand_attack', displayName: 'Sand Attack', classId: 'thief', maxLevel: 1, type: 'active', targetType: 'single', element: 'earth', range: 150, description: 'Throw sand to blind target. Earth element. Quest skill.', icon: 'sand_attack', treeRow: 2, treeCol: 1, prerequisites: [], levels: [{ level: 1, spCost: 9, castTime: 0, afterCastDelay: 0, cooldown: 1000, effectValue: 130, duration: 0 }] },
    { id: 507, name: 'backslide', displayName: 'Back Slide', classId: 'thief', maxLevel: 1, type: 'active', targetType: 'self', element: 'neutral', range: 0, description: 'Instantly slide backward.', icon: 'backslide', treeRow: 1, treeCol: 3, prerequisites: [], levels: [{ level: 1, spCost: 7, castTime: 0, afterCastDelay: 500, cooldown: 0, effectValue: 0, duration: 0 }] },
    { id: 508, name: 'throw_stone', displayName: 'Throw Stone', classId: 'thief', maxLevel: 1, type: 'active', targetType: 'single', element: 'neutral', range: 700, description: 'Throw stone for fixed 50 damage. Chance to stun/blind. Needs Stone item. Quest skill.', icon: 'throw_stone', treeRow: 0, treeCol: 3, prerequisites: [], levels: [{ level: 1, spCost: 2, castTime: 0, afterCastDelay: 0, cooldown: 0, effectValue: 50, duration: 0 }] },
    ...
    { id: 608, name: 'cart_revolution', displayName: 'Cart Revolution', classId: 'merchant', maxLevel: 1, type: 'active', targetType: 'ground', element: 'neutral', range: 150, description: 'AoE attack with cart. Damage scales with cart weight. Knockback 2. Quest skill.', icon: 'cart_revolution', treeRow: 1, treeCol: 1, prerequisites: [], levels: [{ level: 1, spCost: 12, castTime: 0, afterCastDelay: 0, cooldown: 500, effectValue: 150, duration: 0 }] },
