 ...
 *
 * respawnMs accepts:
 *   - number (fixed delay in ms)              e.g. 5500
 *   - [min, max] array (uniform random range) e.g. [120000, 360000]
 * Resolved by resolveRespawnMs() in index.js. Used for non-MVP/boss
 * spawns; MVPs/bosses still use hardcoded variance in the death handler.
 */
...
RO_MONSTER_TEMPLATES['poring'] = {
    ...
    drops: [
        ...
        { itemName: 'Knife', itemId: 1202, rate: 1 },
...
RO_MONSTER_TEMPLATES['red_plant'] = {
    ...
    drops: [
        ...
        { itemName: 'Flower', itemId: 712, rate: 10 },
...
RO_MONSTER_TEMPLATES['blue_plant'] = {
    ...
    aspd: 190, walkSpeed: 1000, attackDelay: 1, attackMotion: 1, damageMotion: 1,
    size: 'small', race: 'plant', element: { type: 'earth', level: 1 },
    monsterClass: 'normal', aiType: 'passive', respawnMs: [300000, 600000],  // 5-10 min — rare farming spawn
    raceGroups: {},
    stats: { str: 0, agi: 0, vit: 0, int: 0, dex: 0, luk: 0, level: 1, weaponATK: 1 },
    modes: {},
...
RO_MONSTER_TEMPLATES['green_plant'] = {
    ...
    aspd: 190, walkSpeed: 1000, attackDelay: 1, attackMotion: 1, damageMotion: 1,
    size: 'small', race: 'plant', element: { type: 'earth', level: 1 },
    monsterClass: 'normal', aiType: 'passive', respawnMs: [300000, 600000],  // 5-10 min — ambient spawn
    raceGroups: {},
    stats: { str: 0, agi: 0, vit: 0, int: 0, dex: 0, luk: 0, level: 1, weaponATK: 1 },
    modes: {},
...
RO_MONSTER_TEMPLATES['black_mushroom'] = {
    ...
    aspd: 190, walkSpeed: 1000, attackDelay: 1, attackMotion: 1, damageMotion: 1,
    size: 'small', race: 'plant', element: { type: 'earth', level: 1 },
    monsterClass: 'normal', aiType: 'passive', respawnMs: [120000, 360000],  // 2-6 min — rare farming spawn
    raceGroups: {},
    stats: { str: 0, agi: 0, vit: 0, int: 0, dex: 0, luk: 0, level: 1, weaponATK: 1 },
    modes: {},
...
RO_MONSTER_TEMPLATES['crystal_1'] = {
    ...
    level: 1, maxHealth: 15, baseExp: 0, jobExp: 0, mvpExp: 0,
    attack: 0, attack2: 0, defense: 100, magicDefense: 99,
    ...
    drops: [
        ...
        { itemName: 'Gift Box', itemId: 665, rate: 49 },
...
RO_MONSTER_TEMPLATES['crystal_3'] = {
    ...
    drops: [
        ...
        { itemName: 'Candy Cane', rate: 45 },
        { itemName: 'White Chocolate', rate: 50 },
        { itemName: 'Gift Box', itemId: 664, rate: 49 },
        { itemName: 'Holiday Hat', rate: 70 },
...
RO_MONSTER_TEMPLATES['crystal_4'] = {
    ...
    drops: [
        ...
        { itemName: 'Candy Cane', rate: 45 },
        { itemName: 'White Chocolate', rate: 50 },
        { itemName: 'Gift Box', itemId: 666, rate: 49 },
        { itemName: 'Holiday Hat', rate: 70 },
        { itemName: 'Grape Juice', rate: 65 },
        { itemName: 'Chocolate', rate: 50 },
        { itemName: 'Old Blue Box', itemId: 603, rate: 1, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['poring_'] = {
    ...
    drops: [
        ...
        { itemName: 'Santa Poring Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['lunatic'] = {
    ...
    // AUDIT 2026-05-10 REVERT: rAthena + Hercules pre-re mob_db confirm Lunatic element
    // is canonically Neutral level 3 (not 1). Reverted to canonical.
...
// AUDIT 2026-05-10 REVERT: Hercules pre-re mob_db confirms Drops is canonically FIRE element
// (despite the visual "water droplet" name). Reverted from water back to fire.
RO_MONSTER_TEMPLATES['drops'] = {
    ...
    drops: [
        ...
        { itemName: 'Rod', itemId: 1602, rate: 0.8 },
...
RO_MONSTER_TEMPLATES['wilow'] = {
    ...
    drops: [
        ...
        { itemName: 'Trunk', itemId: 1019, rate: 1 },
        { itemName: 'Potato', itemId: 516, rate: 7 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['chonchon'] = {
    ...
    drops: [
        ...
        { itemName: 'Cutter', itemId: 1205, rate: 0.55 },
...
RO_MONSTER_TEMPLATES['picky_'] = {
    ...
    drops: [
        ...
        { itemName: 'Picky Egg Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['condor'] = {
    ...
    // AUDIT 2026-05-10 REVERT: rAthena + Hercules pre-re mob_db confirm Condor is
    // canonically Medium size, not Small. Reverted.
    ...
    drops: [
        ...
        { itemName: 'Bow', itemId: 1702, rate: 1.5 },
...
RO_MONSTER_TEMPLATES['thief_bug'] = {
    ...
    drops: [
        ...
        { itemName: 'Jellopy', rate: 20 },
        { itemName: 'Jacket', itemId: 2303, rate: 1.2 },
        { itemName: 'Iron Ore', rate: 2.5 },
...
RO_MONSTER_TEMPLATES['savage_babe'] = {
    ...
    drops: [
        ...
        { itemName: 'Axe', itemId: 1302, rate: 1 },
...
RO_MONSTER_TEMPLATES['hornet'] = {
    ...
    drops: [
        ...
        { itemName: 'Main Gauche', itemId: 1208, rate: 0.15 },
        { itemName: 'Green Herb', rate: 3.5 },
...
RO_MONSTER_TEMPLATES['farmiliar'] = {
    ...
    drops: [
        ...
        { itemName: 'Falchion', itemId: 1105, rate: 0.2 },
...
RO_MONSTER_TEMPLATES['rocker'] = {
    ...
    drops: [
        ...
        { itemName: 'Javelin', itemId: 1402, rate: 0.8 },
...
RO_MONSTER_TEMPLATES['desert_wolf_b'] = {
    ...
    drops: [
        ...
        { itemName: 'Adventurer\'s Suit', rate: 0.8 },
        { itemName: 'Meat', rate: 6 },
        { itemName: 'Cotton Shirt', itemId: 2301, rate: 2 },
...
RO_MONSTER_TEMPLATES['thief_bug_'] = {
    ...
    drops: [
        ...
        { itemName: 'Blade', itemId: 1108, rate: 0.15 },
...
RO_MONSTER_TEMPLATES['skeleton'] = {
    ...
    drops: [
        ...
        { itemName: 'Mace', itemId: 1505, rate: 0.8 },
        { itemName: 'Jellopy', rate: 30 },
        { itemName: 'Red Herb', rate: 8.5 },
        { itemName: 'Skull Ring', itemId: 2609, rate: 0.3 },
...
RO_MONSTER_TEMPLATES['antonio'] = {
    ...
    drops: [
        ...
        { itemName: 'Gift Box', itemId: 644, rate: 2 },
...
RO_MONSTER_TEMPLATES['mandragora'] = {
    ...
    monsterClass: 'normal', aiType: 'aggressive', respawnMs: 11600,
    raceGroups: {},
    ...
    drops: [
        ...
        { itemName: 'Spear', itemId: 1405, rate: 0.3 },
        { itemName: 'Green Herb', rate: 3.5 },
...
RO_MONSTER_TEMPLATES['worm_tail'] = {
    ...
    drops: [
        ...
        { itemName: 'Pike', itemId: 1408, rate: 0.3 },
...
RO_MONSTER_TEMPLATES['poporing'] = {
    ...
    drops: [
        ...
        { itemName: 'Main Gauche', itemId: 1207, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['zombie'] = {
    ...
    drops: [
        ...
        { itemName: 'Cursed Ruby', itemId: 724, rate: 0.05 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['snake'] = {
    ...
    drops: [
        ...
        { itemName: 'Katana', itemId: 1117, rate: 0.15 },
...
// AUDIT 2026-05-10 REVERT: rAthena master + Hercules master pre-re mob_db both confirm
// canonical Spore is level 16, HP 510, atk 24-48. The earlier "lv8/HP144" values matched
// iRO Classic 2003-2005 era but the modern canonical pre-re reference is the higher set.
RO_MONSTER_TEMPLATES['spore'] = {
    ...
    str: 1, agi: 12, vit: 12, int: 5, dex: 19, luk: 8,
    attackRange: 50, aggroRange: 0, chaseRange: 600,
    ...
    raceGroups: {},
    stats: { str: 1, agi: 12, vit: 12, int: 5, dex: 19, luk: 8, level: 16, weaponATK: 24 },
    modes: {},
    ...
    drops: [
        ...
        { itemName: 'Hat', itemId: 2220, rate: 0.4 },
...
RO_MONSTER_TEMPLATES['creamy'] = {
    ...
    drops: [
        ...
        { itemName: 'Flower', itemId: 712, rate: 5 },
...
RO_MONSTER_TEMPLATES['meta_creamy'] = {
    ...
    drops: [
        ...
        { itemName: 'Flower', itemId: 712, rate: 8 },
        { itemName: 'Creamy Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['muka'] = {
    ...
    drops: [
        ...
        { itemName: 'Red Herb', rate: 10 },
        { itemName: 'Guisarme', itemId: 1451, rate: 0.5 },
        { itemName: 'Iron Ore', rate: 2.5 },
...
RO_MONSTER_TEMPLATES['coco'] = {
    ...
    drops: [
        ...
        { itemName: 'Potato', itemId: 516, rate: 5 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['smokie'] = {
    ...
    drops: [
        ...
        { itemName: 'Potato', itemId: 516, rate: 8 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['vocal'] = {
    ...
    size: 'medium', race: 'insect', element: { type: 'earth', level: 1 },
    monsterClass: 'normal', aiType: 'aggressive', respawnMs: [900000, 1500000],  // 15-25 min — rare named spawn
...
RO_MONSTER_TEMPLATES['ghostring'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['horn'] = {
    ...
    drops: [
        ...
        { itemName: 'Guisarme', itemId: 1452, rate: 0.15 },
        { itemName: 'Shell', rate: 55 },
...
RO_MONSTER_TEMPLATES['martin'] = {
    ...
    drops: [
        ...
        { itemName: 'Goggles', itemId: 2224, rate: 0.15 },
...
RO_MONSTER_TEMPLATES['pecopeco'] = {
    ...
    drops: [
        ...
        { itemName: 'Yellow Herb', rate: 2 },
        { itemName: 'Red Herb', rate: 9 },
        { itemName: 'Wand', itemId: 1604, rate: 1 },
        { itemName: 'Orange', rate: 10 },
...
RO_MONSTER_TEMPLATES['thief_bug__'] = {
    ...
    drops: [
        ...
        { itemName: 'Slayer', itemId: 1152, rate: 0.1 },
        { itemName: 'Yellow Herb', rate: 0.9 },
        { itemName: 'Zircon', rate: 0.05 },
        { itemName: 'Katana', itemId: 1116, rate: 0.5 },
...
RO_MONSTER_TEMPLATES['elder_wilow'] = {
    ...
    drops: [
        ...
        { itemName: 'Trunk', itemId: 1019, rate: 3.5 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['marina'] = {
    // AUDIT 2026-05-10 RE-REVERT: rAthena pre-re mob_db.yml master (verified via local clone)
    // confirms Marina's canonical ID is 1141 (matching our ORIGINAL). 1145 is actually Martin.
    // Reverted to canonical 1141.
...
RO_MONSTER_TEMPLATES['orc_baby'] = {
    ...
    drops: [
        ...
        { itemName: 'Orc Helm', itemId: 2299, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['thara_frog'] = {
    ...
    drops: [
        ...
        { itemName: 'Sardonyx', itemId: 725, rate: 0.05 },
    ],
    mvpDrops: [],
};
...
// AUDIT 2026-05-10 RE-REVERT: rAthena pre-re mob_db.yml master (verified via local clone)
// confirms Metaller's canonical ID is 1058 (matching our ORIGINAL). The v2 hallucinated
// WebFetch reported 1141 but actual file has 1058. Reverted to canonical.
...
RO_MONSTER_TEMPLATES['goblin_5'] = {
    ...
    size: 'medium', race: 'demihuman', element: { type: 'water', level: 1 },
    monsterClass: 'normal', aiType: 'passive', respawnMs: 14600,
    ...
    drops: [
        ...
        { itemName: 'Wand', itemId: 1605, rate: 0.15 },
...
RO_MONSTER_TEMPLATES['anacondaq'] = {
    ...
    drops: [
        ...
        { itemName: 'Glaive', itemId: 1455, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['caramel'] = {
    ...
    drops: [
        ...
        { itemName: 'Animal\'s Skin', rate: 55 },
        { itemName: 'Glaive', itemId: 1455, rate: 0.1 },
        { itemName: 'Spear', itemId: 1405, rate: 0.15 },
        { itemName: 'Pike', itemId: 1408, rate: 0.2 },
...
RO_MONSTER_TEMPLATES['goblin_4'] = {
    ...
    drops: [
        ...
        { itemName: 'Smasher', itemId: 1508, rate: 0.1 },
        { itemName: 'Buckler', rate: 0.01 },
        { itemName: 'Red Herb', rate: 15 },
        { itemName: 'Goblin Card', rate: 0.01, stealProtected: true },
    ],
...
RO_MONSTER_TEMPLATES['zerom'] = {
    ...
    drops: [
        ...
        { itemName: 'Pantie', itemId: 2339, rate: 2 },
...
RO_MONSTER_TEMPLATES['ork_warrior'] = {
    ...
    attackRange: 50, aggroRange: 0, chaseRange: 600,
    aspd: 170, walkSpeed: 200, attackDelay: 1500, attackMotion: 500, damageMotion: 300,
    // AUDIT 2026-05-10: element corrected neutral 1 → earth 1 per Hercules pre-re mob_db.conf.
    size: 'medium', race: 'demihuman', element: { type: 'earth', level: 1 },
    ...
    drops: [
        ...
        { itemName: 'Battle Axe', itemId: 1352, rate: 0.1 },
        { itemName: 'Orcish Axe', itemId: 1304, rate: 0.05 },
        { itemName: 'Axe', itemId: 1301, rate: 1 },
...
RO_MONSTER_TEMPLATES['megalodon'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['vagabond_wolf'] = {
    ...
    drops: [
        ...
        { itemName: 'Sardonyx', itemId: 725, rate: 0.1 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['drainliar'] = {
    ...
    drops: [
        ...
        { itemName: 'Sardonyx', itemId: 725, rate: 0.2 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['goblin_2'] = {
    ...
    drops: [
        ...
        { itemName: 'Flail', itemId: 1511, rate: 0.1 },
        { itemName: 'Buckler', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['goblin_3'] = {
    ...
    attackRange: 50, aggroRange: 0, chaseRange: 600,
    aspd: 170, walkSpeed: 200, attackDelay: 1500, attackMotion: 500, damageMotion: 300,
    size: 'medium', race: 'demihuman', element: { type: 'poison', level: 1 },
    monsterClass: 'normal', aiType: 'passive', respawnMs: 15200,
    spriteClass: 'goblin', weaponMode: 0,
    raceGroups: { Goblin: true, Element: true, ElementLevel: true, WalkSpeed: true, AttackDelay: true, AttackMotion: true, ClientAttackMotion: true, DamageMotion: true, Ai: true },
...
RO_MONSTER_TEMPLATES['orc_xmas'] = {
    ...
    drops: [
        ...
        { itemName: 'Orcish Voucher', rate: 55 },
        { itemName: 'Rough Oridecon', rate: 0.4 },
        { itemName: 'Wrapping Paper', itemId: 7175, rate: 16 },
        { itemName: 'Battle Axe', itemId: 1352, rate: 0.1 },
        { itemName: 'Gift Box', itemId: 644, rate: 0.15 },
...
RO_MONSTER_TEMPLATES['bigfoot'] = {
    ...
    drops: [
        ...
        { itemName: 'Potato', itemId: 516, rate: 15 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['pirate_skel'] = {
    ...
    drops: [
        ...
        { itemName: 'Pirate Bandana', itemId: 2287, rate: 0.15 },
        { itemName: 'Level 6 Cookbook', rate: 0.05 },
        { itemName: 'Bandana', rate: 2.5 },
        { itemName: 'Falchion', itemId: 1104, rate: 2.5 },
        { itemName: 'Rough Oridecon', rate: 0.43 },
...
RO_MONSTER_TEMPLATES['goblin_1'] = {
    ...
    attackRange: 50, aggroRange: 0, chaseRange: 600,
    aspd: 170, walkSpeed: 200, attackDelay: 1500, attackMotion: 500, damageMotion: 300,
    // AUDIT 2026-05-10: element corrected neutral 1 → wind 1 per Hercules pre-re mob_db.conf.
    ...
    drops: [
        ...
        { itemName: 'Rough Oridecon', rate: 0.43 },
        { itemName: 'Goblin Mask', rate: 0.03 },
        { itemName: 'Dirk', itemId: 1211, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['gobline_xmas'] = {
    ...
    drops: [
        ...
        { itemName: 'Wrapping Paper', itemId: 7175, rate: 5.5 },
        { itemName: 'Rough Oridecon', rate: 0.43 },
        { itemName: 'Gift Box', itemId: 644, rate: 0.1 },
        { itemName: 'Dirk', itemId: 1211, rate: 0.1 },
        { itemName: 'Buckler', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['rotar_zairo'] = {
    ...
    drops: [
        ...
        { itemName: 'Padded Armor', itemId: 2312, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['flora'] = {
    ...
    drops: [
        ...
        { itemName: 'Sunflower', itemId: 2253, rate: 0.03 },
...
RO_MONSTER_TEMPLATES['desert_wolf'] = {
    ...
    drops: [
        ...
        { itemName: 'Stiletto', itemId: 1217, rate: 1.4 },
...
RO_MONSTER_TEMPLATES['rice_cake_boy'] = {
    ...
    drops: [
        ...
        { itemName: 'Bao', itemId: 553, rate: 10 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['marine_sphere'] = {
    ...
    drops: [
        ...
        { itemName: 'Chain', itemId: 1520, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['orc_skeleton'] = {
    ...
    drops: [
        ...
        { itemName: 'Rough Elunium', rate: 0.8 },
        { itemName: 'Orc Helm', itemId: 2299, rate: 0.02 },
        { itemName: 'Buster', itemId: 1358, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['cookie_xmas'] = {
    ...
    drops: [
        ...
        { itemName: 'Gift Box', itemId: 644, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['goblin_archer'] = {
    ...
    attackRange: 450, aggroRange: 0, chaseRange: 600,
    aspd: 170, walkSpeed: 200, attackDelay: 1500, attackMotion: 500, damageMotion: 300,
    size: 'small', race: 'demihuman', element: { type: 'poison', level: 1 },
    monsterClass: 'normal', aiType: 'passive', respawnMs: 16400,
    raceGroups: { Goblin: true, Element: true, ElementLevel: true, WalkSpeed: true, AttackDelay: true, AttackMotion: true, ClientAttackMotion: true, DamageMotion: true, Ai: true },
    ...
    drops: [
        ...
        { itemName: 'Red Herb', rate: 6 },
        { itemName: 'Composite Bow', itemId: 1705, rate: 0.25 },
        { itemName: 'Grape', rate: 3 },
...
RO_MONSTER_TEMPLATES['porcellio'] = {
    ...
    drops: [
        { itemName: 'Jubilee', rate: 50 },
        { itemName: 'Main Gauche', itemId: 1208, rate: 0.25 },
...
RO_MONSTER_TEMPLATES['soldier_skeleton'] = {
    ...
    drops: [
        ...
        { itemName: 'Dagger', itemId: 1214, rate: 0.12 },
        { itemName: 'Red Herb', rate: 7 },
        { itemName: 'Memento', rate: 0.1 },
        { itemName: 'Knife', itemId: 1201, rate: 1.5 },
        { itemName: 'Stiletto', itemId: 1216, rate: 0.5 },
...
RO_MONSTER_TEMPLATES['giearth'] = {
    ...
    drops: [
        ...
        { itemName: 'Elven Ears', itemId: 2286, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['sword_fish'] = {
    ...
    drops: [
        ...
        { itemName: 'Katana', itemId: 1117, rate: 0.25 },
...
RO_MONSTER_TEMPLATES['karakasa'] = {
    ...
    drops: [
        ...
        { itemName: 'Murasame', itemId: 13012, rate: 0.05 },
        { itemName: 'Karakasa Card', rate: 0.01, stealProtected: true },
        { itemName: 'Trunk', itemId: 1019, rate: 32 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['archer_skeleton'] = {
    ...
    drops: [
        ...
        { itemName: 'Apple of Archer', itemId: 2285, rate: 0.03 },
        { itemName: 'Great Bow', itemId: 1708, rate: 0.35 },
        { itemName: 'Fire Arrow', rate: 10 },
        { itemName: 'Red Herb', rate: 18 },
        { itemName: 'Bow', itemId: 1701, rate: 1.5 },
...
RO_MONSTER_TEMPLATES['kobold_2'] = {
    ...
    attackRange: 50, aggroRange: 0, chaseRange: 600,
    aspd: 170, walkSpeed: 200, attackDelay: 1500, attackMotion: 500, damageMotion: 300,
    size: 'medium', race: 'demihuman', element: { type: 'poison', level: 2 },
    ...
    drops: [
        ...
        { itemName: 'Guard', itemId: 2101, rate: 1 },
...
RO_MONSTER_TEMPLATES['kobold_3'] = {
    ...
    drops: [
        ...
        { itemName: 'Blue Hair', rate: 53.35 },
        { itemName: 'Zargon', rate: 2 },
        { itemName: 'Hammer', itemId: 1355, rate: 0.05 },
        { itemName: 'Buckler', rate: 0.03 },
        { itemName: 'Yellow Herb', rate: 1 },
        { itemName: 'Kobold Card', rate: 0.01, stealProtected: true },
    ],
...
RO_MONSTER_TEMPLATES['orc_lady'] = {
    ...
    drops: [
        ...
        { itemName: 'Earring', itemId: 2602, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['bogun'] = {
    ...
    drops: [
        ...
        { itemName: 'Bongun Hat', itemId: 5046, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['baby_leopard'] = {
    ...
    drops: [
        ...
        { itemName: 'Dagger', itemId: 1214, rate: 1 },
...
RO_MONSTER_TEMPLATES['dokebi'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Dokebi Horn', itemId: 1021, rate: 90 },
        { itemName: 'Rough Elunium', rate: 1.5 },
        { itemName: 'Sword Mace', itemId: 1517, rate: 0.02 },
        { itemName: 'Mighty Staff', itemId: 1613, rate: 0.01 },
        { itemName: 'Gold', rate: 0.01 },
        { itemName: 'Club', itemId: 1501, rate: 3 },
...
RO_MONSTER_TEMPLATES['sohee'] = {
    ...
    drops: [
        ...
        { itemName: 'Stiletto', itemId: 1217, rate: 0.05 },
        { itemName: 'Red Herb', rate: 10 },
        { itemName: 'Authoritative Badge', itemId: 662, rate: 3.5 },
...
RO_MONSTER_TEMPLATES['kobold_archer'] = {
    ...
    attackRange: 450, aggroRange: 0, chaseRange: 600,
    aspd: 170, walkSpeed: 200, attackDelay: 1500, attackMotion: 500, damageMotion: 300,
    size: 'small', race: 'demihuman', element: { type: 'fire', level: 1 },
    ...
    drops: [
        ...
        { itemName: 'Crossbow', itemId: 1711, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['miyabi_ningyo'] = {
    ...
    drops: [
        ...
        { itemName: 'Professional Cooking Kit', rate: 0.1 },
        { itemName: 'Hakujin', itemId: 13014, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['sand_man'] = {
    ...
    drops: [
        ...
        { itemName: 'Katar of Quaking', itemId: 1257, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['requiem'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.35 },
        { itemName: 'Emperium', rate: 0.01 },
        { itemName: 'Zargon', rate: 25 },
...
RO_MONSTER_TEMPLATES['cruiser'] = {
    ...
    drops: [
        ...
        { itemName: 'Monk Hat', itemId: 2251, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['steam_goblin'] = {
    ...
    drops: [
        ...
        { itemName: 'Garrison', itemId: 13104, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['noxious'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['kobold_1'] = {
    ...
    drops: [
        ...
        { itemName: 'Rough Elunium', rate: 0.25 },
        { itemName: 'Gladius', itemId: 1220, rate: 0.02 },
        { itemName: 'Buckler', rate: 0.05 },
        { itemName: 'Kobold Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
...
RO_MONSTER_TEMPLATES['mummy'] = {
    ...
    drops: [
        ...
        { itemName: 'Glove', itemId: 2604, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['verit'] = {
    ...
    drops: [
        ...
        { itemName: 'Skull Ring', itemId: 2609, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['myst'] = {
    ...
    drops: [
        ...
        { itemName: 'Trunk', itemId: 1019, rate: 8 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['jakk_xmas'] = {
    ...
    drops: [
        ...
        { itemName: 'Elunium', rate: 0.31 },
        { itemName: 'Tights', rate: 0.05 },
        { itemName: 'Gift Box', itemId: 644, rate: 0.2 },
        { itemName: 'Wrapping Paper', itemId: 7175, rate: 12 },
...
RO_MONSTER_TEMPLATES['mystcase'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.2 },
        ...
        { itemName: '2carat Diamond', itemId: 731, rate: 0.05 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['iceicle'] = {
    ...
    drops: [
        { itemName: 'Ice Cubic', rate: 10 },
        { itemName: 'Ice Cubic', rate: 10 },
        { itemName: 'Ice Cubic', rate: 10 },
        { itemName: 'Ice Cubic', rate: 5 },
        { itemName: 'Ice Cubic', rate: 5 },
        { itemName: 'Ice Cubic', rate: 5 },
        { itemName: 'Ice Cubic', rate: 5 },
        { itemName: 'Ice Cubic', rate: 5, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['ghoul'] = {
    ...
    drops: [
        ...
        { itemName: 'Skull Ring', itemId: 2609, rate: 0.6 },
...
RO_MONSTER_TEMPLATES['marduk'] = {
    ...
    drops: [
        ...
        { itemName: 'Staff', itemId: 1608, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['stem_worm'] = {
    ...
    drops: [
        ...
        { itemName: 'Glaive', itemId: 1454, rate: 0.2 },
...
RO_MONSTER_TEMPLATES['greatest_general'] = {
    ...
    drops: [
        ...
        { itemName: 'Club', itemId: 1501, rate: 1 },
        { itemName: 'Authoritative Badge', itemId: 662, rate: 3 },
        ...
        { itemName: 'Trunk', itemId: 1019, rate: 20 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['wootan_fighter'] = {
    ...
    drops: [
        ...
        { itemName: 'Waghnak', itemId: 1801, rate: 0.03 },
...
RO_MONSTER_TEMPLATES['hunter_fly'] = {
    ...
    drops: [
        ...
        { itemName: 'Mini Propeller', itemId: 2259, rate: 0.01 },
        { itemName: 'Damascus', itemId: 1226, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['chepet'] = {
    ...
    drops: [
        ...
        { itemName: 'Red Scarf', itemId: 10019, rate: 0.05 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['side_winder'] = {
    ...
    drops: [
        ...
        { itemName: 'Tsurugi', itemId: 1120, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['sageworm'] = {
    ...
    drops: [
        ...
        { itemName: 'Level 5 Fire Bolt', rate: 1 },
        { itemName: 'Blue Potion', itemId: 505, rate: 0.4 },
        { itemName: 'Level 5 Cold Bolt', rate: 1 },
        { itemName: 'Ph.D Hat', itemId: 5012, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['plasma_r'] = {
    ...
    drops: [
        ...
        { itemName: '2carat Diamond', itemId: 731, rate: 0.02 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['novus_'] = {
    ...
    drops: [
        ...
        { itemName: 'Cyfar', rate: 10.35 },
        { itemName: 'Dragon Scale', rate: 5.89 },
        { itemName: 'Yellow Novus Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['dragon_egg'] = {
    ...
    drops: [
        ...
        { itemName: '2carat Diamond', itemId: 731, rate: 0.1 },
        { itemName: '3carat Diamond', itemId: 732, rate: 0.05 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['bathory'] = {
    ...
    drops: [
        ...
        { itemName: 'Arc Wand', itemId: 1611, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['petit'] = {
    ...
    drops: [
        ...
        { itemName: 'White Herb', rate: 10 },
        { itemName: 'Flail', itemId: 1510, rate: 1.5 },
        { itemName: 'Zargon', rate: 15 },
...
RO_MONSTER_TEMPLATES['petit_'] = {
    ...
    drops: [
        ...
        { itemName: 'Zargon', rate: 15 },
        { itemName: 'Aloevera', rate: 0.15 },
        { itemName: 'Sky Petite Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['deviruchi'] = {
    ...
    drops: [
        ...
        { itemName: 'Partizan', itemId: 1458, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['poison_toad'] = {
    ...
    drops: [
        ...
        { itemName: 'Cursed Ruby', itemId: 724, rate: 0.02 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['wild_ginseng'] = {
    ...
    drops: [
        ...
        { itemName: 'Potato', itemId: 516, rate: 48 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['isis'] = {
    ...
    drops: [
        ...
        { itemName: 'Necklace', itemId: 2603, rate: 0.01 },
        { itemName: 'Shining Scale', rate: 10 },
        { itemName: 'Isis Card', rate: 0.01, stealProtected: true },
        { itemName: 'Cracked Diamond', itemId: 733, rate: 1.5 },
        { itemName: '3carat Diamond', itemId: 732, rate: 0.2 },
        { itemName: '2carat Diamond', itemId: 731, rate: 0.05 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['deviace'] = {
    ...
    drops: [
        ...
        { itemName: 'Katar of Frozen Icicle', itemId: 1256, rate: 0.03 },
...
RO_MONSTER_TEMPLATES['antique_firelock'] = {
    ...
    drops: [
        ...
        { itemName: 'Apple of Archer', itemId: 2285, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['strouf'] = {
    ...
    drops: [
        ...
        { itemName: 'Trident', itemId: 1461, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['gargoyle'] = {
    ...
    drops: [
        ...
        { itemName: 'Bow Thimble', itemId: 2619, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['li_me_mang_ryang'] = {
    ...
    drops: [
        ...
        { itemName: 'Club', itemId: 1501, rate: 0.1 },
        { itemName: 'Spike', itemId: 1523, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['nightmare'] = {
    ...
    drops: [
        ...
        { itemName: 'Rosary', itemId: 2608, rate: 0.02 },
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.3 },
        { itemName: 'Blue Potion', itemId: 505, rate: 1 },
        { itemName: 'Infiltrator', itemId: 1261, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['parasite'] = {
    ...
    drops: [
        ...
        { itemName: 'Rante Whip', itemId: 1957, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['plasma_p'] = {
    ...
    drops: [
        ...
        { itemName: 'Plasma Card', rate: 0.01, stealProtected: true },
        { itemName: '2carat Diamond', itemId: 731, rate: 0.02 },
        { itemName: 'Cursed Ruby', itemId: 724, rate: 1 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['baphomet_'] = {
    ...
    drops: [
        ...
        { itemName: 'Halberd', itemId: 1464, rate: 0.02 },
        { itemName: 'Yggdrasil Berry', rate: 0.5 },
        { itemName: 'Yggdrasil Leaf', rate: 1 },
        { itemName: 'Yellow Herb', rate: 13 },
        { itemName: 'Boots', itemId: 2405, rate: 0.5 },
        { itemName: 'Bapho Jr. Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['knocker'] = {
    ...
    drops: [
        ...
        { itemName: 'Elder Pixie\'s Beard', rate: 55 },
        { itemName: 'Elven Ears', itemId: 2286, rate: 0.01 },
        { itemName: 'Ribbon', itemId: 2208, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['nine_tail'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Blue Box', itemId: 603, rate: 1 },
        { itemName: 'Dead Branch', rate: 1 },
...
RO_MONSTER_TEMPLATES['mimic'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.45 },
        { itemName: 'Trap', rate: 12 },
        { itemName: 'Magnifier', rate: 30 },
        { itemName: 'Emperium', rate: 0.03 },
        { itemName: 'Rosary', itemId: 2626, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['injustice'] = {
    ...
    drops: [
        ...
        { itemName: 'Cyfar', rate: 35 },
        { itemName: 'Padded Armor', rate: 0.05 },
        { itemName: 'Full Plate', itemId: 2316, rate: 0.02 },
        { itemName: 'Forbidden Red Candle', rate: 0.02 },
        { itemName: 'Jamadhar', itemId: 1255, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['wind_ghost'] = {
    ...
    drops: [
        ...
        { itemName: 'Skull', itemId: 7005, rate: 5 },
        { itemName: 'Level 5 Lightening Bolt', rate: 1 },
        { itemName: 'Arc Wand', itemId: 1611, rate: 0.08 },
...
RO_MONSTER_TEMPLATES['carat'] = {
    ...
    drops: [
        ...
        { itemName: 'High Heels', itemId: 2409, rate: 0.05 },
        { itemName: 'Joker Jester', itemId: 5003, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['wooden_golem'] = {
    ...
    attackRange: 50, aggroRange: 0, chaseRange: 600,
    aspd: 170, walkSpeed: 200, attackDelay: 1500, attackMotion: 500, damageMotion: 300,
    size: 'large', race: 'plant', element: { type: 'earth', level: 4 },
...
RO_MONSTER_TEMPLATES['hylozoist'] = {
    ...
    drops: [
        ...
        { itemName: 'Angry Snarl', itemId: 5113, rate: 0.01 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['minorous'] = {
    ...
    drops: [
        ...
        { itemName: 'Two-Handed Axe', itemId: 1361, rate: 0.02 },
        { itemName: 'Hammer of Blacksmith', rate: 0.1 },
        { itemName: 'Axe', itemId: 1301, rate: 2 },
...
RO_MONSTER_TEMPLATES['raydric'] = {
    ...
    drops: [
        ...
        { itemName: 'Two-Handed Sword', itemId: 1158, rate: 0.02 },
        { itemName: 'Katana', itemId: 1116, rate: 1 },
...
RO_MONSTER_TEMPLATES['high_orc'] = {
    ...
    attackRange: 50, aggroRange: 0, chaseRange: 600,
    aspd: 170, walkSpeed: 200, attackDelay: 1500, attackMotion: 500, damageMotion: 300,
    size: 'large', race: 'demihuman', element: { type: 'fire', level: 2 },
    ...
    drops: [
        ...
        { itemName: 'Orcish Axe', itemId: 1304, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['tamruan'] = {
    ...
    drops: [
        ...
        { itemName: 'Katana', itemId: 1117, rate: 0.4 },
        { itemName: 'Bastard Sword', itemId: 1155, rate: 0.08 },
...
RO_MONSTER_TEMPLATES['wraith'] = {
    ...
    drops: [
        ...
        { itemName: 'Manteau', itemId: 2505, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['merman'] = {
    ...
    drops: [
        ...
        { itemName: 'Trident', itemId: 1460, rate: 0.03 },
...
RO_MONSTER_TEMPLATES['live_peach_tree'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['disguise'] = {
    ...
    drops: [
        ...
        { itemName: 'Rider Insignia', itemId: 2529, rate: 0.05 },
        { itemName: 'Disguise Card', rate: 0.01, stealProtected: true },
        { itemName: 'Red Muffler', itemId: 7216, rate: 48.5 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['cramp'] = {
    ...
    drops: [
        ...
        { itemName: 'Sapphire', itemId: 726, rate: 0.8 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['giant_honet'] = {
    ...
    drops: [
        ...
        { itemName: 'Staff', itemId: 1608, rate: 0.03 },
...
RO_MONSTER_TEMPLATES['geographer'] = {
    ...
    drops: [
        ...
        { itemName: 'Maneater Root', rate: 55 },
        { itemName: 'Sunflower', itemId: 2253, rate: 0.3 },
...
RO_MONSTER_TEMPLATES['the_paper'] = {
    ...
    drops: [
        ...
        { itemName: 'Kamaitachi', itemId: 13009, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['evil_cloud_hermit'] = {
    ...
    drops: [
        ...
        { itemName: 'Guitar', itemId: 1908, rate: 0.02 },
        { itemName: 'Rough Elunium', rate: 1.5 },
        { itemName: 'Level 5 Lightening Bolt', rate: 1 },
        { itemName: 'Cloud Hermit Card', rate: 0.01, stealProtected: true },
        { itemName: 'Bao', itemId: 553, rate: 68 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['joker'] = {
    ...
    drops: [
        ...
        { itemName: 'Yellow Herb', rate: 10 },
        { itemName: 'Katar of Piercing Wind', itemId: 1259, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['penomena'] = {
    ...
    drops: [
        ...
        { itemName: 'Katar of Raging Blaze', itemId: 1258, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['alarm'] = {
    ...
    drops: [
        ...
        { itemName: 'Skull', itemId: 7005, rate: 15 },
...
RO_MONSTER_TEMPLATES['leib_olmai'] = {
    ...
    drops: [
        ...
        { itemName: 'Honey', rate: 5 },
        { itemName: 'Pocket Watch', itemId: 2717, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['gibbet'] = {
    ...
    drops: [
        ...
        { itemName: 'Cursed Ruby', itemId: 724, rate: 3 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['ygnizem'] = {
    ...
    drops: [
        ...
        { itemName: 'Two-Handed Sword', itemId: 1158, rate: 0.2 },
        { itemName: 'Saber', rate: 0.2 },
        { itemName: 'Padded Armor', rate: 0.1 },
        { itemName: 'Slayer', itemId: 1152, rate: 0.8 },
...
RO_MONSTER_TEMPLATES['rideword'] = {
    ...
    drops: [
        ...
        { itemName: 'Book of Billows', itemId: 1553, rate: 0.04 },
        { itemName: 'Book of Mother Earth', itemId: 1554, rate: 0.04 },
        { itemName: 'Book of Gust of Wind', itemId: 1556, rate: 0.02 },
        { itemName: 'Bookclip in Memory', rate: 3 },
        { itemName: 'Old Magicbook', rate: 0.2 },
        { itemName: 'Rideword Card', rate: 0.01, stealProtected: true },
        { itemName: 'Book of the Blazing Sun', itemId: 1555, rate: 0.02 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['dark_frame'] = {
    ...
    drops: [
        ...
        { itemName: 'Manteau', itemId: 2505, rate: 0.3 },
...
RO_MONSTER_TEMPLATES['panzer_goblin'] = {
    ...
    drops: [
        ...
        { itemName: 'Butcher', itemId: 13158, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['see_otter'] = {
    ...
    drops: [
        ...
        { itemName: 'Sardonyx', itemId: 725, rate: 0.5 },
        { itemName: 'Sapphire', itemId: 726, rate: 0.5 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['erend'] = {
    ...
    drops: [
        ...
        { itemName: 'Morning Star', itemId: 1514, rate: 0.5 },
        { itemName: 'Sword Mace', itemId: 1517, rate: 0.2 },
...
RO_MONSTER_TEMPLATES['kavac'] = {
    ...
    drops: [
        ...
        { itemName: 'Great Bow', itemId: 1708, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['ancient_mimic'] = {
    ...
    drops: [
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.3 },
        { itemName: 'Old Purple Box', rate: 0.01 },
        { itemName: 'Gift Box', itemId: 644, rate: 0.5 },
...
RO_MONSTER_TEMPLATES['pasana'] = {
    ...
    drops: [
        ...
        { itemName: 'Falchion', itemId: 1105, rate: 5 },
        { itemName: 'Stiletto', itemId: 1217, rate: 1.5 },
        { itemName: 'Undershirt', itemId: 2522, rate: 1 },
...
RO_MONSTER_TEMPLATES['sting'] = {
    ...
    drops: [
        ...
        { itemName: 'Glove', itemId: 2624, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['am_mut'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Dokebi Horn', itemId: 1021, rate: 45.5 },
        { itemName: 'Rough Elunium', rate: 2.5 },
        { itemName: 'Sword Mace', itemId: 1517, rate: 0.03 },
        { itemName: 'Gold', rate: 0.05 },
        { itemName: 'Halo', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['mobster'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Poison Knife', itemId: 1239, rate: 0.03 },
        { itemName: 'Ring', itemId: 2621, rate: 0.01 },
        { itemName: 'Red Gemstone', rate: 6 },
        { itemName: 'Zargon', rate: 25 },
        { itemName: 'Panacea', rate: 4.5 },
        { itemName: 'Blue Potion', itemId: 505, rate: 0.6 },
        { itemName: 'Mobster Card', rate: 0.01, stealProtected: true },
        { itemName: 'Sapphire', itemId: 726, rate: 45.59 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['dragon_tail'] = {
    ...
    drops: [
        ...
        { itemName: 'Cap', itemId: 2226, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['rawrel'] = {
    ...
    drops: [
        ...
        { itemName: 'Staff', itemId: 1608, rate: 0.5 },
        { itemName: 'Silk Robe', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['hodremlin'] = {
    ...
    drops: [
        ...
        { itemName: 'Red Prickly Fruit', itemId: 587, rate: 10 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['dullahan'] = {
    ...
    drops: [
        ...
        { itemName: 'Manteau', itemId: 2505, rate: 0.13 },
        { itemName: 'Manteau', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['whikebain'] = {
    ...
    drops: [
        ...
        { itemName: 'Fortune Sword', itemId: 1223, rate: 0.01 },
        { itemName: 'Adventurer\'s Suit', rate: 0.4 },
        { itemName: 'Gladius', itemId: 1220, rate: 0.1 },
        { itemName: 'Chain Mail', rate: 0.02 },
...
RO_MONSTER_TEMPLATES['isilla'] = {
    ...
    drops: [
        ...
        { itemName: 'Ring', itemId: 2601, rate: 0.01 },
        { itemName: 'Bloody Rune', rate: 1 },
...
RO_MONSTER_TEMPLATES['aunoe'] = {
    ...
    drops: [
        ...
        { itemName: 'Memory Book', itemId: 2109, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['khalitzburg'] = {
    ...
    drops: [
        ...
        { itemName: 'Bone Helm', itemId: 5017, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['permeter'] = {
    ...
    drops: [
        ...
        { itemName: 'Trunk', itemId: 1019, rate: 12.4 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['fur_seal'] = {
    ...
    drops: [
        ...
        { itemName: 'Coat', rate: 0.05 },
        { itemName: 'Cyfar', rate: 12 },
        { itemName: 'Guisarme', itemId: 1452, rate: 0.01 },
        { itemName: 'Panacea', rate: 2 },
...
RO_MONSTER_TEMPLATES['wicked_nymph'] = {
    ...
    drops: [
        ...
        { itemName: 'Level 5 Heal', rate: 1 },
        { itemName: 'Oriental Lute', itemId: 1918, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['golden_bug'] = {
    ...
    drops: [
        ...
        { itemName: 'Golden Mace', itemId: 1524, rate: 1.5 },
        { itemName: 'Golden Gear', itemId: 2246, rate: 2.5 },
...
RO_MONSTER_TEMPLATES['goblin_leader'] = {
    ...
    drops: [
        ...
        { itemName: 'Angry Snarl', itemId: 5113, rate: 0.1 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['caterpillar'] = {
    ...
    drops: [
        ...
        { itemName: 'Blue Potion', itemId: 505, rate: 0.12 },
...
RO_MONSTER_TEMPLATES['eddga'] = {
    ...
    drops: [
        ...
        { itemName: 'Katar of Raging Blaze', itemId: 1258, rate: 5 },
...
RO_MONSTER_TEMPLATES['executioner'] = {
    ...
    drops: [
        ...
        { itemName: 'Rapier', itemId: 1111, rate: 0.8 },
        { itemName: 'Scimitar', itemId: 1114, rate: 0.6 },
...
RO_MONSTER_TEMPLATES['kobold_leader'] = {
    ...
    drops: [
        ...
        { itemName: 'Zargon', rate: 12 },
        { itemName: 'Flail', itemId: 1511, rate: 0.06 },
        { itemName: 'Mighty Staff', itemId: 1613, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['tengu'] = {
    ...
    drops: [
        ...
        { itemName: 'Huuma Giant Wheel Shuriken', itemId: 13301, rate: 0.05 },
        { itemName: 'Mastela Fruit', rate: 1.5 },
        { itemName: 'Huuma Giant Wheel Shuriken', itemId: 13302, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['majoruros'] = {
    ...
    drops: [
        ...
        { itemName: 'Two-Handed Axe', itemId: 1361, rate: 0.04 },
        { itemName: 'Lemon', rate: 3 },
...
RO_MONSTER_TEMPLATES['apocalips'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Metal Fragment', itemId: 7095, rate: 53.35 },
...
RO_MONSTER_TEMPLATES['armaia'] = {
    ...
    drops: [
        ...
        { itemName: 'Buster', itemId: 1358, rate: 0.5 },
        { itemName: 'Battle Axe', itemId: 1352, rate: 0.4 },
        { itemName: 'Mink Coat', rate: 0.1 },
        { itemName: 'Axe', itemId: 1302, rate: 0.8 },
...
RO_MONSTER_TEMPLATES['moonlight'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Spectral Spear', itemId: 1477, rate: 5 },
        { itemName: 'Moonlight Dagger', itemId: 1234, rate: 1 },
...
RO_MONSTER_TEMPLATES['diabolic'] = {
    ...
    drops: [
        ...
        { itemName: 'Brooch', itemId: 2605, rate: 0.03 },
...
RO_MONSTER_TEMPLATES['sleeper'] = {
    ...
    drops: [
        ...
        { itemName: 'Damascus', itemId: 1226, rate: 0.05 },
        { itemName: 'Hypnotist\'s Staff', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['poton_canon_1'] = {
    ...
    drops: [
        { itemName: 'Large Jellopy', rate: 50 },
        { itemName: 'Sticky Mucus', rate: 10 },
        { itemName: 'Destroyer', itemId: 13160, rate: 0.05 },
        { itemName: 'Sapphire', itemId: 726, rate: 10 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['mini_demon'] = {
    ...
    drops: [
        ...
        { itemName: 'Ahlspiess', itemId: 1478, rate: 0.05 },
...
RO_MONSTER_TEMPLATES['phreeoni'] = {
    ...
    drops: [
        ...
        { itemName: 'Fortune Sword', itemId: 1223, rate: 5 },
        { itemName: 'Sucsamad', itemId: 1236, rate: 1.5 },
...
RO_MONSTER_TEMPLATES['shinobi'] = {
    ...
    attackRange: 100, aggroRange: 0, chaseRange: 600,
    aspd: 170, walkSpeed: 200, attackDelay: 1500, attackMotion: 500, damageMotion: 300,
    size: 'medium', race: 'demihuman', element: { type: 'shadow', level: 3 },
    ...
    drops: [
        ...
        { itemName: 'Ninja Suit', itemId: 2337, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['ferus_'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Fresh Fish', itemId: 579, rate: 51 },
        { itemName: 'Dragon Canine', rate: 10 },
        { itemName: 'Dragon Scale', rate: 35.89 },
        { itemName: 'Green Bijou', rate: 8 },
        { itemName: 'Great Nature', rate: 0.2 },
        { itemName: 'Green Bijou', rate: 1 },
        { itemName: 'Green Ferus Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['aliza'] = {
    ...
    drops: [
        ...
        { itemName: 'Rosary', itemId: 2626, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['frus'] = {
    ...
    drops: [
        ...
        { itemName: 'Red Gemstone', rate: 10 },
        { itemName: 'Earring', itemId: 2622, rate: 0.03 },
        { itemName: 'Mantle', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['drake'] = {
    ...
    drops: [
        ...
        { itemName: 'Cutlus', itemId: 1135, rate: 1.5 },
        { itemName: 'Haedonggum', rate: 4 },
        { itemName: 'Corsair', itemId: 5019, rate: 3.5 },
...
RO_MONSTER_TEMPLATES['solider'] = {
    ...
    drops: [
        ...
        { itemName: 'Chain', itemId: 1519, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['skogul'] = {
    ...
    drops: [
        ...
        { itemName: 'Skull Ring', itemId: 2609, rate: 1 },
        { itemName: 'Rough Elunium', rate: 5 },
...
RO_MONSTER_TEMPLATES['rybio'] = {
    ...
    drops: [
        ...
        { itemName: '2carat Diamond', itemId: 731, rate: 0.3 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['tirfing'] = {
    ...
    drops: [
        ...
        { itemName: 'Dagger', itemId: 1214, rate: 0.7 },
        { itemName: 'Stiletto', itemId: 1217, rate: 0.4 },
        { itemName: 'Steel', rate: 1.2 },
...
RO_MONSTER_TEMPLATES['incantation_samurai'] = {
    ...
    drops: [
        ...
        { itemName: 'Huuma Blaze Shuriken', itemId: 13303, rate: 75 },
...
RO_MONSTER_TEMPLATES['teddy_bear'] = {
    ...
    drops: [
        ...
        { itemName: 'Angry Snarl', itemId: 5113, rate: 0.5 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['doppelganger'] = {
    ...
    drops: [
        ...
        { itemName: 'Zweihander', itemId: 1168, rate: 1.5 },
        { itemName: 'Spiky Band', itemId: 2258, rate: 3.5 },
        { itemName: 'Lance', itemId: 1411, rate: 5.5 },
...
RO_MONSTER_TEMPLATES['gryphon'] = {
    ...
    drops: [
        ...
        { itemName: 'Guisarme', itemId: 1452, rate: 15 },
        { itemName: 'Pole Axe', itemId: 1417, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['bloody_murderer'] = {
    ...
    drops: [
        ...
        { itemName: 'Ginnungagap', itemId: 13002, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['bacsojin'] = {
    ...
    drops: [
        ...
        { itemName: 'Tiara', itemId: 2234, rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['venatu_1'] = {
    ...
    drops: [
        ...
        { itemName: 'Crest Piece', itemId: 7356, rate: 3.5 },
        { itemName: 'Steel', rate: 3 },
...
RO_MONSTER_TEMPLATES['gemini'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Skull', itemId: 7005, rate: 30 },
        { itemName: 'Old Blue Box', itemId: 603, rate: 10 },
...
RO_MONSTER_TEMPLATES['garm'] = {
    ...
    drops: [
        ...
        { itemName: 'Katar of Frozen Icicle', itemId: 1256, rate: 5 },
...
RO_MONSTER_TEMPLATES['skeleton_general'] = {
    ...
    drops: [
        ...
        { itemName: 'Yellow Herb', rate: 8 },
        { itemName: 'Gladius', itemId: 1220, rate: 0.35 },
        { itemName: 'Gladius', itemId: 1219, rate: 0.8 },
...
RO_MONSTER_TEMPLATES['dark_snake_lord'] = {
    ...
    drops: [
        ...
        { itemName: 'Ph.D Hat', itemId: 5012, rate: 0.8 },
        { itemName: 'Gae Bolg', itemId: 1474, rate: 5 },
        { itemName: 'Soft Apron', rate: 20 },
        { itemName: 'Evil Snake Lord Card', rate: 0.01, stealProtected: true },
        { itemName: 'Pellet', itemId: 7226, rate: 9 },
    ],
    mvpDrops: [
        { itemName: 'Yggdrasil Berry', rate: 55 },
...
RO_MONSTER_TEMPLATES['mistress'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Gungnir', itemId: 1413, rate: 1.5 },
        { itemName: 'Honey', rate: 100 },
...
RO_MONSTER_TEMPLATES['orc_lord'] = {
    ...
    drops: [
        ...
        { itemName: 'Ring', itemId: 2621, rate: 4 },
        { itemName: 'Grand Circlet', itemId: 5007, rate: 4 },
        { itemName: 'Doom Slayer', itemId: 1371, rate: 4 },
...
RO_MONSTER_TEMPLATES['owl_duke'] = {
    ...
    drops: [
        ...
        { itemName: 'Guisarme', itemId: 1451, rate: 0.03 },
        { itemName: 'Morning Star', itemId: 1513, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['mysteltainn'] = {
    ...
    drops: [
        ...
        { itemName: 'Slayer', itemId: 1152, rate: 0.7 },
        { itemName: 'Bastard Sword', itemId: 1155, rate: 0.4 },
        { itemName: 'Claymore', itemId: 1163, rate: 0.02 },
        { itemName: 'Steel', rate: 1.2 },
...
RO_MONSTER_TEMPLATES['acidus_'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Blue Potion', itemId: 505, rate: 1.5 },
        ...
        { itemName: 'Blue Acidus Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['imp'] = {
    ...
    drops: [
        ...
        { itemName: 'Huuma Blaze Shuriken', itemId: 13303, rate: 0.03 },
...
RO_MONSTER_TEMPLATES['ork_hero'] = {
    ...
    drops: [
        ...
        { itemName: 'Light Epsilon', itemId: 1366, rate: 1.5 },
...
RO_MONSTER_TEMPLATES['knight_of_windstorm'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Zephyrus', itemId: 1468, rate: 1.5 },
        { itemName: 'Old Blue Box', itemId: 603, rate: 30 },
        { itemName: 'Old Purple Box', rate: 40 },
        { itemName: 'Ring', itemId: 2621, rate: 2 },
        { itemName: 'Manteau', rate: 5 },
        { itemName: 'Elunium', rate: 45.59 },
        { itemName: 'Grand Circlet', itemId: 5007, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['dark_illusion'] = {
    ...
    drops: [
        ...
        { itemName: 'Bone Helm', itemId: 5017, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['solace'] = {
    ...
    drops: [
        ...
        { itemName: 'Harp', itemId: 1909, rate: 1 },
...
RO_MONSTER_TEMPLATES['osiris'] = {
    ...
    drops: [
        ...
        { itemName: 'Assassin Dagger', itemId: 1232, rate: 1.5 },
        { itemName: 'Crown', itemId: 2235, rate: 2 },
        { itemName: 'Jamadhar', itemId: 1255, rate: 6 },
        { itemName: 'Hand of God', rate: 10 },
        { itemName: 'Sphinx Hat', itemId: 5053, rate: 1.5 },
...
RO_MONSTER_TEMPLATES['nightmare_terror'] = {
    ...
    drops: [
        ...
        { itemName: 'Rosary', itemId: 2626, rate: 0.01 },
        { itemName: 'Rosary', itemId: 2608, rate: 0.3 },
        { itemName: 'Blue Potion', itemId: 505, rate: 0.5 },
        { itemName: 'Blue Herb', rate: 1.5 },
        { itemName: 'Level 5 Soul Strike', rate: 1 },
        { itemName: 'Infiltrator', itemId: 1261, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['venatu_3'] = {
    ...
    drops: [
        { itemName: 'Rusty Screw', rate: 20 },
        { itemName: 'Crest Piece', itemId: 7358, rate: 4 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Fragment', rate: 3 },
        { itemName: 'Armor Charm', rate: 0.1 },
        { itemName: 'Elunium', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['b_ygnizem'] = {
    ...
    drops: [
        ...
        { itemName: 'Gift Box', itemId: 644, rate: 50 },
        { itemName: 'Old Blue Box', itemId: 603, rate: 50 },
        { itemName: 'Schweizersabel', itemId: 1167, rate: 10 },
...
RO_MONSTER_TEMPLATES['dimik_1'] = {
    ...
    drops: [
        ...
        { itemName: 'Transparent Plate', itemId: 7352, rate: 0.5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Fragment', rate: 3 },
...
RO_MONSTER_TEMPLATES['retribution'] = {
    ...
    drops: [
        ...
        { itemName: 'Two-Handed Sword', itemId: 1158, rate: 0.1 },
        { itemName: 'Cursed Seal', rate: 0.5 },
...
RO_MONSTER_TEMPLATES['dark_lord'] = {
    ...
    drops: [
        ...
        { itemName: 'Mage Coat', itemId: 2334, rate: 3 },
        { itemName: 'Ancient Cape', itemId: 2507, rate: 1 },
...
RO_MONSTER_TEMPLATES['dimik_3'] = {
    ...
    drops: [
        { itemName: 'Used Iron Plate', rate: 20 },
        { itemName: 'Transparent Plate', itemId: 7354, rate: 0.5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Fragment', rate: 3 },
        { itemName: 'Armor Charm', rate: 0.1 },
        { itemName: 'Oridecon', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['venatu_2'] = {
    ...
    drops: [
        { itemName: 'Rusty Screw', rate: 20 },
        { itemName: 'Crest Piece', itemId: 7357, rate: 5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Fragment', rate: 3 },
...
RO_MONSTER_TEMPLATES['shelter'] = {
    ...
    drops: [
        ...
        { itemName: 'Stone of Sage', rate: 0.5 },
        { itemName: 'Pearl', rate: 10 },
        { itemName: 'Skull', itemId: 7005, rate: 10 },
        { itemName: 'Cursed Seal', rate: 0.5 },
...
RO_MONSTER_TEMPLATES['bow_guardian'] = {
    ...
    drops: [
        ...
        { itemName: 'Bow', itemId: 1701, rate: 0.5 },
        { itemName: 'Sniping Suit', itemId: 2367, rate: 0.2 },
...
RO_MONSTER_TEMPLATES['baphomet'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Crescent Scythe', itemId: 1466, rate: 4 },
        { itemName: 'Majestic Goat', itemId: 2256, rate: 3 },
...
RO_MONSTER_TEMPLATES['maya'] = {
    ...
    drops: [
        ...
        { itemName: 'Safety Ring', itemId: 2615, rate: 2 },
        { itemName: 'Tiara', itemId: 2234, rate: 2 },
...
RO_MONSTER_TEMPLATES['skeggiold'] = {
    ...
    drops: [
        ...
        { itemName: 'Odin\'s Blessing', itemId: 2353, rate: 1 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['bloody_knight'] = {
    ...
    drops: [
        ...
        { itemName: 'Katzbalger', rate: 0.01 },
        { itemName: 'Pole Axe', itemId: 1417, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['shecil'] = {
    ...
    drops: [
        ...
        { itemName: 'Crossbow', itemId: 1711, rate: 1 },
        { itemName: 'Oridecon Arrow Quiver', rate: 1.5 },
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.5 },
...
RO_MONSTER_TEMPLATES['bloody_knight_'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Pole Axe', itemId: 1417, rate: 1 },
...
RO_MONSTER_TEMPLATES['harword'] = {
    ...
    drops: [
        ...
        { itemName: 'Two-Handed Axe', itemId: 1361, rate: 1.1 },
...
RO_MONSTER_TEMPLATES['tha_maero'] = {
    ...
    drops: [
        ...
        { itemName: '2carat Diamond', itemId: 731, rate: 5 },
        { itemName: '3carat Diamond', itemId: 732, rate: 1 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['succubus'] = {
    ...
    drops: [
        ...
        { itemName: 'Soul Staff', rate: 0.01 },
        { itemName: 'Blue Potion', itemId: 505, rate: 10 },
...
RO_MONSTER_TEMPLATES['dracula'] = {
    ...
    drops: [
        ...
        { itemName: 'Ballista', itemId: 1722, rate: 0.05 },
        { itemName: 'Ancient Cape', itemId: 2507, rate: 0.15 },
        { itemName: 'Ring', itemId: 2621, rate: 0.04 },
...
RO_MONSTER_TEMPLATES['bacsojin_'] = {
    ...
    drops: [
        ...
        { itemName: 'Tiara', itemId: 2234, rate: 0.1 },
...
RO_MONSTER_TEMPLATES['kasa'] = {
    ...
    drops: [
        ...
        { itemName: 'Lucius\'s Fierce Armor of Volcano', itemId: 2344, rate: 0.1 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['rsx_0806'] = {
    ...
    drops: [
        ...
        { itemName: 'Ice Pick', itemId: 1230, rate: 0.1 },
        { itemName: 'Ice Pick', itemId: 13017, rate: 0.01 },
        { itemName: 'Old Purple Box', rate: 10 },
        { itemName: 'Flashlight', rate: 50 },
        { itemName: 'Dagger of Counter', itemId: 1242, rate: 0.5 },
        { itemName: 'Wrench', itemId: 1531, rate: 0.2 },
...
RO_MONSTER_TEMPLATES['sword_guardian'] = {
    ...
    drops: [
        { itemName: 'Destroyed Armor', rate: 30 },
        { itemName: 'Doom Slayer', itemId: 1370, rate: 0.3 },
        { itemName: 'Claymore', itemId: 1163, rate: 0.5 },
        { itemName: 'Zweihander', itemId: 1168, rate: 0.01 },
...
RO_MONSTER_TEMPLATES['byorgue'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.4 },
...
RO_MONSTER_TEMPLATES['amon_ra'] = {
    ...
    drops: [
        { itemName: 'Sphinx Hat', itemId: 5053, rate: 1.5 },
        { itemName: 'Safety Ring', itemId: 2615, rate: 0.5 },
...
RO_MONSTER_TEMPLATES['dimik_2'] = {
    ...
    drops: [
        { itemName: 'Used Iron Plate', rate: 20 },
        { itemName: 'Transparent Plate', itemId: 7353, rate: 0.5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Fragment', rate: 3 },
...
RO_MONSTER_TEMPLATES['lady_tanee'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Steamed Desert Scorpions', itemId: 12090, rate: 50 },
...
RO_MONSTER_TEMPLATES['hydro'] = {
    ...
    drops: [
        ...
        { itemName: 'Immortal Stew', itemId: 12085, rate: 3 },
...
RO_MONSTER_TEMPLATES['gloomundernight'] = {
    ...
    drops: [
        ...
        { itemName: 'Will of Red Darkness', itemId: 7566, rate: 70 },
    ],
    mvpDrops: [
        { itemName: 'Yggdrasil Berry', rate: 55 },
        { itemName: 'Old Purple Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['magaleta'] = {
    ...
    drops: [
        ...
        { itemName: 'Rod', itemId: 1602, rate: 2 },
        { itemName: 'Hardcover Book', rate: 0.1 },
        { itemName: 'Holy Robe', itemId: 2327, rate: 0.01 },
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.5 },
...
RO_MONSTER_TEMPLATES['detale'] = {
    ...
    drops: [
        ...
        { itemName: 'Treasure Box', itemId: 7444, rate: 50 },
        { itemName: 'Fire Dragon Scale', rate: 35.89 },
        { itemName: 'Dragon Breath Cocktail', itemId: 12080, rate: 10 },
        { itemName: 'Pole Axe', itemId: 1417, rate: 1 },
...
RO_MONSTER_TEMPLATES['kiel_'] = {
    ...
    drops: [
        ...
        { itemName: 'Dagger of Counter', itemId: 1242, rate: 5 },
        { itemName: 'Morrigane\'s Belt', rate: 10 },
        { itemName: 'Kiel-D-01 Card', rate: 0.01, stealProtected: true },
        { itemName: 'Survivor\'s Rod', itemId: 1618, rate: 5 },
    ],
    mvpDrops: [
        { itemName: 'Old Purple Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['seyren'] = {
    ...
    drops: [
        { itemName: 'Handcuffs', rate: 30 },
        { itemName: 'Dragon Killer', itemId: 13001, rate: 0.02 },
        { itemName: 'Claymore', itemId: 1163, rate: 2 },
        { itemName: 'Old Blue Box', itemId: 603, rate: 0.3 },
...
RO_MONSTER_TEMPLATES['pharaoh'] = {
    ...
    drops: [
        ...
        { itemName: 'Solar Sword', itemId: 1136, rate: 1 },
        { itemName: 'Holy Robe', itemId: 2327, rate: 1.5 },
        { itemName: 'Jewel Crown', rate: 5 },
...
RO_MONSTER_TEMPLATES['lord_of_death'] = {
    ...
    drops: [
        ...
        { itemName: 'Pole Axe', itemId: 1417, rate: 0.05 },
        { itemName: 'Ice Pick', itemId: 1230, rate: 0.1 },
        { itemName: 'Ring', itemId: 2621, rate: 0.02 },
...
RO_MONSTER_TEMPLATES['turtle_general'] = {
    ...
    drops: [
        ...
        { itemName: 'Pole Axe', itemId: 1417, rate: 0.09 },
...
RO_MONSTER_TEMPLATES['apocalips_h'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Metal Fragment', itemId: 7095, rate: 50 },
        { itemName: 'Fragment', rate: 30 },
        { itemName: 'Old Purple Box', rate: 10 },
        { itemName: 'Vesper Core 01', itemId: 2659, rate: 1 },
        { itemName: 'Vesper Core 02', itemId: 2660, rate: 1 },
        { itemName: 'Vesper Core 03', itemId: 2661, rate: 1 },
        { itemName: 'Vesper Core 04', itemId: 2662, rate: 1 },
...
RO_MONSTER_TEMPLATES['ktullanux'] = {
    ...
    drops: [
        ...
        { itemName: 'Sacred Mission', itemId: 2111, rate: 50 },
        { itemName: 'Old Purple Box', rate: 50 },
        { itemName: 'Yggdrasil Berry', rate: 50 },
...
RO_MONSTER_TEMPLATES['poring_v'] = {
    ...
    drops: [
        ...
        { itemName: 'Claytos Cracking Earth Armor', itemId: 2350, rate: 25 },
        { itemName: 'Large Jellopy', rate: 100 },
        { itemName: 'Holy Guard', rate: 45, stealProtected: true },
        { itemName: 'Lucius\'s Fierce Armor of Volcano', itemId: 2344, rate: 25 },
        { itemName: 'Saphien\'s Armor of Ocean', itemId: 2346, rate: 25 },
        { itemName: 'Aebecee\'s Raging Typhoon Armor', itemId: 2348, rate: 25 },
        { itemName: 'Bloodied Shackle Ball', itemId: 2655, rate: 40 },
    ],
    mvpDrops: [
...
RO_MONSTER_TEMPLATES['b_seyren'] = {
    ...
    drops: [
        ...
        { itemName: 'Dragon Slayer', itemId: 1166, rate: 25 },
...
RO_MONSTER_TEMPLATES['b_eremes'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Moonlight Dagger', itemId: 1234, rate: 15 },
        { itemName: 'Ice Pick', itemId: 1230, rate: 15 },
        { itemName: 'Glittering Jacket', rate: 90 },
        { itemName: 'Exorciser', rate: 35 },
        { itemName: 'Assassin Dagger', itemId: 1232, rate: 35 },
        { itemName: 'Bloody Roar', rate: 35 },
        { itemName: 'Ginnungagap', itemId: 13002, rate: 35 },
...
RO_MONSTER_TEMPLATES['b_harword'] = {
    ...
    drops: [
        ...
        { itemName: 'Tomahawk', itemId: 1368, rate: 35 },
...
RO_MONSTER_TEMPLATES['b_magaleta'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Berserk', itemId: 1814, rate: 35 },
        { itemName: 'Safety Ring', itemId: 2615, rate: 25 },
        { itemName: 'Heavenly Maiden Robe', rate: 90 },
        { itemName: 'Book of the Apocalypse', rate: 35 },
        { itemName: 'Quadrille', rate: 35 },
        { itemName: 'Grand Cross', itemId: 1528, rate: 25 },
        { itemName: 'High Priest Card', rate: 0.01, stealProtected: true },
        { itemName: 'Sage\'s Diary', itemId: 1560, rate: 35 },
    ],
    mvpDrops: [
        { itemName: 'Old Purple Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['b_shecil'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Combat Knife', itemId: 1228, rate: 35 },
        { itemName: 'Sucsamad', itemId: 1236, rate: 35 },
        { itemName: 'Old Purple Box', rate: 90 },
        { itemName: 'Moonlight Dagger', itemId: 1234, rate: 15 },
        { itemName: 'Grimtooth', rate: 35 },
        { itemName: 'Rudra Bow', itemId: 1720, rate: 15 },
...
RO_MONSTER_TEMPLATES['b_katrinn'] = {
    ...
    drops: [
        ...
        { itemName: 'Dagger of Counter', itemId: 1242, rate: 35 },
        { itemName: 'Critical Ring', itemId: 2616, rate: 90 },
        { itemName: 'Robe of Cast', itemId: 2343, rate: 25 },
        ...
        { itemName: 'Survivor\'s Rod', itemId: 1618, rate: 30 },
    ],
    mvpDrops: [
        { itemName: 'Old Purple Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['thanatos'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Treasure Box', itemId: 7444, rate: 10 },
        ...
        { itemName: 'Bloodied Shackle Ball', itemId: 2655, rate: 5 },
    ],
    mvpDrops: [
        { itemName: 'Old Purple Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['ifrit'] = {
    ...
    drops: [
        ...
        { itemName: 'Spiritual Ring', itemId: 2677, rate: 30 },
...
RO_MONSTER_TEMPLATES['golden_savage'] = {
    ...
    drops: [
        ...
        { itemName: 'Treasure Box', itemId: 7444, rate: 1 },
        { itemName: 'Old Card Album', rate: 0.05 },
        { itemName: 'Gold', rate: 5 },
        { itemName: 'Emperium', rate: 1 },
        { itemName: 'Golden Gear', rate: 0.01 },
        { itemName: 'New Year Rice Cake', itemId: 12238, rate: 30 },
        { itemName: 'New Year Rice Cake', itemId: 12239, rate: 30, stealProtected: true },
    ],
    mvpDrops: [],
};
