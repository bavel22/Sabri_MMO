...
RO_MONSTER_TEMPLATES['red_plant'] = {
    ...
    drops: [
        ...
        { itemName: 'Centimental Flower', rate: 0.02, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['blue_plant'] = {
    ...
    drops: [
        ...
        { itemName: 'Stem', rate: 5 },
        { itemName: 'Pointed Scale', rate: 3 },
        { itemName: 'Fruit Of Mastela', rate: 0.5 },
        { itemName: 'Grape', rate: 10 },
        { itemName: 'Centimental Leaf', rate: 0.02, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['green_plant'] = {
    ...
    drops: [
        ...
        { itemName: 'Leaflet Of Aloe', rate: 0.5 },
        { itemName: 'Centimental Leaf', rate: 0.02, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['shining_plant'] = {
    ...
    drops: [
        ...
        { itemName: 'Seed Of Yggdrasil', rate: 0.2 },
        { itemName: 'Honey', rate: 5 },
        { itemName: 'Yggdrasilberry', rate: 0.5 },
...
RO_MONSTER_TEMPLATES['thief_mushroom'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Mushroom Of Thief 1', rate: 15 },
        { itemName: 'Mushroom Of Thief 2', rate: 30 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['fabre_'] = {
    ...
    drops: [
        ...
        { itemName: 'Azure Jewel', rate: 0.02 },
...
RO_MONSTER_TEMPLATES['crystal_1'] = {
    ...
    drops: [
        ...
        { itemName: 'Candy Striper', rate: 45 },
        { itemName: 'White Chocolate', rate: 50 },
        { itemName: 'Gift Box 2', rate: 49 },
        { itemName: 'Cone Hat', rate: 70 },
        { itemName: 'Banana Juice', rate: 65 },
        { itemName: 'Chocolate', rate: 50 },
        { itemName: 'Yggdrasilberry', rate: 2, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['crystal_2'] = {
    ...
    drops: [
        ...
        { itemName: 'Candy Striper', rate: 45 },
        { itemName: 'White Chocolate', rate: 50 },
        { itemName: 'Gift Box 4', rate: 49 },
        { itemName: 'Cone Hat', rate: 70 },
        { itemName: 'Apple Juice', rate: 65 },
        { itemName: 'Chocolate', rate: 50 },
        { itemName: 'Seed Of Yggdrasil', rate: 2.5, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['crystal_3'] = {
    ...
    drops: [
        ...
        { itemName: 'Candy Striper', rate: 45 },
        { itemName: 'White Chocolate', rate: 50 },
        { itemName: 'Gift Box 1', rate: 49 },
        { itemName: 'Cone Hat', rate: 70 },
        { itemName: 'Carrot Juice', rate: 65 },
        { itemName: 'Chocolate', rate: 50 },
        { itemName: 'Branch Of Dead Tree', rate: 3, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['fabre'] = {
    ...
    drops: [
        ...
        { itemName: 'Club', rate: 0.8 },
        { itemName: 'Azure Jewel', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['mastering'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Snowy Horn', rate: 2 },
        { itemName: 'Unripe Apple', rate: 0.5 },
        { itemName: 'Scarlet Jewel', rate: 10 },
...
RO_MONSTER_TEMPLATES['meta_fabre'] = {
    ...
    drops: [
        ...
        { itemName: 'Club', rate: 0.8 },
        { itemName: 'Azure Jewel', rate: 0.08 },
...
RO_MONSTER_TEMPLATES['pecopeco_egg'] = {
    ...
    drops: [
        ...
        { itemName: 'White Platter', rate: 0.1 },
        { itemName: 'Pecopeco Egg Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['poring_'] = {
    ...
    drops: [
        ...
        { itemName: 'Candy Striper', rate: 10 },
...
RO_MONSTER_TEMPLATES['lunatic'] = {
    ...
    drops: [
        ...
        { itemName: 'Pierrot Nose', rate: 0.04 },
...
RO_MONSTER_TEMPLATES['meta_pecopeco_egg'] = {
    ...
    drops: [
        ...
        { itemName: 'White Platter', rate: 0.15 },
        { itemName: 'Pecopeco Egg Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['wilow'] = {
    ...
    drops: [
        ...
        { itemName: 'Tree Of Archer 3', rate: 35 },
        { itemName: 'Tree Of Archer 2', rate: 20 },
        { itemName: 'Tree Of Archer 1', rate: 10 },
        { itemName: 'Wilow Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['roda_frog'] = {
    ...
    drops: [
        ...
        { itemName: 'Azure Jewel', rate: 0.07 },
        { itemName: 'Empty Bottle', rate: 20 },
...
RO_MONSTER_TEMPLATES['thief_bug'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Worm Peelings', rate: 25 },
        { itemName: 'Leather Jacket', rate: 0.8 },
        { itemName: 'Red Herb', rate: 3.5 },
        { itemName: 'Jellopy', rate: 20 },
        { itemName: 'Leather Jacket', rate: 1.2 },
        { itemName: 'Iron Ore', rate: 2.5 },
...
RO_MONSTER_TEMPLATES['eclipse'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Fillet', rate: 2 },
        { itemName: 'Red Herb', rate: 80 },
        { itemName: 'White Jewel', rate: 12 },
...
RO_MONSTER_TEMPLATES['farmiliar'] = {
    ...
    drops: [
        ...
        { itemName: 'Wing Of Fly', rate: 0.5 },
        { itemName: 'Grape', rate: 1 },
        { itemName: 'Red Herb', rate: 7 },
        { itemName: 'Center Potion', rate: 0.5 },
        { itemName: 'Farmiliar Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['dragon_fly'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Sweet Gents', rate: 2 },
        { itemName: 'Red Herb', rate: 80 },
        { itemName: 'Violet Jewel', rate: 15 },
        { itemName: 'Chonchon Doll', rate: 20 },
        { itemName: 'Clip', rate: 30 },
        { itemName: 'Lusty Iron', rate: 0.5 },
...
RO_MONSTER_TEMPLATES['rocker'] = {
    ...
    drops: [
        ...
        { itemName: 'Guitar Of Vast Land', rate: 0.1 },
        { itemName: 'Green Feeler', rate: 0.04 },
        { itemName: 'Javelin', rate: 0.8 },
        { itemName: 'Leaflet Of Hinal', rate: 0.1 },
        { itemName: 'Grasshopper Doll', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['desert_wolf_b'] = {
    ...
    drops: [
        ...
        { itemName: 'Desert Wolf Babe Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['thief_bug_'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Worm Peelings', rate: 35 },
        ...
        { itemName: 'Iron Ore', rate: 3 },
        { itemName: 'Thief Bug Female Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['toad'] = {
    ...
    drops: [
        ...
        { itemName: 'Bluish Green Jewel', rate: 10 },
        { itemName: 'Glass Bead', rate: 15 },
        { itemName: 'Alchol', rate: 1 },
        { itemName: 'Detrimindexta', rate: 1 },
        { itemName: 'Kiss Of Angel', rate: 10 },
...
RO_MONSTER_TEMPLATES['kukre'] = {
    ...
    drops: [
        ...
        { itemName: 'Worm Peelings', rate: 55 },
...
RO_MONSTER_TEMPLATES['ambernite'] = {
    ...
    drops: [
        ...
        { itemName: 'Elunium Stone', rate: 0.14 },
        { itemName: 'Iron Ore', rate: 1.5 },
...
RO_MONSTER_TEMPLATES['worm_tail'] = {
    ...
    drops: [
        ...
        { itemName: 'Worm Tail Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['snake'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Scale Of Snakes', rate: 90 },
        { itemName: 'Katana', rate: 0.15 },
        { itemName: 'Red Herb', rate: 9 },
        { itemName: 'Emveretarcon', rate: 0.35 },
        { itemName: 'Posionous Canine', rate: 8 },
        { itemName: 'Shining Scales', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['shellfish'] = {
    ...
    drops: [
        ...
        { itemName: 'Flesh Of Clam', rate: 10 },
        { itemName: 'Stone', rate: 5 },
        { itemName: 'Grit', rate: 10 },
        { itemName: 'Sparkling Dust', rate: 0.1 },
        { itemName: 'Elunium Stone', rate: 0.18 },
        { itemName: 'Shellfish Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['marin'] = {
    ...
    drops: [
        ...
        { itemName: 'Sticky Mucus', rate: 15 },
        { itemName: 'Cold Scroll 2 1', rate: 1 },
        { itemName: 'Skyblue Jewel', rate: 0.4 },
...
RO_MONSTER_TEMPLATES['boiled_rice'] = {
    ...
    drops: [
        ...
        { itemName: 'Meat Dumpling Doll', rate: 30 },
        { itemName: 'Soft Leaf', rate: 10 },
        { itemName: 'Great Leaf', rate: 10 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['creamy'] = {
    ...
    drops: [
        ...
        { itemName: 'Honey', rate: 1.5 },
        { itemName: 'Wing Of Butterfly', rate: 1 },
        { itemName: 'Fancy Flower', rate: 0.02 },
        { itemName: 'Flower', rate: 5 },
        { itemName: 'Wind Scroll 1 3', rate: 1 },
...
RO_MONSTER_TEMPLATES['stainer'] = {
    ...
    drops: [
        ...
        { itemName: 'Colorful Shell', rate: 90 },
        { itemName: 'Garlet', rate: 21 },
        { itemName: 'Elunium Stone', rate: 0.25 },
...
RO_MONSTER_TEMPLATES['meta_creamy'] = {
    ...
    drops: [
        ...
        { itemName: 'Wing Of Butterfly', rate: 2 },
...
RO_MONSTER_TEMPLATES['andre'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Worm Peelings', rate: 90 },
        { itemName: 'Garlet', rate: 10 },
        { itemName: 'Sticky Mucus', rate: 5 },
        { itemName: 'Yellow Live', rate: 0.5 },
        { itemName: 'Sparkling Dust', rate: 0.04 },
        { itemName: 'Iron Ore', rate: 3.5 },
        { itemName: 'Elunium Stone', rate: 0.28 },
...
RO_MONSTER_TEMPLATES['rafflesia'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Root Of Maneater', rate: 55 },
...
RO_MONSTER_TEMPLATES['meta_andre'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Worm Peelings', rate: 60 },
        { itemName: 'Garlet', rate: 30 },
        { itemName: 'Sticky Mucus', rate: 10 },
        { itemName: 'Shell', rate: 30 },
        { itemName: 'Sparkling Dust', rate: 0.06 },
        { itemName: 'Iron Ore', rate: 3.5 },
        { itemName: 'Elunium Stone', rate: 0.28 },
        { itemName: 'Andre Card', rate: 0.01, stealProtected: true },
    ],
...
RO_MONSTER_TEMPLATES['smokie'] = {
    ...
    drops: [
        ...
        { itemName: 'Cat Hairband', rate: 0.01 },
        { itemName: 'Raccoondog Doll', rate: 0.02 },
        { itemName: 'Zargon', rate: 0.05 },
        { itemName: 'Bluish Green Jewel', rate: 0.02 },
...
RO_MONSTER_TEMPLATES['vocal'] = {
    ...
    drops: [
        ...
        { itemName: 'Azure Jewel', rate: 10 },
        { itemName: 'Grasshopper Doll', rate: 15 },
        { itemName: 'Angel\'s Arrival', rate: 10 },
        { itemName: 'Center Potion', rate: 7 },
        { itemName: 'Guitar Of Gentle Breeze', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['martin'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Moustache Of Mole', rate: 90 },
        { itemName: 'Nail Of Mole', rate: 5 },
        { itemName: 'Jur', rate: 0.1 },
        { itemName: 'Goggle', rate: 0.05 },
        { itemName: 'Safety Helmet', rate: 0.01 },
        { itemName: 'Battered Pot', rate: 0.1 },
        { itemName: 'Goggle', rate: 0.15 },
...
RO_MONSTER_TEMPLATES['piere'] = {
    ...
    drops: [
        ...
        { itemName: 'Sparkling Dust', rate: 0.05 },
        { itemName: 'Iron Ore', rate: 4 },
        { itemName: 'Elunium Stone', rate: 0.31 },
        { itemName: 'Andre Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['meta_piere'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Worm Peelings', rate: 57 },
        { itemName: 'Garlet', rate: 11 },
        { itemName: 'Sticky Mucus', rate: 6 },
...
RO_MONSTER_TEMPLATES['pecopeco'] = {
    ...
    drops: [
        ...
        { itemName: 'Orange', rate: 10 },
        { itemName: 'Pecopeco Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['thief_bug__'] = {
    ...
    drops: [
        ...
        { itemName: 'Worm Peelings', rate: 15 },
        { itemName: 'Slayer', rate: 0.1 },
        { itemName: 'Yellow Herb', rate: 0.9 },
        { itemName: 'Bluish Green Jewel', rate: 0.05 },
        { itemName: 'Katana', rate: 0.5 },
        { itemName: 'Thief Bug Male Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['vadon'] = {
    ...
    drops: [
        ...
        { itemName: 'Elunium Stone', rate: 0.4 },
...
RO_MONSTER_TEMPLATES['deniro'] = {
    ...
    drops: [
        ...
        { itemName: 'Boody Red', rate: 0.5 },
        { itemName: 'Sparkling Dust', rate: 0.08 },
        { itemName: 'Iron Ore', rate: 4.5 },
        { itemName: 'Elunium Stone', rate: 0.34 },
        { itemName: 'Andre Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['provoke_yoyo'] = {
    ...
    drops: [
        ...
        { itemName: 'Animal\'s Skin', rate: 55 },
        { itemName: 'Monkey Doll', rate: 0.07 },
...
RO_MONSTER_TEMPLATES['elder_wilow'] = {
    ...
    drops: [
        ...
        { itemName: 'Fire Scroll 1 3', rate: 1 },
        { itemName: 'Branch Of Dead Tree', rate: 1 },
        { itemName: 'Elder Wilow Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['crab'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Crap Shell', rate: 55 },
        { itemName: 'Nipper', rate: 15 },
        { itemName: 'Stone', rate: 7 },
        { itemName: 'Sparkling Dust', rate: 0.13 },
        { itemName: 'Elunium Stone', rate: 0.37 },
...
RO_MONSTER_TEMPLATES['angeling'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Angelic Chain', rate: 1 },
        { itemName: 'Scapulare', rate: 0.6 },
        { itemName: 'Leaf Of Yggdrasil', rate: 5 },
        { itemName: 'Spirit Chain', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['vitata'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Yellow Live', rate: 0.9 },
        { itemName: 'Worm Peelings', rate: 50 },
        { itemName: 'Scell', rate: 2 },
        { itemName: 'Honey', rate: 3.5 },
        { itemName: 'Honey', rate: 3.5 },
        { itemName: 'Royal Jelly', rate: 2 },
        { itemName: 'Oridecon Stone', rate: 0.26 },
...
RO_MONSTER_TEMPLATES['yoyo'] = {
    ...
    drops: [
        ...
        { itemName: 'Monkey Doll', rate: 0.1 },
        { itemName: 'Oridecon Stone', rate: 0.24 },
...
RO_MONSTER_TEMPLATES['marina'] = {
    ...
    drops: [
        ...
        { itemName: 'Mistic Frozen', rate: 0.02 },
...
RO_MONSTER_TEMPLATES['raggler'] = {
    ...
    drops: [
        ...
        { itemName: 'Center Potion', rate: 2 },
        { itemName: 'Grape', rate: 2 },
        { itemName: 'Wind Of Verdure', rate: 0.9 },
        { itemName: 'Goggle', rate: 0.07 },
        { itemName: 'Oridecon Stone', rate: 0.32 },
...
RO_MONSTER_TEMPLATES['orc_baby'] = {
    ...
    drops: [
        ...
        { itemName: 'Viking Helm', rate: 0.01 },
        { itemName: 'Milk', rate: 50 },
        { itemName: 'Milk Bottle', rate: 2 },
        { itemName: 'Bib', rate: 1 },
...
RO_MONSTER_TEMPLATES['metaller'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Boody Red', rate: 0.6 },
        { itemName: 'Grasshopper\'s Leg', rate: 65 },
        { itemName: 'Scell', rate: 4 },
        { itemName: 'Elunium Stone', rate: 0.49 },
        { itemName: 'Singing Plant', rate: 0.2 },
        { itemName: 'Shell', rate: 30 },
        { itemName: 'Guitar Of Passion', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['goblin_5'] = {
    ...
    drops: [
        ...
        { itemName: 'Goblin Mask 03', rate: 0.15 },
...
RO_MONSTER_TEMPLATES['anacondaq'] = {
    ...
    drops: [
        ...
        { itemName: 'Posionous Canine', rate: 90 },
        { itemName: 'Glaive', rate: 0.1 },
        { itemName: 'Scale Of Snakes', rate: 15 },
        { itemName: 'Scales Shell', rate: 2 },
        { itemName: 'Yellow Herb', rate: 1.5 },
        { itemName: 'Oridecon Stone', rate: 0.5 },
...
RO_MONSTER_TEMPLATES['cornutus'] = {
    ...
    drops: [
        ...
        { itemName: 'Elunium Stone', rate: 0.53 },
...
RO_MONSTER_TEMPLATES['caramel'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Porcupine Spike', rate: 90 },
...
RO_MONSTER_TEMPLATES['goblin_4'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Yellow Live', rate: 1 },
        { itemName: 'Iron', rate: 1.7 },
        { itemName: 'Goblin Mask 01', rate: 0.15 },
        { itemName: 'Gangster Patch', rate: 0.03 },
...
RO_MONSTER_TEMPLATES['zerom'] = {
    ...
    drops: [
        ...
        { itemName: 'G Strings', rate: 2 },
        { itemName: 'Ganster Mask', rate: 0.03 },
        { itemName: 'Cuffs', rate: 0.1 },
        { itemName: 'Iron Ore', rate: 3 },
        { itemName: 'Iron Ore', rate: 3 },
...
RO_MONSTER_TEMPLATES['anopheles'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Wing Of Fly', rate: 10 },
        { itemName: 'Spawns', rate: 5 },
...
RO_MONSTER_TEMPLATES['scorpion'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Boody Red', rate: 0.7 },
        { itemName: 'Scorpion\'s Tail', rate: 55 },
        { itemName: 'Elunium Stone', rate: 0.57 },
        { itemName: 'Solid Shell', rate: 2.1 },
        { itemName: 'Fine Grit', rate: 1 },
        { itemName: 'Yellow Herb', rate: 2 },
        { itemName: 'Lusty Iron', rate: 0.2 },
...
RO_MONSTER_TEMPLATES['ork_warrior'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 0.4 },
        { itemName: 'Cigar', rate: 0.03 },
...
RO_MONSTER_TEMPLATES['vagabond_wolf'] = {
    ...
    drops: [
        ...
        { itemName: 'Claw Of Wolves', rate: 80 },
        { itemName: 'Golden Jewel', rate: 15 },
...
RO_MONSTER_TEMPLATES['eggyra'] = {
    ...
    drops: [
        ...
        { itemName: 'Center Potion', rate: 2.5 },
        { itemName: 'Elunium Stone', rate: 0.57 },
...
RO_MONSTER_TEMPLATES['goblin_2'] = {
    ...
    drops: [
        ...
        { itemName: 'Scell', rate: 90 },
        { itemName: 'Indian Hair Piece', rate: 0.03 },
        { itemName: 'Flail', rate: 0.1 },
        { itemName: 'Buckler', rate: 0.01 },
        { itemName: 'Red Herb', rate: 15.5 },
        { itemName: 'Goblini Mask', rate: 0.03 },
        { itemName: 'Goblin Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['goblin_3'] = {
    ...
    drops: [
        ...
        { itemName: 'Goblin Mask 02', rate: 0.15 },
        { itemName: 'Buckler', rate: 0.01 },
        { itemName: 'Red Herb', rate: 15.5 },
        { itemName: 'Yellow Herb', rate: 2.2 },
        { itemName: 'Goblin Card', rate: 0.01, stealProtected: true },
...
RO_MONSTER_TEMPLATES['orc_xmas'] = {
    ...
    drops: [
        ...
        { itemName: 'Orcish Voucher', rate: 55 },
        { itemName: 'Oridecon Stone', rate: 0.4 },
        { itemName: 'Packing Paper', rate: 16 },
        { itemName: 'Battle Axe', rate: 0.1 },
        { itemName: 'Gift Box', rate: 0.15 },
        { itemName: 'Packing Ribbon', rate: 16 },
        { itemName: 'Orc Warrior Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['wolf'] = {
    ...
    drops: [
        ...
        { itemName: 'Claw Of Wolves', rate: 90 },
...
RO_MONSTER_TEMPLATES['golem'] = {
    ...
    drops: [
        ...
        { itemName: 'Elunium Stone', rate: 0.7 },
...
RO_MONSTER_TEMPLATES['bigfoot'] = {
    ...
    drops: [
        ...
        { itemName: 'Stuffed Doll', rate: 0.8 },
        { itemName: 'Sweet Potato', rate: 15 },
        { itemName: 'Honey', rate: 4.5 },
        { itemName: 'Oridecon Stone', rate: 0.43 },
...
RO_MONSTER_TEMPLATES['pirate_skel'] = {
    ...
    drops: [
        ...
        { itemName: 'Cookbook06', rate: 0.05 },
        { itemName: 'Bandana', rate: 2.5 },
        { itemName: 'Falchion', rate: 2.5 },
        { itemName: 'Oridecon Stone', rate: 0.43 },
        { itemName: 'Well Dried Bone', rate: 0.2 },
        { itemName: 'Pirate Skel Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['argos'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Spiderweb', rate: 90 },
        { itemName: 'Scell', rate: 12 },
        { itemName: 'Short Leg', rate: 5 },
        { itemName: 'Elunium Stone', rate: 0.61 },
...
RO_MONSTER_TEMPLATES['gobline_xmas'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Packing Ribbon', rate: 5.5 },
        { itemName: 'Packing Paper', rate: 5.5 },
        { itemName: 'Oridecon Stone', rate: 0.43 },
...
RO_MONSTER_TEMPLATES['cookie'] = {
    ...
    drops: [
        ...
        { itemName: 'Candy Striper', rate: 1.5 },
        { itemName: 'Darkgreen Dyestuffs', rate: 0.01 },
        { itemName: 'Great Chef Orleans01', rate: 0.5 },
        { itemName: 'Sandals', rate: 0.3 },
        { itemName: 'Holy Scroll 1 3', rate: 1 },
...
RO_MONSTER_TEMPLATES['flora'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Blossom Of Maneater', rate: 90 },
...
RO_MONSTER_TEMPLATES['hode'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Yellow Live', rate: 1.2 },
        { itemName: 'Earthworm Peeling', rate: 90 },
        { itemName: 'Elunium Stone', rate: 0.8 },
        { itemName: 'Sticky Mucus', rate: 30 },
        { itemName: 'Town Sword', rate: 0.1 },
        { itemName: 'Foolishness Of Blind', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['magnolia'] = {
    ...
    drops: [
        ...
        { itemName: 'High end Cooking Kits', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['mantis'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Yellow Live', rate: 1.1 },
        { itemName: 'Limb Of Mantis', rate: 90 },
        { itemName: 'Scell', rate: 14 },
        { itemName: 'Elunium Stone', rate: 0.7 },
        { itemName: 'Solid Shell', rate: 2.5 },
        { itemName: 'Azure Jewel', rate: 0.1 },
        { itemName: 'Red Herb', rate: 6.5 },
...
RO_MONSTER_TEMPLATES['phen'] = {
    ...
    drops: [
        ...
        { itemName: 'Skyblue Jewel', rate: 0.05 },
        { itemName: 'Meat', rate: 10 },
        { itemName: 'Fin', rate: 5 },
        { itemName: 'Oridecon Stone', rate: 0.25 },
...
RO_MONSTER_TEMPLATES['savage'] = {
    ...
    drops: [
        ...
        { itemName: 'Animal Blood', rate: 0.02 },
        { itemName: 'Eagle Eyes', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['m_savage'] = {
    ...
    drops: [
        ...
        { itemName: 'Animal Blood', rate: 0.03 },
        { itemName: 'Eagle Eyes', rate: 0.02 },
...
RO_MONSTER_TEMPLATES['desert_wolf'] = {
    ...
    drops: [
        ...
        { itemName: 'Claw Of Wolves', rate: 20 },
        { itemName: 'Oridecon Stone', rate: 0.53 },
...
RO_MONSTER_TEMPLATES['rice_cake_boy'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Bamboo Cut', rate: 32 },
        { itemName: 'Oil Paper', rate: 25 },
        { itemName: 'Pierrot Nose', rate: 0.01 },
        { itemName: 'Blade Of Pinwheel', rate: 50 },
        { itemName: 'Bun', rate: 10 },
        { itemName: 'Festival Mask', rate: 30 },
        { itemName: 'Rice Cake Boy Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['marine_sphere'] = {
    ...
    drops: [
        ...
        { itemName: 'Skyblue Jewel', rate: 0.1 },
        { itemName: 'Blue Gemstone', rate: 1.5 },
        { itemName: 'Transparent Headgear', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['orc_skeleton'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Orcish Cuspid', rate: 55 },
        { itemName: 'Skel Bone', rate: 35 },
        { itemName: 'Elunium Stone', rate: 0.8 },
        { itemName: 'Viking Helm', rate: 0.02 },
...
RO_MONSTER_TEMPLATES['cookie_xmas'] = {
    ...
    drops: [
        { itemName: 'Well Baked Cookie', rate: 15 },
        { itemName: 'Scarlet Jewel', rate: 0.45 },
        { itemName: 'Zargon', rate: 2 },
        { itemName: 'Hood', rate: 0.25 },
        { itemName: 'Gift Box', rate: 0.05 },
        { itemName: 'Cold Scroll 1 3', rate: 1 },
        { itemName: 'Red Herb', rate: 17 },
        { itemName: 'Cookie XMAS Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['soldier_skeleton'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 0.6 },
        { itemName: 'Dagger', rate: 0.12 },
        { itemName: 'Red Herb', rate: 7 },
        { itemName: 'Mementos', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['giearth'] = {
    ...
    drops: [
        ...
        { itemName: 'Sparkling Dust', rate: 1 },
...
RO_MONSTER_TEMPLATES['munak'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Danggie', rate: 90 },
        { itemName: 'Munak Turban', rate: 0.02 },
        { itemName: 'Shoes', rate: 0.15 },
        { itemName: 'Amulet', rate: 0.2 },
        { itemName: 'Ninja Suit', rate: 0.01 },
        { itemName: 'Adventure Suit', rate: 1 },
...
RO_MONSTER_TEMPLATES['sword_fish'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Mistic Frozen', rate: 0.1 },
        { itemName: 'Sharp Scale', rate: 90 },
        { itemName: 'Oridecon Stone', rate: 0.33 },
        { itemName: 'Snowy Horn', rate: 0.02 },
        { itemName: 'Elunium Stone', rate: 0.5 },
        { itemName: 'Katana', rate: 0.25 },
        { itemName: 'Gill', rate: 6 },
        { itemName: 'Sword Fish Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['frilldora'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Lizard Scruff', rate: 55 },
        { itemName: 'Elunium Stone', rate: 0.9 },
        { itemName: 'Reptile Tongue', rate: 15 },
        { itemName: 'Azure Jewel', rate: 0.15 },
        { itemName: 'Yellow Gemstone', rate: 2 },
        { itemName: 'Red Herb', rate: 8 },
...
RO_MONSTER_TEMPLATES['skel_worker'] = {
    ...
    drops: [
        ...
        { itemName: 'Skel Worker Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['sasquatch'] = {
    ...
    drops: [
        ...
        { itemName: 'Feather', rate: 10 },
        { itemName: 'Panda Cap', rate: 0.01 },
        { itemName: 'Bear\'s Foot', rate: 50 },
        { itemName: 'White Jewel', rate: 0.3 },
        { itemName: 'Elunium Stone', rate: 0.9 },
...
RO_MONSTER_TEMPLATES['karakasa'] = {
    ...
    drops: [
        ...
        { itemName: 'Bamboo Cut', rate: 42.68 },
        { itemName: 'Wooden Block', rate: 32 },
        { itemName: 'Smooth Paper', rate: 22 },
...
RO_MONSTER_TEMPLATES['archer_skeleton'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 0.7 },
...
RO_MONSTER_TEMPLATES['obeaune'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Mistic Frozen', rate: 0.13 },
        { itemName: 'Heart Of Mermaid', rate: 90 },
        { itemName: 'Fin Helm', rate: 0.01 },
        { itemName: 'Saint Robe', rate: 0.1 },
        { itemName: 'Skyblue Jewel', rate: 0.1 },
        { itemName: 'Fin', rate: 5 },
...
RO_MONSTER_TEMPLATES['kobold_2'] = {
    ...
    drops: [
        { itemName: 'Steel', rate: 1 },
        { itemName: 'Cobold Hair', rate: 53.35 },
        { itemName: 'Zargon', rate: 2 },
...
RO_MONSTER_TEMPLATES['marse'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Chinese Ink', rate: 90 },
        { itemName: 'Tentacle', rate: 30 },
        { itemName: 'Blue Gemstone', rate: 2 },
        { itemName: 'Skyblue Jewel', rate: 0.1 },
        { itemName: 'Mistic Frozen', rate: 0.12 },
        { itemName: 'Penetration', rate: 0.05 },
        { itemName: 'Grape', rate: 3 },
...
RO_MONSTER_TEMPLATES['zenorc'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Tooth Of', rate: 55 },
        { itemName: 'Oridecon Stone', rate: 0.7 },
        { itemName: 'Sticky Mucus', rate: 25 },
        { itemName: 'Old Magic Book', rate: 0.05 },
        { itemName: 'Yellow Herb', rate: 1 },
...
RO_MONSTER_TEMPLATES['orc_lady'] = {
    ...
    drops: [
        ...
        { itemName: 'High end Cooking Kits', rate: 0.1 },
        { itemName: 'Cookbook06', rate: 0.03 },
...
RO_MONSTER_TEMPLATES['bon_gun'] = {
    ...
    drops: [
        ...
        { itemName: 'Bon Gun Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['tri_joint'] = {
    ...
    drops: [
        ...
        { itemName: 'Aloebera', rate: 2 },
        { itemName: 'Yellow Live', rate: 1.6 },
        { itemName: 'Sparkling Dust', rate: 1.4 },
        { itemName: 'Elunium Stone', rate: 1.06 },
...
RO_MONSTER_TEMPLATES['baby_leopard'] = {
    ...
    drops: [
        ...
        { itemName: 'Leopard Talon', rate: 32 },
        { itemName: 'Oridecon Stone', rate: 1.5 },
...
RO_MONSTER_TEMPLATES['dokebi'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Dokkaebi Horn', rate: 90 },
        { itemName: 'Elunium Stone', rate: 1.5 },
...
RO_MONSTER_TEMPLATES['kobold_archer'] = {
    ...
    drops: [
        ...
        { itemName: 'Cobold Hair', rate: 48.5 },
        { itemName: 'Ear Of Puppy', rate: 0.5 },
        { itemName: 'Poison Arrow', rate: 20 },
        { itemName: 'CrossBow', rate: 0.05 },
        { itemName: 'Oridecon Stone', rate: 0.79 },
...
RO_MONSTER_TEMPLATES['horong'] = {
    ...
    drops: [
        ...
        { itemName: 'Elunium Stone', rate: 1.18 },
        { itemName: 'Baked Yam', rate: 0.2 },
        { itemName: 'Alchol', rate: 0.5 },
...
RO_MONSTER_TEMPLATES['sand_man'] = {
    ...
    drops: [
        ...
        { itemName: 'Sparkling Dust', rate: 2 },
        { itemName: 'Katar Of Thornbush', rate: 0.01 },
        { itemName: 'Hypnotist\'s Staff', rate: 0.05 },
        { itemName: 'Sand Man Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['whisper'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Sparkling Dust', rate: 1.5 },
        { itemName: 'Transparent Cloth', rate: 53.35 },
        { itemName: 'Spirit Chain', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['whisper_'] = {
    ...
    drops: [
        { itemName: 'Sparkling Dust', rate: 0.1 },
        { itemName: 'Transparent Cloth', rate: 1 },
...
RO_MONSTER_TEMPLATES['whisper_boss'] = {
    ...
    drops: [
        ...
        { itemName: 'Spirit Chain', rate: 0.01 },
        { itemName: 'Silver Robe', rate: 0.1 },
        { itemName: 'Whisper Boss Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['kind_of_beetle'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Solid Peeling', rate: 65 },
        { itemName: 'Beetle Nipper', rate: 45 },
        { itemName: 'Insect Feeler', rate: 10 },
        { itemName: 'Worm Peelings', rate: 5 },
        { itemName: 'Guard', rate: 0.01 },
        { itemName: 'Kind Of Beetle Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['requiem'] = {
    ...
    drops: [
        ...
        { itemName: 'Mementos', rate: 15 },
        { itemName: 'Mantle', rate: 0.1 },
        { itemName: 'Cookbook06', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['steam_goblin'] = {
    ...
    drops: [
        ...
        { itemName: 'The Garrison', rate: 0.05 },
        { itemName: 'Elunium Stone', rate: 1.24 },
        { itemName: 'Steam Goblin Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['zipper_bear'] = {
    ...
    drops: [
        ...
        { itemName: 'Mystery Iron Bit', rate: 35 },
...
RO_MONSTER_TEMPLATES['noxious'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Poisonous Gas', rate: 10 },
        { itemName: 'Mould Powder', rate: 30 },
        { itemName: 'Anodyne', rate: 0.5 },
        { itemName: 'Air Pollutant', rate: 30 },
...
RO_MONSTER_TEMPLATES['marc'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Mistic Frozen', rate: 0.18 },
        { itemName: 'Gill', rate: 90 },
        { itemName: 'Oridecon Stone', rate: 0.95 },
...
RO_MONSTER_TEMPLATES['lude'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Pumpkin Bucket', rate: 32 },
        { itemName: 'Ectoplasm', rate: 57.23 },
        { itemName: 'Transparent Cloth', rate: 10 },
        { itemName: 'Spirit Chain', rate: 0.1 },
        { itemName: 'Elunium Stone', rate: 0.1 },
        { itemName: 'Holy Scroll 1 3', rate: 1 },
...
RO_MONSTER_TEMPLATES['mole'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Moustache Of Mole', rate: 50 },
        { itemName: 'Nail Of Mole', rate: 50 },
        { itemName: 'Super Novice Hat', rate: 0.5 },
        { itemName: 'Six Shooter', rate: 0.05 },
        { itemName: 'Mole Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['mummy'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 1 },
        { itemName: 'Mementos', rate: 5.5 },
...
RO_MONSTER_TEMPLATES['myst'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 0.65 },
        { itemName: 'Elunium Stone', rate: 0.97 },
...
RO_MONSTER_TEMPLATES['jakk_xmas'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Pumpkin Head', rate: 53.35 },
        { itemName: 'Zargon', rate: 9 },
        { itemName: 'Elunium', rate: 0.31 },
        { itemName: 'Tights', rate: 0.05 },
        { itemName: 'Gift Box', rate: 0.2 },
        { itemName: 'Packing Paper', rate: 12 },
        { itemName: 'Packing Ribbon', rate: 12 },
        { itemName: 'Jakk Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['mystcase'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Candy Striper', rate: 0.9 },
        { itemName: 'Zargon', rate: 15 },
        { itemName: 'Old Blue Box', rate: 0.2 },
        { itemName: 'Piece Of Cake', rate: 8 },
        { itemName: 'Scarlet Jewel', rate: 1.5 },
        { itemName: 'Crystal Jewel', rate: 0.05 },
        { itemName: 'Candy', rate: 3.4 },
        { itemName: 'Mystcase Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['leaf_cat'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Great Leaf', rate: 43.65 },
        { itemName: 'Leaflet Of Hinal', rate: 3 },
        { itemName: 'Seed Of Yggdrasil', rate: 0.05 },
        { itemName: 'Fish Tail', rate: 11 },
        { itemName: 'Lemon', rate: 2.5 },
        { itemName: 'Prawn', rate: 5 },
        { itemName: 'Leaf Clothes', rate: 53.35 },
...
RO_MONSTER_TEMPLATES['wootan_shooter'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Air Rifle', rate: 45 },
        { itemName: 'Flexible String', rate: 35 },
...
RO_MONSTER_TEMPLATES['ghoul'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 1.1 },
        { itemName: 'White Herb', rate: 7 },
        { itemName: 'Green Herb', rate: 8 },
        { itemName: 'Skul Ring', rate: 0.6 },
        { itemName: 'Mementos', rate: 1.5 },
        { itemName: 'Ghoul Leg', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['marduk'] = {
    ...
    drops: [
        ...
        { itemName: 'Sacred Masque', rate: 43.65 },
        { itemName: 'Staff', rate: 0.1 },
        { itemName: 'Mitten Of Presbyter', rate: 0.01 },
        { itemName: 'Blessed Wand', rate: 0.03 },
        { itemName: 'Fire Scroll 1 5', rate: 1 },
        { itemName: 'Book Of Devil', rate: 0.2 },
...
RO_MONSTER_TEMPLATES['stem_worm'] = {
    ...
    drops: [
        ...
        { itemName: 'Jump Rope', rate: 0.1 },
        { itemName: 'Oridecon Stone', rate: 1.15 },
        { itemName: 'Great Nature', rate: 0.05 },
        { itemName: 'Glaive', rate: 0.2 },
        { itemName: 'Seed Of Yggdrasil', rate: 0.45 },
...
RO_MONSTER_TEMPLATES['neraid'] = {
    ...
    drops: [
        ...
        { itemName: 'Whip Of Ice Piece', rate: 0.1 },
        { itemName: 'Grape', rate: 2.5 },
        { itemName: 'Elunium Stone', rate: 1.8 },
        { itemName: 'Elunium', rate: 0.37 },
        { itemName: 'Neraid Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['pest'] = {
    ...
    drops: [
        ...
        { itemName: 'Animal Blood', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['greatest_general'] = {
    ...
    drops: [
        ...
        { itemName: 'Inspector Certificate', rate: 3 },
        { itemName: 'Stop Post', rate: 0.01 },
        { itemName: 'Yellow Herb', rate: 2.5 },
        { itemName: 'Earth Scroll 1 3', rate: 1 },
...
RO_MONSTER_TEMPLATES['quve'] = {
    ...
    drops: [
        ...
        { itemName: 'Ectoplasm', rate: 57.23 },
        { itemName: 'Wing Of Fly', rate: 10 },
        { itemName: 'Poison Powder', rate: 1 },
        { itemName: 'Oridecon Stone', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['argiope'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Short Leg', rate: 53.35 },
        { itemName: 'Zargon', rate: 12 },
        { itemName: 'Elunium Stone', rate: 1.75 },
...
RO_MONSTER_TEMPLATES['marionette'] = {
    ...
    drops: [
        ...
        { itemName: 'Fire Scroll 3 5', rate: 1 },
        { itemName: 'Chain', rate: 0.15 },
        { itemName: 'Chrystal Pumps', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['kapha'] = {
    ...
    drops: [
        ...
        { itemName: 'Leaflet Of Aloe', rate: 23 },
        { itemName: 'Ment', rate: 0.02 },
        { itemName: 'Guitar Of Blue Solo', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['wootan_fighter'] = {
    ...
    drops: [
        ...
        { itemName: 'Shoulder Protection', rate: 40 },
        { itemName: 'Waghnakh', rate: 0.03 },
...
RO_MONSTER_TEMPLATES['hunter_fly'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 1.29 },
...
RO_MONSTER_TEMPLATES['chepet'] = {
    ...
    drops: [
        ...
        { itemName: 'Ragamuffin Cape', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['alligator'] = {
    ...
    drops: [
        ...
        { itemName: 'Seed Of Yggdrasil', rate: 0.5 },
        { itemName: 'Oridecon Stone', rate: 1.29 },
...
RO_MONSTER_TEMPLATES['stone_shooter'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Solid Twig', rate: 50 },
        { itemName: 'Log', rate: 50 },
        { itemName: 'Browny Root', rate: 10 },
        { itemName: 'Wooden Block', rate: 20 },
        { itemName: 'Oridecon Stone', rate: 1 },
        { itemName: 'Stone', rate: 10 },
...
RO_MONSTER_TEMPLATES['venomous'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Air Pollutant', rate: 50 },
        { itemName: 'Spawns', rate: 30 },
        { itemName: 'Poison Powder', rate: 10 },
        { itemName: 'Poisonous Gas', rate: 20 },
        { itemName: 'Old Blue Box', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['novus'] = {
    ...
    drops: [
        ...
        { itemName: 'Novus Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['side_winder'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Shining Scales', rate: 53.35 },
        { itemName: 'Zargon', rate: 14 },
        { itemName: 'Oridecon Stone', rate: 1.34 },
        { itemName: 'Tsurugi', rate: 0.02 },
        { itemName: 'Posionous Canine', rate: 25 },
        { itemName: 'Scale Of Snakes', rate: 50 },
        { itemName: 'White Herb', rate: 10 },
        { itemName: 'Side Winder Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['punk'] = {
    ...
    drops: [
        ...
        { itemName: 'Pacifier', rate: 1 },
        { itemName: 'Starsand Of Witch', rate: 10 },
        { itemName: 'Moth Dust', rate: 30 },
        { itemName: 'Wing Of Fly', rate: 11 },
...
RO_MONSTER_TEMPLATES['choco'] = {
    ...
    drops: [
        ...
        { itemName: 'Yggdrasilberry', rate: 0.25 },
...
RO_MONSTER_TEMPLATES['sageworm'] = {
    ...
    drops: [
        ...
        { itemName: 'Cold Scroll 1 5', rate: 1 },
        { itemName: 'Ph.D Hat', rate: 0.01 },
        { itemName: 'Sageworm Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['blazzer'] = {
    ...
    drops: [
        ...
        { itemName: 'Blazzer Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['plasma_r'] = {
    ...
    drops: [
        { itemName: 'Scell', rate: 1 },
        { itemName: 'Gift Box', rate: 0.1 },
        { itemName: 'Crystal Jewel', rate: 0.02 },
        { itemName: 'Red Gemstone', rate: 1 },
        { itemName: 'Boody Red', rate: 0.45 },
...
RO_MONSTER_TEMPLATES['dragon_egg'] = {
    ...
    drops: [
        ...
        { itemName: 'Crystal Jewel', rate: 0.1 },
        { itemName: 'Crystal Jewel', rate: 0.05 },
        { itemName: 'Dark Red Jewel', rate: 0.1 },
        { itemName: 'Skyblue Jewel', rate: 0.1 },
        { itemName: 'Golden Jewel', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['bathory'] = {
    ...
    drops: [
        { itemName: 'Sparkling Dust', rate: 2 },
        { itemName: 'Starsand Of Witch', rate: 48.5 },
        { itemName: 'Star Sparkling', rate: 0.03 },
        { itemName: 'Arc Wand', rate: 0.05 },
        { itemName: 'Star Crumb', rate: 0.3 },
        { itemName: 'Old Magic Book', rate: 0.15 },
...
RO_MONSTER_TEMPLATES['petit'] = {
    ...
    drops: [
        ...
        { itemName: 'Dragon Train', rate: 3 },
        { itemName: 'Oridecon Stone', rate: 1.4 },
        { itemName: 'White Herb', rate: 10 },
        { itemName: 'Flail', rate: 1.5 },
        { itemName: 'Zargon', rate: 15 },
        { itemName: 'Aloebera', rate: 0.15 },
        { itemName: 'Petit Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['megalith'] = {
    ...
    drops: [
        ...
        { itemName: 'Stone', rate: 10 },
        { itemName: 'Old Violet Box', rate: 0.01 },
        { itemName: 'Elunium', rate: 0.61 },
        { itemName: 'Elunium Stone', rate: 2.07 },
...
RO_MONSTER_TEMPLATES['deviruchi'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Petite DiablOfs Horn', rate: 53.35 },
        { itemName: 'Petite DiablOfs Wing', rate: 4 },
        { itemName: 'Oridecon', rate: 0.02 },
        { itemName: 'Partizan', rate: 0.02 },
        { itemName: 'Sacred Marks', rate: 0.05 },
        { itemName: 'Zargon', rate: 15 },
        { itemName: 'Oridecon Stone', rate: 1.54 },
...
RO_MONSTER_TEMPLATES['brilight'] = {
    ...
    drops: [
        ...
        { itemName: 'Zargon', rate: 12 },
        { itemName: 'Wing Of Butterfly', rate: 10 },
        { itemName: 'Elunium Stone', rate: 2.2 },
        { itemName: 'Leaf Of Yggdrasil', rate: 2.5 },
...
RO_MONSTER_TEMPLATES['explosion'] = {
    ...
    drops: [
        ...
        { itemName: 'Hot Hair', rate: 32 },
        { itemName: 'Oridecon Stone', rate: 8 },
        { itemName: 'Fruit Of Mastela', rate: 4 },
...
RO_MONSTER_TEMPLATES['poison_toad'] = {
    ...
    drops: [
        ...
        { itemName: 'Poison Powder', rate: 24 },
        { itemName: 'Gold Ring', rate: 0.04 },
        { itemName: 'Green Herb', rate: 5.4 },
        { itemName: 'Cardinal Jewel', rate: 0.02 },
        { itemName: 'Royal Jelly', rate: 0.02 },
        { itemName: 'Cinquedea', rate: 0.1 },
        { itemName: 'Poison Toad Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['wild_ginseng'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Leaflet Of Hinal', rate: 35 },
        { itemName: 'Leaflet Of Aloe', rate: 35 },
        { itemName: 'Root Of Maneater', rate: 38 },
        { itemName: 'Blossom Of Maneater', rate: 48 },
        { itemName: 'Sweet Potato', rate: 48 },
        { itemName: 'Rope', rate: 0.01 },
        { itemName: 'Strawberry', rate: 10 },
        { itemName: 'Wild Ginseng Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['drosera'] = {
    ...
    drops: [
        ...
        { itemName: 'Sticky Mucus', rate: 30 },
        { itemName: 'Blossom Of Maneater', rate: 20 },
        { itemName: 'Root Of Maneater', rate: 20 },
...
RO_MONSTER_TEMPLATES['isis'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Scales Shell', rate: 53.35 },
        { itemName: 'Circlet', rate: 0.05 },
        { itemName: 'Necklace', rate: 0.01 },
        { itemName: 'Crystal Jewel', rate: 1.5 },
        { itemName: 'Crystal Jewel', rate: 0.2 },
        { itemName: 'Shining Scales', rate: 10 },
        { itemName: 'Crystal Jewel', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['deviace'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Mistic Frozen', rate: 0.25 },
        { itemName: 'Tooth Of Ancient Fish', rate: 90 },
        { itemName: 'Lip Of Ancient Fish', rate: 10 },
        { itemName: 'Antenna', rate: 0.02 },
        { itemName: 'Detrimindexta', rate: 2 },
        { itemName: 'Katar Of Cold Icicle', rate: 0.03 },
        { itemName: 'Oridecon Stone', rate: 1.61 },
...
RO_MONSTER_TEMPLATES['iron_fist'] = {
    ...
    drops: [
        ...
        { itemName: 'Elunium Stone', rate: 2.29 },
        { itemName: 'Elunium Stone', rate: 0.22 },
...
RO_MONSTER_TEMPLATES['antique_firelock'] = {
    ...
    drops: [
        ...
        { itemName: 'Nice Sweet Potato', rate: 3.5 },
        { itemName: 'Panacea', rate: 2.5 },
        { itemName: 'The Cyclone', rate: 0.05 },
        { itemName: 'Antique Firelock Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['strouf'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 1.15 },
        { itemName: 'Granpa Beard', rate: 0.02 },
        { itemName: 'Trident', rate: 0.02 },
        { itemName: 'Feather', rate: 30 },
        { itemName: 'Skyblue Jewel', rate: 0.2 },
...
RO_MONSTER_TEMPLATES['gargoyle'] = {
    ...
    drops: [
        ...
        { itemName: 'Petite DiablOfs Wing', rate: 5 },
        { itemName: 'Thimble Of Archer', rate: 0.01 },
        { itemName: 'Silence Arrow', rate: 20 },
        { itemName: 'Elunium Stone', rate: 2.38 },
...
RO_MONSTER_TEMPLATES['li_me_mang_ryang'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Tiger Skin Panties', rate: 45 },
        { itemName: 'Little Blacky Ghost', rate: 4 },
        { itemName: 'Club', rate: 0.1 },
        { itemName: 'Spike', rate: 0.01 },
        { itemName: 'Li Me Mang Ryang Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['orc_archer'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Sharpened Cuspid', rate: 46.56 },
...
RO_MONSTER_TEMPLATES['parasite'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Germinating Sprout', rate: 55 },
        { itemName: 'Soft Leaf', rate: 20 },
        { itemName: 'Thin Stem', rate: 38.8 },
        { itemName: 'Great Leaf', rate: 5 },
        { itemName: 'Rante', rate: 0.01 },
        { itemName: 'Bladed Whip', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['chung_e'] = {
    ...
    drops: [
        ...
        { itemName: 'Stuffed Doll', rate: 1 },
        { itemName: 'Hora', rate: 0.1 },
        { itemName: 'Honey', rate: 5 },
        { itemName: 'Tantanmen', rate: 0.2 },
        { itemName: 'Hat Of Cake', rate: 0.5 },
        { itemName: 'Hair Protector', rate: 0.02, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['plasma_p'] = {
    ...
    drops: [
        ...
        { itemName: 'Crystal Jewel', rate: 0.02 },
        { itemName: 'Red Gemstone', rate: 1 },
        { itemName: 'Cardinal Jewel', rate: 1 },
        { itemName: 'Plasma Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['baphomet_'] = {
    ...
    drops: [
        ...
        { itemName: 'Yggdrasilberry', rate: 0.5 },
        { itemName: 'Leaf Of Yggdrasil', rate: 1 },
        { itemName: 'Yellow Herb', rate: 13 },
...
RO_MONSTER_TEMPLATES['dryad'] = {
    ...
    drops: [
        ...
        { itemName: 'Great Leaf', rate: 10 },
        { itemName: 'Browny Root', rate: 30 },
        { itemName: 'Rope', rate: 0.8 },
        { itemName: 'Chemeti', rate: 0.01 },
        { itemName: 'Centimental Leaf', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['kraben'] = {
    ...
    drops: [
        ...
        { itemName: 'Leaflet Of Aloe', rate: 10 },
        { itemName: 'Guard', rate: 0.01 },
        { itemName: 'Bamboo Basket', rate: 48.5 },
        { itemName: 'Chilli', rate: 10 },
        { itemName: 'Old Blue Box', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['mimic'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Old Violet Box', rate: 0.05 },
        { itemName: 'Old Blue Box', rate: 0.45 },
        { itemName: 'Booby Trap', rate: 12 },
        { itemName: 'Spectacles', rate: 30 },
        { itemName: 'Emperium', rate: 0.03 },
        { itemName: 'Rosary', rate: 0.01 },
        { itemName: 'Elunium Stone', rate: 2.7 },
...
RO_MONSTER_TEMPLATES['injustice'] = {
    ...
    drops: [
        ...
        { itemName: 'Cyfar', rate: 35 },
        { itemName: 'Padded Armor', rate: 0.05 },
        { itemName: 'Plate Armor', rate: 0.02 },
        { itemName: 'Prohibition Red Candle', rate: 0.02 },
...
RO_MONSTER_TEMPLATES['wind_ghost'] = {
    ...
    drops: [
        ...
        { itemName: 'Wind Scroll 1 5', rate: 1 },
        { itemName: 'Arc Wand', rate: 0.08 },
        { itemName: 'Rough Wind', rate: 1 },
        { itemName: 'Bone Wand', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['wooden_golem'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Heart Of Tree', rate: 40 },
        { itemName: 'Browny Root', rate: 40 },
        { itemName: 'Elunium Stone', rate: 1.1 },
        { itemName: 'Centimental Leaf', rate: 0.1 },
        { itemName: 'Branch Of Dead Tree', rate: 1 },
        { itemName: 'Log', rate: 50 },
...
RO_MONSTER_TEMPLATES['increase_soil'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Dried Sand', rate: 43.65 },
        { itemName: 'Mud Lump', rate: 23 },
        { itemName: 'Great Nature', rate: 0.1 },
        { itemName: 'Gold', rate: 0.02 },
        { itemName: 'Increase Soil Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['minorous'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 1.96 },
...
RO_MONSTER_TEMPLATES['raydric'] = {
    ...
    drops: [
        ...
        { itemName: 'Iron Cane', rate: 0.01 },
        { itemName: 'Chain Mail', rate: 0.02 },
        { itemName: 'Two Hand Sword', rate: 0.02 },
        { itemName: 'Katana', rate: 1 },
        { itemName: 'Patriotism Marks', rate: 0.1 },
        { itemName: 'Brigan', rate: 48.5 },
        { itemName: 'Daydric Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['skel_prisoner'] = {
    ...
    drops: [
        ...
        { itemName: 'Cuffs', rate: 0.35 },
        { itemName: 'Mementos', rate: 15 },
        { itemName: 'Skel Prisoner Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['raydric_archer'] = {
    ...
    drops: [
        ...
        { itemName: 'Chain Mail', rate: 0.02 },
        { itemName: 'Bow', rate: 1.5 },
        { itemName: 'Incisive Arrow', rate: 20 },
...
RO_MONSTER_TEMPLATES['driller'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Lizard Scruff', rate: 75 },
...
RO_MONSTER_TEMPLATES['tamruan'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Sword Accessory', rate: 48.5 },
        { itemName: 'Broken Armor Piece', rate: 30 },
...
RO_MONSTER_TEMPLATES['merman'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Lip Of Ancient Fish', rate: 13 },
        { itemName: 'Holy Water', rate: 3 },
        { itemName: 'Lemon', rate: 4 },
        { itemName: 'Skyblue Jewel', rate: 0.4 },
        { itemName: 'Mistic Frozen', rate: 0.35 },
        { itemName: 'Trident', rate: 0.03 },
        { itemName: 'Oridecon Stone', rate: 2.03 },
...
RO_MONSTER_TEMPLATES['live_peach_tree'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Hard Peach', rate: 43.65 },
        { itemName: 'Royal Jelly', rate: 10 },
        { itemName: 'Branch Of Dead Tree', rate: 4 },
        { itemName: 'Banana Juice', rate: 1 },
        { itemName: 'Old Blue Box', rate: 0.05 },
        { itemName: 'Live Peach Tree Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['gremlin'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Will Of Darkness', rate: 30 },
        { itemName: 'Sticky Mucus', rate: 30 },
        { itemName: 'Violet Jewel', rate: 1 },
...
RO_MONSTER_TEMPLATES['dancing_dragon'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Dragon Fang', rate: 43.65 },
        { itemName: 'Dragon Horn', rate: 30 },
        { itemName: 'Little Blacky Ghost', rate: 8 },
        { itemName: 'Dragon Scale', rate: 10 },
        { itemName: 'Yarn', rate: 30 },
        { itemName: 'Dancing Dragon Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['green_iguana'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Leaflet Of Aloe', rate: 15 },
        { itemName: 'Reptile Tongue', rate: 10 },
        { itemName: 'Leaflet Of Hinal', rate: 10 },
        { itemName: 'Green Herb', rate: 10 },
        { itemName: 'Monster\'s Feed', rate: 20 },
        { itemName: 'Aloebera', rate: 0.1 },
        { itemName: 'Green Herb', rate: 0.01 },
        { itemName: 'Green Iguana Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['giant_spider'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Spiderweb', rate: 45.5 },
        { itemName: 'Short Leg', rate: 12 },
        { itemName: 'Elunium Stone', rate: 1.4 },
...
RO_MONSTER_TEMPLATES['blood_butterfly'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Sharp Feeler', rate: 46.08 },
        { itemName: 'Great Wing', rate: 25 },
        { itemName: 'Wing Of Butterfly', rate: 12 },
        { itemName: 'Powder Of Butterfly', rate: 55 },
        { itemName: 'Waghnakh', rate: 0.03 },
        { itemName: 'Lariat', rate: 0.01 },
        { itemName: 'Blood Butterfly Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['disguise'] = {
    ...
    drops: [
        ...
        { itemName: 'Tangled Chain', rate: 36.86 },
        { itemName: 'Hood', rate: 0.5 },
        { itemName: 'Honey', rate: 1 },
        { itemName: 'Ragamuffin Cape', rate: 0.5 },
...
RO_MONSTER_TEMPLATES['removal'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Steel Plate', rate: 50 },
        { itemName: 'Gas Mask', rate: 0.1 },
        { itemName: 'Nice Sweet Potato', rate: 5 },
        { itemName: 'Detrimindexta', rate: 0.5 },
        { itemName: 'Karvodailnirol', rate: 1 },
        { itemName: 'Fedora', rate: 0.06 },
        { itemName: 'Removal Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['constant'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Burnt Parts', rate: 1 },
        { itemName: 'Sturdy Iron Piece', rate: 15 },
        { itemName: 'Tube', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['giant_honet'] = {
    ...
    drops: [
        ...
        { itemName: 'Fruit Of Mastela', rate: 0.12 },
        { itemName: 'Leaf Of Yggdrasil', rate: 0.15 },
        { itemName: 'Staff', rate: 0.03 },
        { itemName: 'Scarlet Jewel', rate: 0.2 },
        { itemName: 'Double Bound', rate: 0.15 },
        { itemName: 'Giant Honet Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['geographer'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Blossom Of Maneater', rate: 62 },
        { itemName: 'Root Of Maneater', rate: 55 },
        { itemName: 'Sunflower', rate: 0.3 },
        { itemName: 'Fancy Flower', rate: 0.5 },
        { itemName: 'Holy Scroll 1 5', rate: 1 },
...
RO_MONSTER_TEMPLATES['the_paper'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Smooth Paper', rate: 49.47 },
        { itemName: 'Fright Paper Blade', rate: 32 },
...
RO_MONSTER_TEMPLATES['demon_pungus'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Spawns', rate: 40.74 },
        { itemName: 'Mould Powder', rate: 45.59 },
        { itemName: 'Yellow Gemstone', rate: 38.8 },
        { itemName: 'Starsand Of Witch', rate: 50 },
...
RO_MONSTER_TEMPLATES['evil_cloud_hermit'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Cloud Piece', rate: 46.56 },
        { itemName: 'Cheese', rate: 56 },
        { itemName: 'Popped Rice', rate: 45 },
        { itemName: 'Bun', rate: 68 },
        { itemName: 'Guitar', rate: 0.02 },
        { itemName: 'Elunium Stone', rate: 1.5 },
        { itemName: 'Wind Scroll 1 5', rate: 1 },
        { itemName: 'Evil Cloud Hermit Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['hyegun'] = {
    ...
    drops: [
        ...
        { itemName: 'Hyegun Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['mineral'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Fragment Of Crystal', rate: 30 },
        { itemName: 'Golden Jewel', rate: 5 },
...
RO_MONSTER_TEMPLATES['breeze'] = {
    ...
    drops: [
        ...
        { itemName: 'Branch Of Dead Tree', rate: 0.1 },
        { itemName: 'Centimental Flower', rate: 0.1 },
        { itemName: 'Rough Wind', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['joker'] = {
    ...
    drops: [
        ...
        { itemName: 'Contracts In Shadow', rate: 0.2 },
        { itemName: 'Yellow Herb', rate: 10 },
...
RO_MONSTER_TEMPLATES['penomena'] = {
    ...
    drops: [
        ...
        { itemName: 'Violet Jewel', rate: 0.15 },
...
RO_MONSTER_TEMPLATES['muscipular'] = {
    ...
    drops: [
        { itemName: 'Sticky Poison', rate: 30 },
        { itemName: 'Blossom Of Maneater', rate: 30 },
...
RO_MONSTER_TEMPLATES['evil_druid'] = {
    ...
    drops: [
        ...
        { itemName: 'Bone Wand', rate: 0.01 },
        { itemName: 'Ragamuffin Cape', rate: 0.02 },
        { itemName: 'Bible', rate: 0.1 },
        { itemName: 'Leaf Of Yggdrasil', rate: 2 },
        { itemName: 'Cookbook07', rate: 0.04 },
        { itemName: 'White Herb', rate: 20 },
...
RO_MONSTER_TEMPLATES['leib_olmai'] = {
    ...
    drops: [
        ...
        { itemName: 'Stuffed Doll', rate: 1.2 },
        { itemName: 'Honey', rate: 5 },
...
RO_MONSTER_TEMPLATES['grand_peco'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Peco Wing Feather', rate: 48.5 },
        { itemName: 'Fruit Of Mastela', rate: 3 },
...
RO_MONSTER_TEMPLATES['gibbet'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Hanging Doll', rate: 18 },
        { itemName: 'Rotten Rope', rate: 53.35 },
        { itemName: 'Tree Knot', rate: 40.74 },
        { itemName: 'Cardinal Jewel', rate: 3 },
        { itemName: 'Red Gemstone', rate: 1 },
        { itemName: 'Branch Of Dead Tree', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['ygnizem'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Lab Staff Record', rate: 10 },
        { itemName: 'Katzbalger', rate: 0.01 },
        { itemName: 'Two Hand Sword', rate: 0.2 },
        { itemName: 'Saber', rate: 0.2 },
        { itemName: 'Padded Armor', rate: 0.1 },
        { itemName: 'Slayer', rate: 0.8 },
        { itemName: 'Plate Armor', rate: 0.01 },
        { itemName: 'Ygnizem Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['arclouse'] = {
    ...
    drops: [
        ...
        { itemName: 'Zargon', rate: 25 },
        { itemName: 'Arclouse Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['rideword'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Magic Book', rate: 0.2 },
...
RO_MONSTER_TEMPLATES['chung_e_'] = {
    ...
    drops: [
        ...
        { itemName: 'Hora', rate: 0.1 },
        { itemName: 'Honey', rate: 5 },
        { itemName: 'Tantanmen', rate: 0.1 },
        { itemName: 'Hair Protector', rate: 0.5 },
        { itemName: 'Chung E Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['erend'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Armlet Of Prisoner', rate: 5 },
        { itemName: 'Biretta', rate: 0.05 },
        { itemName: 'Morning Star', rate: 0.5 },
        { itemName: 'Sword Mace', rate: 0.2 },
        { itemName: 'Saint Robe', rate: 0.05 },
        { itemName: 'Scapulare', rate: 0.1 },
        { itemName: 'Spike', rate: 0.01 },
        { itemName: 'Erend Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['kaho'] = {
    ...
    drops: [
        ...
        { itemName: 'Burning Heart', rate: 30 },
        { itemName: 'Fire Scroll 1 3', rate: 1 },
        { itemName: 'Elunium Stone', rate: 10 },
        { itemName: 'Red Gemstone', rate: 3 },
        { itemName: 'Alchol', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['clock'] = {
    ...
    drops: [
        ...
        { itemName: 'Underground Key', rate: 0.3 },
...
RO_MONSTER_TEMPLATES['stalactic_golem'] = {
    ...
    drops: [
        ...
        { itemName: 'Great Nature', rate: 0.3 },
        { itemName: 'Elunium Stone', rate: 2.5 },
        { itemName: 'Elunium', rate: 1.63 },
...
RO_MONSTER_TEMPLATES['archangeling'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Satanic Chain', rate: 0.05 },
        { itemName: 'Leaf Of Yggdrasil', rate: 18 },
        { itemName: 'Seed Of Yggdrasil', rate: 1.5 },
        { itemName: 'Agate', rate: 15 },
        { itemName: 'Angelic Chain', rate: 0.05 },
        { itemName: 'Plate Armor', rate: 0.03 },
        { itemName: 'Turquoise', rate: 15 },
        { itemName: 'Archangeling Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['kavac'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Lab Staff Record', rate: 20 },
        { itemName: 'Kakkung', rate: 0.01 },
        { itemName: 'Steel Arrow Container', rate: 1 },
        { itemName: 'Great Bow', rate: 0.1 },
        { itemName: 'Mantle', rate: 0.05 },
        { itemName: 'Sandals', rate: 0.3 },
        { itemName: 'Shoes', rate: 0.02 },
        { itemName: 'Kavac Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['ancient_mimic'] = {
    ...
    drops: [
        ...
        { itemName: 'Fricco Shoes', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['pasana'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Vroken Sword', rate: 43.65 },
        { itemName: 'Honey Jar', rate: 25 },
        { itemName: 'Elunium Stone', rate: 0.2 },
...
RO_MONSTER_TEMPLATES['sting'] = {
    ...
    drops: [
        ...
        { itemName: 'Violet Jewel', rate: 0.03 },
...
RO_MONSTER_TEMPLATES['am_mut'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Dokkaebi Horn', rate: 45.5 },
        { itemName: 'Elunium Stone', rate: 2.5 },
...
RO_MONSTER_TEMPLATES['dragon_tail'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Dragon Fly Wing', rate: 44.13 },
        { itemName: 'Round Shell', rate: 4 },
        { itemName: 'Solid Shell', rate: 8 },
        { itemName: 'Fancy Flower', rate: 0.08 },
        { itemName: 'Cap', rate: 0.02 },
        { itemName: 'Wing Of Fly', rate: 3 },
        { itemName: 'Wing Of Butterfly', rate: 1.5 },
...
RO_MONSTER_TEMPLATES['garm_baby'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Milk Bottle', rate: 15 },
        { itemName: 'Bib', rate: 25 },
        { itemName: 'Ice Piece', rate: 43.65 },
        { itemName: 'Frozen Rose', rate: 1 },
        { itemName: 'Cold Scroll 2 5', rate: 1 },
        { itemName: 'Garm Baby Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['rawrel'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Mementos', rate: 10 },
        { itemName: 'Staff Of Wing', rate: 0.01 },
        { itemName: 'Guard', rate: 0.05 },
        { itemName: 'Staff', rate: 0.5 },
        { itemName: 'Silk Robe', rate: 0.1 },
        { itemName: 'Silver Robe', rate: 0.3 },
        { itemName: 'Clip', rate: 0.01 },
        { itemName: 'Rawrel Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['hodremlin'] = {
    ...
    drops: [
        ...
        { itemName: 'Will Of Darkness', rate: 10 },
        { itemName: 'Boots', rate: 0.02 },
        { itemName: 'Sticky Mucus', rate: 10 },
        { itemName: 'Bloody Rune', rate: 10 },
        { itemName: 'Starsand Of Witch', rate: 20 },
...
RO_MONSTER_TEMPLATES['alice'] = {
    ...
    drops: [
        ...
        { itemName: 'Chrystal Pumps', rate: 0.03 },
        { itemName: 'Rouge', rate: 0.3 },
        { itemName: 'Pair Of Red Ribbon', rate: 0.01 },
        { itemName: 'Imperial Cooking Kits', rate: 0.1 },
        { itemName: 'Holy Scroll 1 5', rate: 1 },
...
RO_MONSTER_TEMPLATES['cremy_fear'] = {
    ...
    drops: [
        ...
        { itemName: 'Icarus Wing', rate: 0.05 },
        { itemName: 'Fruit Of Mastela', rate: 0.5 },
        { itemName: 'Cremy Fear Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['zombie_master'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Tatters Clothes', rate: 44.13 },
        { itemName: 'Sticky Mucus', rate: 15 },
        { itemName: 'Horrendous Mouth', rate: 15 },
        { itemName: 'Cardinal Jewel', rate: 2 },
        { itemName: 'White Jewel', rate: 1 },
        { itemName: 'Ghoul Leg', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['gullinbursti'] = {
    ...
    drops: [
        ...
        { itemName: 'Animal Blood', rate: 0.06 },
        { itemName: 'Eagle Eyes', rate: 0.01 },
        { itemName: 'Anodyne', rate: 0.15 },
...
RO_MONSTER_TEMPLATES['dullahan'] = {
    ...
    drops: [
        ...
        { itemName: 'Dullahan Armor', rate: 48.5 },
        { itemName: 'An Eye Of Dullahan', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['civil_servant'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Fan', rate: 41.71 },
        { itemName: 'Cat Eyed Stone', rate: 20 },
        { itemName: 'Aloebera', rate: 0.1 },
        { itemName: 'Fish Tail', rate: 1 },
        { itemName: 'Wind Scroll 1 5', rate: 1 },
        { itemName: 'Civil Servant Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['whikebain'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Armlet Of Prisoner', rate: 20 },
        { itemName: 'Forturn Sword', rate: 0.01 },
        { itemName: 'Adventurere\'s Suit', rate: 0.4 },
        { itemName: 'Gladius', rate: 0.1 },
        { itemName: 'Chain Mail', rate: 0.02 },
        { itemName: 'Ring Of Rogue', rate: 0.02 },
        { itemName: 'Coward', rate: 0.1 },
        { itemName: 'Whikebain Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['aunoe'] = {
    ...
    drops: [
        ...
        { itemName: 'Memorize Book', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['zherlthsh'] = {
    ...
    drops: [
        ...
        { itemName: 'Zherlthsh Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['c_tower_manager'] = {
    ...
    drops: [
        ...
        { itemName: 'Brigan', rate: 53.35 },
        { itemName: 'Steel', rate: 5 },
        { itemName: 'Leaflet Of Hinal', rate: 8.5 },
        { itemName: 'Memorize Book', rate: 0.01 },
        { itemName: 'Key Of Clock Tower', rate: 20 },
        { itemName: 'Underground Key', rate: 20 },
        { itemName: 'C Tower Manager Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['gajomart'] = {
    ...
    drops: [
        ...
        { itemName: 'Fire Arrow', rate: 100 },
        { itemName: 'Magic Study Vol1', rate: 0.2 },
...
RO_MONSTER_TEMPLATES['permeter'] = {
    ...
    drops: [
        ...
        { itemName: 'Fruit Of Mastela', rate: 0.25 },
...
RO_MONSTER_TEMPLATES['fur_seal'] = {
    ...
    drops: [
        ...
        { itemName: 'Fur Seal Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['wicked_nymph'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Limpid Celestial Robe', rate: 39.77 },
        { itemName: 'Soft Silk Cloth', rate: 13.8 },
        { itemName: 'Oridecon', rate: 0.1 },
        { itemName: 'Mandolin', rate: 0.04 },
        { itemName: 'Lute', rate: 0.01 },
        { itemName: 'Holy Scroll 1 5', rate: 1 },
        { itemName: 'Oriental Lute', rate: 0.1 },
        { itemName: 'Wicked Nymph Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['golden_bug'] = {
    ...
    drops: [
        ...
        { itemName: 'Golden Bug Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
...
RO_MONSTER_TEMPLATES['goblin_leader'] = {
    ...
    drops: [
        ...
        { itemName: 'Oridecon Stone', rate: 1.2 },
        { itemName: 'Goblin Mask 04', rate: 0.5 },
...
RO_MONSTER_TEMPLATES['caterpillar'] = {
    ...
    drops: [
        { itemName: 'Feather', rate: 30 },
        { itemName: 'Brigan', rate: 53.35 },
        { itemName: 'Twilight Desert', rate: 0.2 },
...
RO_MONSTER_TEMPLATES['elder'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Old Magic Circle', rate: 40 },
        { itemName: 'Rent Spell Book', rate: 15 },
        { itemName: 'Rent Scroll', rate: 15 },
        { itemName: 'Encyclopedia', rate: 0.1 },
        { itemName: 'Wizardy Staff', rate: 0.01 },
        { itemName: 'Old Card Album', rate: 0.01 },
        { itemName: 'Underground Key', rate: 30 },
...
RO_MONSTER_TEMPLATES['executioner'] = {
    ...
    drops: [
        ...
        { itemName: 'Lapier', rate: 0.8 },
        { itemName: 'Scimiter', rate: 0.6 },
...
RO_MONSTER_TEMPLATES['mutant_dragon'] = {
    ...
    drops: [
        ...
        { itemName: 'Mutant Dragon Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['kobold_leader'] = {
    ...
    drops: [
        { itemName: 'Steel', rate: 4.5 },
        { itemName: 'Cobold Hair', rate: 63.05 },
        { itemName: 'Zargon', rate: 12 },
...
RO_MONSTER_TEMPLATES['fake_angel'] = {
    ...
    drops: [
        ...
        { itemName: 'Water Of Darkness', rate: 10 },
        { itemName: 'Carrot Whip', rate: 0.2 },
        { itemName: 'Fake Angel Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['deleter_'] = {
    ...
    drops: [
        ...
        { itemName: 'Dragon Canine', rate: 53.35 },
        { itemName: 'Dragon Train', rate: 38.8 },
        { itemName: 'Dragon Scale', rate: 35.89 },
        { itemName: 'Deleter Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['tengu'] = {
    ...
    drops: [
        ...
        { itemName: 'Broken Wine Vessel', rate: 55 },
        { itemName: 'Huuma Giant Wheel', rate: 0.05 },
        { itemName: 'Fruit Of Mastela', rate: 1.5 },
        { itemName: 'Huuma Giant Wheel', rate: 0.05 },
        { itemName: 'Imperial Cooking Kits', rate: 0.2 },
        { itemName: 'Earth Scroll 1 5', rate: 1 },
...
RO_MONSTER_TEMPLATES['deathword'] = {
    ...
    drops: [
        ...
        { itemName: 'Bookclip In Memory', rate: 3 },
        { itemName: 'Legend Of Kafra01', rate: 0.5 },
        { itemName: 'Bloody Page', rate: 5 },
        { itemName: 'Vidar\'s Boots', rate: 0.1 },
        { itemName: 'Cookbook08', rate: 0.02 },
        { itemName: 'Cookbook09', rate: 0.01 },
        { itemName: 'Deathword Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['seeker'] = {
    ...
    drops: [
        ...
        { itemName: 'Will Of Darkness', rate: 10 },
        { itemName: 'Elunium', rate: 0.2 },
        { itemName: 'Starsand Of Witch', rate: 40 },
        { itemName: 'Bloody Rune', rate: 10 },
...
RO_MONSTER_TEMPLATES['apocalips'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Broken Steel Piece', rate: 53.35 },
        { itemName: 'Mystery Piece', rate: 24 },
        { itemName: 'Wheel', rate: 22 },
        { itemName: 'Elunium', rate: 0.05 },
        { itemName: 'Destroyer', rate: 0.01 },
        { itemName: 'Manteau', rate: 0.2 },
        { itemName: 'Steel', rate: 25 },
        { itemName: 'Apocalips Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['deleter'] = {
    ...
    drops: [
        ...
        { itemName: 'Dragon Train', rate: 38.8 },
        { itemName: 'Dragon Scale', rate: 35.89 },
        { itemName: 'Flying Deleter Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['armaia'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Armlet Of Prisoner', rate: 10 },
        ...
        { itemName: 'Armaia Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['poton_canon'] = {
    ...
    drops: [
        { itemName: 'Large Jellopy', rate: 50 },
        { itemName: 'Dark Red Jewel', rate: 10 },
        { itemName: 'Sticky Mucus', rate: 10 },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['diabolic'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Petite DiablOfs Horn', rate: 58.2 },
        { itemName: 'Petite DiablOfs Wing', rate: 48.5 },
...
RO_MONSTER_TEMPLATES['sleeper'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Sand Lump', rate: 49.47 },
        { itemName: 'Grit', rate: 53.35 },
        { itemName: 'Great Nature', rate: 25 },
        { itemName: 'Oridecon Stone', rate: 3 },
...
RO_MONSTER_TEMPLATES['mini_demon'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Petite DiablOfs Horn', rate: 44.13 },
        { itemName: 'Petite DiablOfs Wing', rate: 4.5 },
        { itemName: 'Satanic Chain', rate: 0.03 },
        { itemName: 'Elunium Stone', rate: 1.6 },
        { itemName: 'Zargon', rate: 25 },
        { itemName: 'Sacred Marks', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['grizzly'] = {
    ...
    drops: [
        { itemName: 'Bear\'s Foot', rate: 50 },
        { itemName: 'Animal\'s Skin', rate: 50 },
        { itemName: 'Nice Sweet Potato', rate: 25 },
...
RO_MONSTER_TEMPLATES['waste_stove'] = {
    ...
    drops: [
        ...
        { itemName: 'Burn Tree', rate: 10 },
        { itemName: 'Iron', rate: 5 },
        { itemName: 'Lusty Iron', rate: 0.5 },
        { itemName: 'Iron Ore', rate: 10 },
        { itemName: 'Branch Of Dead Tree', rate: 0.5 },
        { itemName: 'Old Steel Plate', rate: 38 },
...
RO_MONSTER_TEMPLATES['phreeoni'] = {
    ...
    drops: [
        ...
        { itemName: 'Forturn Sword', rate: 5 },
        { itemName: 'Sucsamad', rate: 1.5 },
        { itemName: 'Jaws Of Ant', rate: 50 },
    ...
    mvpDrops: [
        { itemName: 'Frozen Heart', rate: 5 },
        { itemName: 'Crystal Jewel', rate: 10 },
    ],
};
...
RO_MONSTER_TEMPLATES['ungoliant'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Long Limb', rate: 45 },
        { itemName: 'Jaws Of Ant', rate: 35 },
        { itemName: 'Colorful Shell', rate: 10 },
        { itemName: 'Olivine', rate: 15 },
        { itemName: 'Fluorescent Liquid', rate: 25 },
        { itemName: 'Dark Red Jewel', rate: 15 },
...
RO_MONSTER_TEMPLATES['ferus_'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Delicious Fish', rate: 51 },
        { itemName: 'Dragon Canine', rate: 10 },
        { itemName: 'Dragon Scale', rate: 35.89 },
        { itemName: 'Dragonball Green', rate: 8 },
        { itemName: 'Great Nature', rate: 0.2 },
        { itemName: 'Dragonball Green', rate: 1 },
        { itemName: 'Ferus Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['aliza'] = {
    ...
    drops: [
        ...
        { itemName: 'Imperial Cooking Kits', rate: 0.5 },
        { itemName: 'Sway Apron', rate: 0.01 },
        { itemName: 'Orleans Server', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['echio'] = {
    ...
    drops: [
        ...
        { itemName: 'Seed Of Yggdrasil', rate: 0.1 },
        { itemName: 'Bloody Rune', rate: 40 },
...
RO_MONSTER_TEMPLATES['drake'] = {
    ...
    drops: [
        ...
        { itemName: 'Cutlas', rate: 1.5 },
        { itemName: 'Hae Dong Gum', rate: 4 },
...
RO_MONSTER_TEMPLATES['chimera'] = {
    ...
    drops: [
        { itemName: 'Brigan', rate: 53.35 },
        { itemName: 'Slender Snake', rate: 25 },
        { itemName: 'Lemon', rate: 10 },
        { itemName: 'War Axe', rate: 0.01 },
        { itemName: 'Citrine', rate: 15 },
...
RO_MONSTER_TEMPLATES['tao_gunka'] = {
    ...
    drops: [
        ...
        { itemName: 'Stone Piece', rate: 48.5 },
        { itemName: 'Golden Jewel', rate: 10 },
    ...
    mvpDrops: [
        ...
        { itemName: 'Old Violet Box', rate: 30 },
    ],
};
...
RO_MONSTER_TEMPLATES['ferus'] = {
    ...
    drops: [
        ...
        { itemName: 'Dragonball Red', rate: 8 },
        { itemName: 'Flame Heart', rate: 0.2 },
        { itemName: 'Magni Cap', rate: 0.5 },
        { itemName: 'Ferus Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['rybio'] = {
    ...
    drops: [
        ...
        { itemName: 'White Herb', rate: 18 },
        { itemName: 'Crystal Jewel', rate: 0.3 },
        { itemName: 'Frozen Heart', rate: 0.1 },
        { itemName: 'Oridecon', rate: 1 },
...
RO_MONSTER_TEMPLATES['assulter'] = {
    ...
    drops: [
        { itemName: 'Turtle Shell', rate: 44.13 },
        { itemName: 'Broken Armor Piece', rate: 12 },
        { itemName: 'Rust Suriken', rate: 8.4 },
        { itemName: 'Yellow Herb', rate: 12.8 },
        { itemName: 'Zargon', rate: 12.4 },
        { itemName: 'Huuma Bird Wing', rate: 0.05 },
        { itemName: 'Old Blue Box', rate: 0.01 },
        { itemName: 'Assulter Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['incantation_samurai'] = {
    ...
    drops: [
        ...
        { itemName: 'Yggdrasilberry', rate: 45 },
        { itemName: 'Steel', rate: 63.05 },
        { itemName: 'Huuma Blaze', rate: 75 },
        { itemName: 'Azoth', rate: 0.8 },
        { itemName: 'Incant Samurai Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Yggdrasilberry', rate: 55 },
        { itemName: 'Seed Of Yggdrasil', rate: 35 },
    ],
};
...
RO_MONSTER_TEMPLATES['loli_ruri'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Black Kitty Doll', rate: 8 },
        { itemName: 'Striped Socks', rate: 30 },
...
RO_MONSTER_TEMPLATES['doppelganger'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Plate Armor', rate: 2.5 },
        { itemName: 'Broad Sword', rate: 2.2 },
        { itemName: 'Zweihander', rate: 1.5 },
        { itemName: 'Sharp Gear', rate: 3.5 },
    ...
    mvpDrops: [
        { itemName: 'Cardinal Jewel', rate: 15 },
    ],
};
...
RO_MONSTER_TEMPLATES['gryphon'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Talon Of Griffin', rate: 25 },
        { itemName: 'Brigan', rate: 53.35 },
...
RO_MONSTER_TEMPLATES['bloody_murderer'] = {
    ...
    drops: [
        ...
        { itemName: 'Distorted Portrait', rate: 10 },
        { itemName: 'Rusty Cleaver', rate: 20 },
...
RO_MONSTER_TEMPLATES['bacsojin'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Long Hair', rate: 55 },
        { itemName: 'Old Blue Box', rate: 0.02 },
        { itemName: 'Old Violet Box', rate: 0.02 },
        { itemName: 'Limpid Celestial Robe', rate: 30 },
        { itemName: 'Soft Silk Cloth', rate: 10 },
...
RO_MONSTER_TEMPLATES['venatu_1'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Screw', rate: 20 },
        { itemName: 'Piece Of Crest1', rate: 3.5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Mystery Piece', rate: 3 },
        { itemName: 'Drifter', rate: 0.05 },
        { itemName: 'Elunium', rate: 0.1 },
        { itemName: 'High end Cooking Kits', rate: 1 },
...
RO_MONSTER_TEMPLATES['gemini'] = {
    ...
    drops: [
        ...
        { itemName: 'Butcher', rate: 0.05 },
        { itemName: 'Yellow Slim Potion', rate: 5 },
        { itemName: 'White Slim Potion', rate: 4 },
        { itemName: 'Cookbook08', rate: 0.06 },
        { itemName: 'Stone Of Intelligence', rate: 3 },
        { itemName: 'Gemini Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['garm'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Fang Of Garm', rate: 55 },
        { itemName: 'Ice Falchon', rate: 1.5 },
        { itemName: 'Katar Of Cold Icicle', rate: 5 },
        { itemName: 'Claw Of Garm', rate: 5 },
        { itemName: 'Elunium', rate: 39.77 },
        { itemName: 'Oridecon', rate: 29 },
        { itemName: 'Garm Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Fang Of Garm', rate: 10 },
...
RO_MONSTER_TEMPLATES['skeleton_general'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Burn Tree', rate: 25.5 },
        { itemName: 'Oridecon Stone', rate: 1.6 },
        { itemName: 'Yellow Herb', rate: 8 },
...
RO_MONSTER_TEMPLATES['dark_snake_lord'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Taegeuk Plate', rate: 58.2 },
        { itemName: 'Sword Of Grave Keeper', rate: 51 },
        { itemName: 'Hell Fire', rate: 0.8 },
        { itemName: 'Ph.D Hat', rate: 0.8 },
        { itemName: 'Gae Bolg', rate: 5 },
        { itemName: 'Pill', rate: 9 },
        { itemName: 'Sway Apron', rate: 20 },
        { itemName: 'Dark Snake Lord Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Yggdrasilberry', rate: 55 },
        { itemName: 'Old Violet Box', rate: 50 },
    ],
};
...
RO_MONSTER_TEMPLATES['orc_lord'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Brood Axe', rate: 4 },
        { itemName: 'Ring', rate: 4 },
        { itemName: 'Loard Circlet', rate: 4 },
        { itemName: 'Doom Slayer', rate: 4 },
        { itemName: 'Old Violet Box', rate: 10 },
        { itemName: 'Elunium', rate: 42.68 },
        { itemName: 'Erde', rate: 31 },
        { itemName: 'Orc Load Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Voucher Of Orcish Hero', rate: 55 },
    ],
};
...
RO_MONSTER_TEMPLATES['wander_man'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Card Album', rate: 0.01 },
        { itemName: 'Hakujin', rate: 0.05 },
        { itemName: 'Centimental Leaf', rate: 0.05 },
        { itemName: 'Leaf Of Yggdrasil', rate: 6.5 },
        { itemName: 'Oridecon', rate: 2.17 },
        { itemName: 'Muramasa', rate: 0.01 },
        { itemName: 'Wander Man Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['wraith_dead'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Transparent Cloth', rate: 44.13 },
        { itemName: 'Wedding Veil', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['owl_baron'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Tatters Clothes', rate: 35 },
        { itemName: 'Soft Feather', rate: 25 },
        { itemName: 'Kakkung', rate: 0.02 },
        { itemName: 'Staff Of Soul', rate: 0.01 },
        { itemName: 'Walking Stick', rate: 0.02 },
        { itemName: 'Wind Scroll 1 5', rate: 1 },
...
RO_MONSTER_TEMPLATES['incubus'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Fruit Of Mastela', rate: 15 },
        { itemName: 'White Herb', rate: 55 },
        { itemName: 'Inccubus Horn', rate: 0.01 },
        { itemName: 'Ring', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['violy'] = {
    ...
    drops: [
        ...
        { itemName: 'High end Cooking Kits', rate: 0.5 },
        { itemName: 'Stuffed Doll', rate: 12 },
        { itemName: 'Base Guitar', rate: 0.5 },
...
RO_MONSTER_TEMPLATES['venatu_4'] = {
    ...
    drops: [
        { itemName: 'Screw', rate: 20 },
        { itemName: 'Piece Of Crest4', rate: 3 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Mystery Piece', rate: 3 },
        { itemName: 'Hyper Changer', rate: 0.1 },
        { itemName: 'Elunium', rate: 0.1 },
        { itemName: 'High end Cooking Kits', rate: 1 },
        { itemName: 'Venatu Card', rate: 0.01, stealProtected: true },
    ],
...
RO_MONSTER_TEMPLATES['alicel'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Burnt Parts', rate: 20 },
        { itemName: 'Sturdy Iron Piece', rate: 30 },
        { itemName: 'Steel', rate: 2 },
        { itemName: 'Screw', rate: 5 },
...
RO_MONSTER_TEMPLATES['cat_o_nine_tail'] = {
    ...
    drops: [
        ...
        { itemName: 'Silver Knife Of Chaste', rate: 1.5 },
        { itemName: 'Punisher', rate: 0.05 },
        { itemName: 'Elunium', rate: 6 },
        { itemName: 'Oridecon', rate: 8 },
        { itemName: 'Gold', rate: 0.06 },
        { itemName: 'Old Violet Box', rate: 0.01 },
        { itemName: 'Cat O Nine Tail Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['acidus_'] = {
    ...
    drops: [
        ...
        { itemName: 'Dragon Scale', rate: 35.89 },
        { itemName: 'Dragonball Blue', rate: 8 },
        { itemName: 'Rough Wind', rate: 0.2 },
        { itemName: 'Dragonball Blue', rate: 1 },
        { itemName: 'Acidus Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['ork_hero'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Voucher Of Orcish Hero', rate: 97 },
        { itemName: 'Monkey Circlet', rate: 5 },
        { itemName: 'Right Epsilon', rate: 1.5 },
    ...
    mvpDrops: [
        ...
        { itemName: 'Yggdrasilberry', rate: 15 },
    ],
};
...
RO_MONSTER_TEMPLATES['knight_of_windstorm'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Blue Box', rate: 30 },
        { itemName: 'Old Violet Box', rate: 40 },
        { itemName: 'Ring', rate: 2 },
        { itemName: 'Manteau', rate: 5 },
        { itemName: 'Elunium', rate: 45.59 },
        { itemName: 'Loard Circlet', rate: 0.01 },
        { itemName: 'Knight Windstorm Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Skyblue Jewel', rate: 45 },
        { itemName: 'Boots', rate: 5 },
    ],
};
...
RO_MONSTER_TEMPLATES['dark_illusion'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Bone Wand', rate: 0.03 },
        { itemName: 'Bone Helm', rate: 0.02 },
        { itemName: 'Ragamuffin Cape', rate: 0.03 },
        { itemName: 'Brigan', rate: 53.35 },
        { itemName: 'Fruit Of Mastela', rate: 1.2 },
        { itemName: 'White Herb', rate: 15.5 },
...
RO_MONSTER_TEMPLATES['lava_golem'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Cold Magma', rate: 45.59 },
...
RO_MONSTER_TEMPLATES['solace'] = {
    ...
    drops: [
        ...
        { itemName: 'Ring', rate: 0.01 },
        { itemName: 'Stone Of Intelligence', rate: 0.5 },
        { itemName: 'Dark Red Jewel', rate: 10 },
        { itemName: 'Harp', rate: 0.5 },
        { itemName: 'Harp', rate: 1 },
        { itemName: 'Cursed Seal', rate: 0.5 },
        { itemName: 'Solace Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['osiris'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Old Violet Box', rate: 20 },
        { itemName: 'Assasin Dagger', rate: 1.5 },
        { itemName: 'Crown', rate: 2 },
        { itemName: 'Jamadhar', rate: 6 },
        { itemName: 'Sacred Marks', rate: 10 },
        { itemName: 'Spinx Helm', rate: 1.5 },
        { itemName: 'Cakram', rate: 1 },
        { itemName: 'Osiris Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Blue Box', rate: 40 },
        { itemName: 'Seed Of Yggdrasil', rate: 30 },
    ],
};
...
RO_MONSTER_TEMPLATES['nightmare_terror'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Burning Horse Shoe', rate: 49.47 },
        { itemName: 'Rosary', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['venatu_3'] = {
    ...
    drops: [
        { itemName: 'Screw', rate: 20 },
        { itemName: 'Piece Of Crest3', rate: 4 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Mystery Piece', rate: 3 },
        { itemName: 'Hyper Changer', rate: 0.1 },
        { itemName: 'Elunium', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['medusa'] = {
    ...
    modes: { detector: true },
    drops: [
        { itemName: 'Slender Snake', rate: 53.35 },
        { itemName: 'Whip Of Red Flame', rate: 2.5 },
        { itemName: 'Animal Blood', rate: 2 },
        { itemName: 'Sea Witch Foot', rate: 0.2 },
        { itemName: 'Scarlet Jewel', rate: 2.5 },
        { itemName: 'Turtle Shell', rate: 35 },
        { itemName: 'Penetration', rate: 0.03 },
...
RO_MONSTER_TEMPLATES['dark_priest'] = {
    ...
    drops: [
        ...
        { itemName: 'Sacred Marks', rate: 0.5 },
        { itemName: 'Glittering Clothes', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['b_ygnizem'] = {
    ...
    drops: [
        ...
        { itemName: 'B Ygnizem Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
    ],
};
...
RO_MONSTER_TEMPLATES['dimik_1'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Old Steel Plate', rate: 20 },
        { itemName: 'Transparent Plate01', rate: 0.5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Mystery Piece', rate: 3 },
...
RO_MONSTER_TEMPLATES['retribution'] = {
    ...
    drops: [
        ...
        { itemName: 'Ring', rate: 0.01 },
        { itemName: 'Stone Of Intelligence', rate: 0.5 },
        { itemName: 'Cardinal Jewel', rate: 10 },
        { itemName: 'Manteau', rate: 0.05 },
        { itemName: 'Two Hand Sword', rate: 0.1 },
        { itemName: 'Cursed Seal', rate: 0.5 },
        { itemName: 'Retribution Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['dimik_3'] = {
    ...
    drops: [
        { itemName: 'Old Steel Plate', rate: 20 },
        { itemName: 'Transparent Plate03', rate: 0.5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Mystery Piece', rate: 3 },
        { itemName: 'Hyper Changer', rate: 0.1 },
        { itemName: 'Oridecon', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['venatu_2'] = {
    ...
    drops: [
        { itemName: 'Screw', rate: 20 },
        { itemName: 'Piece Of Crest2', rate: 5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Mystery Piece', rate: 3 },
...
RO_MONSTER_TEMPLATES['shelter'] = {
    ...
    drops: [
        ...
        { itemName: 'Cursed Seal', rate: 0.5 },
        { itemName: 'Shelter Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['bow_guardian'] = {
    ...
    drops: [
        ...
        { itemName: 'Orleans Glove', rate: 0.04 },
...
RO_MONSTER_TEMPLATES['maya'] = {
    ...
    mvpDrops: [
        { itemName: 'Crystal Jewel', rate: 20 },
        { itemName: 'Old Blue Box', rate: 30 },
    ],
};
...
RO_MONSTER_TEMPLATES['maya_puple'] = {
    ...
    drops: [
        ...
        { itemName: 'Cookbook10', rate: 0.02 },
        { itemName: 'Maya Puple Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['observation'] = {
    ...
    drops: [
        ...
        { itemName: 'Golden Jewel', rate: 10 },
        { itemName: 'Stone Of Intelligence', rate: 1 },
        { itemName: 'Hair Band', rate: 0.1 },
        { itemName: 'Golden Bracelet', rate: 1 },
        { itemName: 'Observation Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['skeggiold'] = {
    ...
    drops: [
        ...
        { itemName: 'Angelic Chain', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['bloody_knight'] = {
    ...
    drops: [
        ...
        { itemName: 'Plate Armor', rate: 0.05 },
...
RO_MONSTER_TEMPLATES['shecil'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Armlet Of Prisoner', rate: 30 },
        { itemName: 'Imma Arrow Container', rate: 1.1 },
        { itemName: 'Tights', rate: 0.1 },
        { itemName: 'CrossBow', rate: 1 },
        { itemName: 'Ori Arrow Container', rate: 1.5 },
        { itemName: 'Old Blue Box', rate: 0.5 },
        { itemName: 'Falken Blitz', rate: 0.01 },
        { itemName: 'Shecil Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['dimik_4'] = {
    ...
    drops: [
        { itemName: 'Old Steel Plate', rate: 20 },
        { itemName: 'Transparent Plate04', rate: 0.5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Mystery Piece', rate: 3 },
        { itemName: 'Hyper Changer', rate: 0.1 },
        { itemName: 'Oridecon', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['atroce'] = {
    ...
    drops: [
        ...
        { itemName: 'Seed Of Yggdrasil', rate: 10 },
        { itemName: 'Ring', rate: 10 },
        { itemName: 'Old Violet Box', rate: 50 },
        { itemName: 'Yggdrasilberry', rate: 50 },
        { itemName: 'Ulle Cap', rate: 1 },
        { itemName: 'Altas Weapon', rate: 1 },
...
RO_MONSTER_TEMPLATES['bloody_knight_'] = {
    ...
    drops: [
        ...
        { itemName: 'Grave', rate: 1 },
        { itemName: 'Pauldron', rate: 2 },
        { itemName: 'Full Plate Armor', rate: 3 },
        { itemName: 'Celestial Robe', rate: 2 },
        { itemName: 'Survival Rod2', rate: 2 },
        { itemName: 'Old Violet Box', rate: 70 },
        { itemName: 'Anti Spell Bead', rate: 100, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['harword'] = {
    ...
    drops: [
        ...
        { itemName: 'Clothes Of The Lord', rate: 0.01 },
        { itemName: 'Old Blue Box', rate: 0.5 },
        { itemName: 'Harword Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['tha_maero'] = {
    ...
    drops: [
        { itemName: 'Brigan', rate: 10 },
        { itemName: 'Crystal Jewel', rate: 5 },
        { itemName: 'Crystal Jewel', rate: 1 },
        { itemName: 'Piece Of Memory Purple', rate: 100 },
        { itemName: 'Old Card Album', rate: 0.1 },
        { itemName: 'Goibne\'s Armor', rate: 10 },
        { itemName: 'Tha Maero Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['tha_dolor'] = {
    ...
    drops: [
        ...
        { itemName: 'Crystal Jewel', rate: 5 },
        { itemName: 'Crystal Jewel', rate: 1 },
        { itemName: 'Piece Of Memory Green', rate: 100 },
        { itemName: 'Old Card Album', rate: 0.1 },
        { itemName: 'Goibne\'s Helmet', rate: 10 },
        { itemName: 'Tha Dolor Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['succubus'] = {
    ...
    drops: [
        ...
        { itemName: 'Horn Of Succubus', rate: 0.01 },
        { itemName: 'Staff Of Soul', rate: 0.01 },
...
RO_MONSTER_TEMPLATES['dracula'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Yggdrasilberry', rate: 47 },
        { itemName: 'Wizardy Staff', rate: 0.05 },
        { itemName: 'Balistar', rate: 0.05 },
        { itemName: 'Cape Of Ancient Lord', rate: 0.15 },
    ...
    mvpDrops: [
        { itemName: 'Yggdrasilberry', rate: 55 },
        { itemName: 'Crystal Jewel', rate: 50 },
    ],
};
...
RO_MONSTER_TEMPLATES['bacsojin_'] = {
    ...
    drops: [
        { itemName: 'Long Hair', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
        { itemName: 'Tantanmen', rate: 0.5 },
        { itemName: 'Limpid Celestial Robe', rate: 30 },
        { itemName: 'Soft Silk Cloth', rate: 10 },
        { itemName: 'Red Silk Seal', rate: 1 },
        { itemName: 'Tiara', rate: 0.1 },
        { itemName: 'Bacsojin Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Yggdrasilberry', rate: 55 },
        { itemName: 'Celestial Robe', rate: 20 },
    ],
};
...
RO_MONSTER_TEMPLATES['kasa'] = {
    ...
    drops: [
        { itemName: 'Burning Heart', rate: 30 },
        { itemName: 'Hot Hair', rate: 25 },
        { itemName: 'Flame Heart', rate: 0.3 },
        { itemName: 'Lesser Elemental Ring', rate: 0.01 },
        { itemName: 'Flame Sprits Armor', rate: 0.1 },
...
RO_MONSTER_TEMPLATES['rsx_0806'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Wheel', rate: 60 },
        { itemName: 'House Auger', rate: 0.1 },
        { itemName: 'House Auger', rate: 0.01 },
        { itemName: 'Old Violet Box', rate: 10 },
        { itemName: 'Headlamp', rate: 50 },
        { itemName: 'Counter Dagger', rate: 0.5 },
        { itemName: 'Spanner', rate: 0.2 },
        { itemName: 'Rsx 0806 Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Yggdrasilberry', rate: 55 },
        { itemName: 'Dark Blindfold', rate: 35 },
    ],
};
...
RO_MONSTER_TEMPLATES['eremes'] = {
    ...
    drops: [
        ...
        { itemName: 'Pauldron', rate: 0.01 },
        { itemName: 'Nail Of Loki', rate: 0.03 },
        { itemName: 'Various Jur', rate: 0.3 },
        { itemName: 'Poison Bottle', rate: 1.1 },
        { itemName: 'Thief Clothes', rate: 0.02 },
        { itemName: 'Eremes Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['tha_despero'] = {
    ...
    drops: [
        ...
        { itemName: 'Crystal Jewel', rate: 5 },
        { itemName: 'Crystal Jewel', rate: 1 },
        { itemName: 'Piece Of Memory Red', rate: 100 },
        { itemName: 'Old Card Album', rate: 0.1 },
        { itemName: 'Goibne\'s Combat Boots', rate: 10 },
        { itemName: 'Tha Despero Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['dimik_2'] = {
    ...
    drops: [
        { itemName: 'Old Steel Plate', rate: 20 },
        { itemName: 'Transparent Plate02', rate: 0.5 },
        { itemName: 'Steel', rate: 3 },
        { itemName: 'Mystery Piece', rate: 3 },
...
RO_MONSTER_TEMPLATES['hydro'] = {
    ...
    drops: [
        ...
        { itemName: 'Dragon Canine', rate: 40 },
        { itemName: 'Tri Headed Dragon Head', rate: 38.8 },
        { itemName: 'Morpheus\'s Hood', rate: 5 },
        { itemName: 'Morrigane\'s Helm', rate: 5 },
        { itemName: 'Vit Dish10', rate: 3 },
        { itemName: 'Fricca Circlet', rate: 5 },
        { itemName: 'Hydro Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['magaleta'] = {
    ...
    drops: [
        ...
        { itemName: 'Rod', rate: 2 },
        { itemName: 'Hardback', rate: 0.1 },
        { itemName: 'Holy Robe', rate: 0.01 },
        { itemName: 'Old Blue Box', rate: 0.5 },
        { itemName: 'Muffler', rate: 0.1 },
        { itemName: 'Magaleta Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['detale'] = {
    ...
    drops: [
        ...
        { itemName: 'Scale Of Red Dragon', rate: 35.89 },
        { itemName: 'Int Dish10', rate: 10 },
        { itemName: 'Pole Axe', rate: 1 },
        { itemName: 'Gemmed Crown', rate: 5 },
        { itemName: 'Detale Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['kiel_'] = {
    ...
    drops: [
        ...
        { itemName: 'Glittering Clothes', rate: 10 },
        { itemName: 'Survival Rod', rate: 5 },
        { itemName: 'Counter Dagger', rate: 5 },
        { itemName: 'Morrigane\'s Belt', rate: 10 },
        { itemName: 'Kiel Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['seyren'] = {
    ...
    drops: [
        ...
        { itemName: 'Seyren Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['katrinn'] = {
    ...
    drops: [
        ...
        { itemName: 'Survival Rod2', rate: 0.05 },
        { itemName: 'Guard', rate: 0.3 },
        { itemName: 'Pair Of Red Ribbon', rate: 0.01 },
        { itemName: 'Shoes', rate: 0.2 },
        { itemName: 'Katrinn Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['tha_odium'] = {
    ...
    drops: [
        ...
        { itemName: 'Crystal Jewel', rate: 5 },
        { itemName: 'Crystal Jewel', rate: 1 },
        { itemName: 'Piece Of Memory Blue', rate: 100 },
        { itemName: 'Old Card Album', rate: 0.1 },
        { itemName: 'Goibne\'s Shoulder Arms', rate: 10 },
        { itemName: 'Tha Odium Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [],
};
...
RO_MONSTER_TEMPLATES['pharaoh'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Broken Pharaoh Symbol', rate: 58.2 },
...
RO_MONSTER_TEMPLATES['lord_of_death'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Boroken Shiled Piece', rate: 53.35 },
        { itemName: 'Pole Axe', rate: 0.05 },
        { itemName: 'House Auger', rate: 0.1 },
        { itemName: 'Ring', rate: 0.02 },
        { itemName: 'Shine Spear Blade', rate: 0.1 },
        { itemName: 'War Axe', rate: 0.01 },
        { itemName: 'Iron Driver', rate: 0.02 },
        { itemName: 'Lord Of Death Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Yggdrasilberry', rate: 55 },
        { itemName: 'Crystal Jewel', rate: 50 },
...
RO_MONSTER_TEMPLATES['apocalips_h'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Broken Steel Piece', rate: 50 },
        { itemName: 'Mystery Piece', rate: 30 },
        { itemName: 'Old Violet Box', rate: 10 },
        { itemName: 'Vesper Core01', rate: 1 },
        { itemName: 'Vesper Core02', rate: 1 },
        { itemName: 'Vesper Core03', rate: 1 },
        { itemName: 'Vesper Core04', rate: 1 },
        { itemName: 'Apocalips H Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['ktullanux'] = {
    ...
    drops: [
        ...
        { itemName: 'Clack Of Servival', rate: 30 },
        { itemName: 'Herald Of GOD', rate: 50 },
        { itemName: 'Old Violet Box', rate: 50 },
        { itemName: 'Yggdrasilberry', rate: 50 },
...
RO_MONSTER_TEMPLATES['poring_v'] = {
    ...
    drops: [
        ...
        { itemName: 'Flame Sprits Armor', rate: 25 },
        { itemName: 'Water Sprits Armor', rate: 25 },
        { itemName: 'Earth Sprits Armor', rate: 25 },
        { itemName: 'Wind Sprits Armor', rate: 25 },
        { itemName: 'Bloody Iron Ball', rate: 40 },
        { itemName: 'Large Jellopy', rate: 100 },
        { itemName: 'Holy Guard', rate: 45, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Sword Of Grave Keeper', rate: 10 },
...
RO_MONSTER_TEMPLATES['b_seyren'] = {
    ...
    drops: [
        ...
        { itemName: 'Full Plate Armor', rate: 35 },
        { itemName: 'Grave', rate: 90 },
        { itemName: 'Brionac', rate: 35 },
        { itemName: 'Longinus\'s Spear', rate: 30 },
        { itemName: 'Dragon Slayer', rate: 25 },
        { itemName: 'Skewer', rate: 15 },
        { itemName: 'B Seyren Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['b_eremes'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Moonlight Sword', rate: 15 },
        { itemName: 'House Auger', rate: 15 },
        { itemName: 'Glittering Clothes', rate: 90 },
        { itemName: 'Exercise', rate: 35 },
        { itemName: 'Assasin Dagger', rate: 35 },
        { itemName: 'Bloody Roar', rate: 35 },
        { itemName: 'Ginnungagap', rate: 35 },
        { itemName: 'B Eremes Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['b_harword'] = {
    ...
    drops: [
        ...
        { itemName: 'Byeorrun Gum', rate: 25 },
        { itemName: 'Clothes Of The Lord', rate: 90 },
        { itemName: 'Sabbath', rate: 35 },
        { itemName: 'Great Axe', rate: 35 },
        { itemName: 'Guillotine', rate: 25 },
        { itemName: 'Tomahawk', rate: 35 },
        { itemName: 'B Harword Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['b_magaleta'] = {
    ...
    drops: [
        ...
        { itemName: 'Celestial Robe', rate: 90 },
        ...
        { itemName: 'B Magaleta Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['b_shecil'] = {
    ...
    drops: [
        ...
        { itemName: 'Old Violet Box', rate: 90 },
        { itemName: 'Moonlight Sword', rate: 15 },
        { itemName: 'Grimtooth', rate: 35 },
        { itemName: 'Bow Of Rudra', rate: 15 },
        { itemName: 'Dragon Wing', rate: 25 },
        { itemName: 'B Shecil Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['b_katrinn'] = {
    ...
    drops: [
        ...
        { itemName: 'Counter Dagger', rate: 35 },
        { itemName: 'Critical Ring', rate: 90 },
        { itemName: 'Robe Of Casting', rate: 25 },
        { itemName: 'Celestial Robe', rate: 25 },
        { itemName: 'Survival Rod', rate: 30 },
        { itemName: 'Glittering Clothes', rate: 35 },
        { itemName: 'B Katrinn Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['thanatos'] = {
    ...
    drops: [
        ...
        { itemName: 'Piece Of Bone Armor', rate: 50 },
        { itemName: 'Full Plate Armor', rate: 50 },
        { itemName: 'Grave', rate: 50 },
        { itemName: 'Wing Of Eagle', rate: 10 },
        { itemName: 'Bloody Iron Ball', rate: 5 },
        { itemName: 'Thanatos Card', rate: 0.01, stealProtected: true },
    ],
    mvpDrops: [
        { itemName: 'Old Violet Box', rate: 55 },
        { itemName: 'Old Blue Box', rate: 50 },
...
RO_MONSTER_TEMPLATES['randgris'] = {
    ...
    modes: { mvp: true },
    drops: [
        { itemName: 'Valhalla Flower', rate: 50 },
        { itemName: 'Valkyrie Armor', rate: 16 },
        { itemName: 'Valkyrie Manteau', rate: 30 },
        { itemName: 'Valkyrie Shoes', rate: 30 },
...
RO_MONSTER_TEMPLATES['ifrit'] = {
    ...
    drops: [
        ...
        { itemName: 'Hell Fire', rate: 20 },
        { itemName: 'Fire Brand', rate: 20 },
        { itemName: 'Flame Sprits Armor', rate: 1 },
...
RO_MONSTER_TEMPLATES['golden_savage'] = {
    ...
    modes: {},
    drops: [
        { itemName: 'Leaf Of Yggdrasil', rate: 30 },
        ...
        { itemName: 'New Year Rice Cake 1', rate: 30 },
        { itemName: 'New Year Rice Cake 2', rate: 30, stealProtected: true },
    ],
    mvpDrops: [],
};
